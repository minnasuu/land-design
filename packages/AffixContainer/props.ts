 ...
 * 合并了所有图钉项属性接口
 */
export type AffixContainerItemProps = AffixItemBaseProps &
  AffixItemPositionProps &
  AffixItemInteractionProps;
 ...
 * 合并了所有属性接口
 */
export type AffixContainerProps = AffixContainerBaseProps &
  AffixContainerPositionProps & {
    /** 
     * 扩展属性
     * 支持传入其他HTML div元素的属性
     */
