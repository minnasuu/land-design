...
export const IconSetting: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="M24 31C27.866 31 31 27.866 31 24C31 20.134 27.866 17 24 17C20.134 17 17 20.134 17 24C17 27.866 20.134 31 24 31Z" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
  </svg>
);
