...
export default function ButtonExample() {
  ...
  const buttonProps = [
    { name: 'type', type: 'ButtonType', default: 'outline', desc: '按钮类型：text | fill | background | outline | dashed | transparent' },
    { name: 'status', type: 'ButtonStatus', default: 'default', desc: '按钮状态：default | primary | warning | danger | success' },
    { name: 'size', type: 'ButtonSize', default: 'default', desc: '按钮尺寸：mini | small | default | large' },
    { name: 'text', type: 'string', desc: '按钮主要文案' },
    { name: 'subText', type: 'string', desc: '按钮次要文案' },
    { name: 'icon', type: 'ReactNode', desc: '按钮图标' },
    { name: 'disabled', type: 'boolean', default: 'false', desc: '是否禁用按钮' },
    { name: 'block', type: 'boolean', default: 'false', desc: '是否为块级按钮' },
    { name: 'bold', type: 'boolean', default: 'false', desc: '是否加粗文字' },
    { name: 'hoverBold', type: 'boolean', default: 'false', desc: '悬停时是否加粗文字' },
    { name: 'capsule', type: 'boolean', default: 'false', desc: '是否为胶囊按钮' },
    { name: 'hoverAnimation', type: 'boolean', default: 'false', desc: '是否启用悬停动画' },
    { name: 'activeAnimation', type: 'boolean', default: 'false', desc: '是否启用点击动画' },
