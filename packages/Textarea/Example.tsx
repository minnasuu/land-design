        ...
        <div className='flex flex-col gap-6'>
          ...
          >
            <CodeOperationContainer column>
              <div className="flex flex-col gap-4">
                <div>
                  <div className="fs-12 color-gray-4 mb-2">Outline（描边样式）</div>
                  <Textarea
                    variant="outline"
                    placeholder="描边样式..."
                    value={value1}
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">Filled（填充样式）</div>
                  <Textarea
                    variant="filled"
                    placeholder="填充样式..."
                    value={value2}
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">Transparent（透明样式）</div>
                  <Textarea
                    variant="transparent"
                    placeholder="透明样式..."
                    value={value3}
          ...
          >
            <CodeOperationContainer column>
              <div className="flex flex-col gap-4">
                <div>
                  <div className="fs-12 color-gray-4 mb-2">基础字数统计</div>
                  <Textarea
                    showCount
                    placeholder="输入后显示字数..."
                    value={value4}
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">限制最大字符数</div>
                  <Textarea
                    showCount
                    maxLength={100}
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">自定义字数格式</div>
                  <Textarea
                    showCount
                    maxLength={50}
          ...
          >
            <CodeOperationContainer column>
              <div className="flex flex-col gap-4">
                <div>
                  <div className="fs-12 color-gray-4 mb-2">自动调整（无限制）</div>
                  <Textarea
                    resize='vertical'
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">限制最小/最大行数</div>
                  <Textarea
          ...
          >
            <CodeOperationContainer column>
              <div className="flex flex-col gap-4">
                <div>
                  <div className="fs-12 color-gray-4 mb-2">禁用状态</div>
                  <Textarea
                    disabled
                    value="这是一个禁用的文本域"
                    placeholder="禁用状态"
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">只读状态</div>
                  <Textarea
                    readOnly
          ...
          >
            <CodeOperationContainer column>
              <div className="flex flex-col gap-4">
                <div>
                  <div className="fs-12 color-gray-4 mb-2">自定义宽度和高度</div>
                  <Textarea
                    width={400}
                    height={120}
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">块级元素（100% 宽度）</div>
                  <Textarea
                    block
                    placeholder="占满父容器宽度"
                  />
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">自定义行数</div>
                  <Textarea
                    rows={6}
                    placeholder="6 行高度"
                  />
                ...
                <div>
                  <div className="fs-12 color-gray-4 mb-2">禁止调整大小</div>
                  <Textarea
                    resize="none"
