...
const linkProps = [
  ...
  { name: 'target', type: 'LinkTarget', default: '_self', desc: '链接打开方式：_self | _blank | _parent | _top' },
  { name: 'anchor', type: 'string', desc: '链接锚点' },
  { name: 'disabled', type: 'boolean', default: 'false', desc: '是否禁用链接' },
  { name: 'status', type: 'LinkStatus', default: 'default', desc: '链接状态：default | primary | warning | danger | success' },
  { name: 'size', type: 'LinkSize', default: 'default', desc: '链接尺寸：mini | small | default | large' },
  { name: 'underline', type: 'boolean', default: 'false', desc: '是否显示下划线' },
  { name: 'hoverUnderline', type: 'boolean', default: 'false', desc: '悬停时是否显示下划线' },
