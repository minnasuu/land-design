...
/** 默认波形采样数量 */
export const DEFAULT_WAVE_SAMPLE_COUNT = 100;

/** 默认波形条形宽度 */
export const DEFAULT_WAVE_BAR_WIDTH = 2;

/** 默认波形条形间距 */
export const DEFAULT_WAVE_BAR_GAP = 1;

/** 默认波形高度 */
export const DEFAULT_WAVE_HEIGHT = 48;
