...
export default function DrawerExample() {
  ...
  const drawerProps = [
    ...
    { name: 'position', type: 'left | right | top | bottom', default: 'right', desc: '侧拉窗出现位置' },
    { name: 'width', type: 'string | number', default: '400px', desc: '侧拉窗宽度（左右位置时）' },
    { name: 'height', type: 'string | number', default: '100%', desc: '侧拉窗高度（上下位置时）' },
    { name: 'submitLabel', type: 'string', default: '确定', desc: '提交按钮文案' },
    { name: 'cancelLabel', type: 'string', default: '取消', desc: '取消按钮文案' },
    { name: 'mask', type: 'boolean', default: 'true', desc: '是否显示遮罩层' },
