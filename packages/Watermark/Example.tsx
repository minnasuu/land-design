...
export default function WatermarkExample() {
  ...
  const watermarkProps = [
    ...
    { name: 'fontSize', type: 'number', desc: '文字水印的字体大小', default: '16' },
    { name: 'fontColor', type: 'string', desc: '文字水印的颜色', default: 'rgba(0, 0, 0, 0.1)' },
    { name: 'width', type: 'number', desc: '图片水印的宽度' },
    { name: 'height', type: 'number', desc: '图片水印的高度' },
    { name: 'gap', type: '[number, number]', desc: '水印之间的间距，[水平间距, 垂直间距]', default: '[100, 100]' },
    { name: 'rotate', type: 'number', desc: '水印的旋转角度', default: '-22' },
    { name: 'zIndex', type: 'number', desc: '水印的层级', default: '1000' },
