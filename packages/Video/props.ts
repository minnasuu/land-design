import React, { CSSProperties, MouseEvent as ReactMouseEvent } from "react";
...
/** 默认播放速率选项 */
export const DEFAULT_RATE_OPTIONS: VideoRateOption[] = [
...
/** 默认音量调节步长 */
export const DEFAULT_VOLUME_STEP = 10;
