...
import pn, { useMemo as j, useState as F, useEffect as de, createContext as Yn, useRef as le, useLayoutEffect as Uc, useId as Js, useContext as ft, useInsertionEffect as Ca, useCallback as M, Children as Yc, isValidElement as Kc, forwardRef as Ma, Fragment as vr, createElement as zc, Component as Xc, useImperativeHandle as qc } from "react";
...
const Q2 = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: o = !0, mode: i = "sync", propagate: a = !1, anchorX: l = "left", root: c }) => {
  const [u, d] = kl(a), p = j(() => gi(e), [e]), h = a && !u ? [] : p.map(Tr), f = le(!0), m = le(p), v = eo(() => /* @__PURE__ */ new Map()), [L, k] = F(p), [y, C] = F(p);
  Na(() => {
  ...
  function a(c) {
    ...
    for (let L = 0; L < Qf; L++) {
      ...
      const { prevResolvedValues: S = {} } = y, P = {
        ...
        T = !0, h.has(B) && (_ = !0, h.delete(B)), y.needsAnimating[B] = !0;
        const X = e.getValue(B);
        X && (X.liveStyle = !1);
      };
      for (const B in P) {
        const X = H[B], Q = S[B];
        if (f.hasOwnProperty(B))
          continue;
        let z = !1;
        Es(X) && Es(Q) ? z = !Dl(X, Q) : z = X !== Q, z ? X != null ? O(B) : h.add(B) : X !== void 0 && h.has(B) ? O(B) : y.protectedKeys[B] = !0;
      }
      y.prevProp = C, y.prevResolvedValues = H, y.isActive && (f = { ...f, ...H }), r && e.blockInitialAnimation && (T = !1), T && (!(x && N) || _) && p.push(...V.map((B) => ({
        animation: B,
        options: { type: k }
      })));
    }
...
const S0 = (e, t) => To(e) ? new T0(t) : new j0(t, {
  ...
  const [f, m] = F(e ?? !1), [v, L] = F(null), [k, y] = F({ width: 0, height: 0 }), [C, w] = F(i), [b, x] = F(!1), N = le(null), T = le(null), _ = le(r), V = le(!0), H = le(i);
  de(() => {
    _.current = r, H.current = i;
  }), de(() => (V.current = !0, () => {
    V.current = !1;
  }), []);
  const S = 8, P = 8, O = 12, Y = l === "body";
  de(() => {
    e !== void 0 && m(e);
  }, [e]), de(() => {
    if (!f && Y) {
  ...
  de(() => {
    var D;
    te.current !== f && (te.current = f, (D = _.current) == null || D.call(_, f));
  }, [f]);
  const B = le(k);
  B.current = k;
  const X = le();
  X.current = () => {
    if (!N.current || !Y || !V.current) return;
    const D = B.current;
    if (D.width === 0 || D.height === 0) return;
    const fe = N.current.getBoundingClientRect(), ne = window.innerWidth, ge = window.innerHeight, I = (se) => {
      switch (se) {
        case "top":
          return {
            top: fe.top - D.height - S,
            left: fe.left + (fe.width - D.width) / 2
          };
        case "bottom":
          return {
            top: fe.bottom + S,
        ...
        case "left":
          return {
            top: fe.top + (fe.height - D.height) / 2,
            left: fe.left - D.width - S
          };
        case "right":
          return {
            top: fe.top + (fe.height - D.height) / 2,
      ...
      const { top: $e, left: He } = se, we = $e + D.height, Ae = He + D.width;
      return ve === "top" || ve === "bottom" ? $e >= P && we <= ge - P : He >= P && Ae <= ne - P;
    }, Z = (se) => ({
      top: "bottom",
      bottom: "top",
      left: "right",
    ...
    let ie = H.current, ee = I(ie);
    if (!E(ee, ie)) {
      const se = Z(ie), ve = I(se);
      E(ve, se) && (ie = se, ee = ve);
    }
    let { top: R, left: oe } = ee;
    R = Math.max(P, Math.min(ge - D.height - P, R)), oe = Math.max(P, Math.min(ne - D.width - P, oe)), L((se) => se && se.top === R && se.left === oe ? se : { top: R, left: oe }), w((se) => se === ie ? se : ie), x(!0);
  }, de(() => {
    if (!Y || !f) return;
    const D = () => {
      var fe;
      return (fe = X.current) == null ? void 0 : fe.call(X);
    };
    ...
    if (!T.current || !f || !Y) return;
    const D = new ResizeObserver((fe) => {
      for (const ne of fe) {
    ...
    var D;
    f && Y && k.width > 0 && k.height > 0 && ((D = X.current) == null || D.call(X));
  }, [f, Y, k]), de(() => {
    if (n !== "click" || !f) return;
    const D = (fe) => {
      N.current && !N.current.contains(fe.target) && m(!1);
    };
  ...
  const Q = M(() => {
    ...
    if (!N.current || k.width === 0 || k.height === 0 || !v)
      return {};
    const fe = N.current.getBoundingClientRect(), ne = fe.left + fe.width / 2, ge = fe.top + fe.height / 2, I = (Z, ie) => Math.max(O, Math.min(ie - O, Z)), E = D[C];
    switch (C) {
      case "top":
        return {
  ...
  }, [Y, i, C, v, k, O]), U = j(() => [Dn, c].filter(Boolean).join(" "), [c]), re = j(() => [
    `${Dn}__bubble`,
    `${Dn}__bubble--${o}`,
...
const P0 = "land-loading", Gn = ({
  ...
  const [x, N] = F(!0), [T, _] = F(!1), V = j(() => A0[e] || "info", [e]), H = j(() => B0[n] || "horizontal", [n]), S = j(() => m ? "text" : t, [m, t]), P = j(() => ({
    ...
    T && `${ut}--closing`,
    v
  ].filter(Boolean).join(" "), [V, S, H, r, u, T, v]), Y = M((Q) => {
    d ? (_(!0), setTimeout(() => {
      N(!1), w == null || w();
    }, 300)) : (N(!1), w == null || w()), C == null || C(Q);
  }, [d, C, w]), te = () => {
    if (a === !1) return null;
    if (a)
      return /* @__PURE__ */ s("span", { className: `${ut}__icon`, style: k, children: a });
    const Q = R0[V];
    return V === "loading" ? /* @__PURE__ */ s("span", { className: `${ut}__icon`, style: k, children: /* @__PURE__ */ s(Gn, { size: P, color: Q.color }) }) : /* @__PURE__ */ s("span", { className: `${ut}__icon`, style: k, children: /* @__PURE__ */ s(Le, { name: Q.name, size: P, color: Q.color }) });
  }, B = () => /* @__PURE__ */ g("div", { className: `${ut}__content`, style: y, children: [
    ...
    f,
    l && /* @__PURE__ */ s("span", { className: `${ut}__close`, onClick: Y, children: c || /* @__PURE__ */ s(Le, { name: "close", size: 14 }) })
  ] });
  ...
  const c = le(null), [u, d] = F(""), [p, h] = F(0), [f, m] = F(-1), [v, L] = F(!1), k = M(() => l(), [l]), y = M((_) => _ === window ? window.pageYOffset || document.documentElement.scrollTop : _.scrollTop, []), C = M((_, V) => {
    ...
    if (H)
      if (n === 0)
        ...
        const P = S === window ? { top: 0 } : S.getBoundingClientRect(), Y = H.getBoundingClientRect().top - P.top, B = y(S) + Y - n;
        C(S, B);
      }
    t == null || t(_);
  }, [n, t, k, y, C]);
  de(() => {
    const _ = (S) => {
      ...
      if (P.length > 0) {
        const O = P[0].target.id;
        d(O), h(w.indexOf(O)), t == null || t(O);
      } else
        S.forEach((O) => {
          const Y = O.target.id;
          if (!O.isIntersecting && u === Y) {
            const te = w.indexOf(Y), B = w[te - 1] || null;
            d(B), h(w.indexOf(B)), B && (t == null || t(B));
          }
        });
...
const dc = ({
  ...
  const y = le(null), C = le(null), w = le(), b = le(null), [x, N] = F([]), [T, _] = F(!0), [V, H] = F(null), [S, P] = F(0), [O, Y] = F(0), te = r ?? S, B = o ?? O;
  de(() => {
    if (!e) return;
    (async () => {
      _(!0), H(null);
      try {
        const U = new (window.AudioContext || window.webkitAudioContext)(), pe = await (await fetch(e)).arrayBuffer(), he = await U.decodeAudioData(pe), ce = Z0(he, a);
        N(ce), U.close();
      } catch (U) {
        H(U instanceof Error ? U.message : "波形加载失败"), console.error("波形生成失败:", U);
      } finally {
        _(!1);
      }
    })();
  ...
  const X = M(() => {
    ...
    const U = b.current;
    if (U) {
      const pe = U.getBoundingClientRect();
  ...
  de(() => (n ? Q() : (z(), X()), () => z()), [n, Q, z, X]), de(() => {
    ...
    return $.addEventListener("timeupdate", U), $.addEventListener("loadedmetadata", re), $.addEventListener("play", pe), $.addEventListener("pause", he), () => {
      $.removeEventListener("timeupdate", U), $.removeEventListener("loadedmetadata", re), $.removeEventListener("play", pe), $.removeEventListener("pause", he);
    };
  }, [t, m]), de(() => {
    ...
    return U.observe($), () => U.disconnect();
  }, [x, X]);
  const W = M(($) => {
    if (!v || !b.current) return;
    const U = b.current.getBoundingClientRect(), re = $.clientX - U.left, pe = Math.max(0, Math.min(1, re / U.width));
    v(pe);
  }, [v]), q = j(() => {
  ...
  const u = le(null), [d, p] = F(!1), [h, f] = F(!1), m = M((C) => {
  ...
  const z = le(null), [W, q] = F("idle"), [$, U] = F(!1), [re, pe] = F(0), [he, ce] = F(0), [Ce, ae] = F(0), [D, fe] = F(a), [ne, ge] = F(i), [I, E] = F(!1), Z = M(() => ({
    currentTime: re,
    duration: he,
    progress: he > 0 ? re / he : 0,
    volume: D,
    muted: ne,
    playbackRate: l,
    status: W
  }), [re, he, D, ne, l, W]), ie = M((Ve) => {
    q(Ve), Y == null || Y(Ve);
  }, [Y]), ee = M(async () => {
    if (z.current)
      try {
        ...
        console.error("播放失败:", Ve), ie("error"), O == null || O(Ve);
      }
  }, [ie, O]), R = M((Ve) => {
    if (!z.current || !he) return;
    const Ue = Ve * he;
    z.current.currentTime = Ue, pe(Ue), S == null || S(Ue);
  }, [he, S]);
  M((Ve) => {
    if (!z.current) return;
    const Ue = Math.max(0, Math.min(100, Ve));
    fe(Ue), z.current.volume = Ue / 100, Ue > 0 && ne && (ge(!1), z.current.muted = !1), H == null || H(Ue, Ue === 0);
  }, [ne, H]);
  const oe = M(() => {
    if (!z.current || I) return;
    const Ve = z.current;
    pe(Ve.currentTime), Ve.buffered.length > 0 && ae(Ve.buffered.end(Ve.buffered.length - 1)), V == null || V(Z());
  }, [I, Z, V]), se = M(() => {
    if (!z.current) return;
    const Ve = z.current;
    ce(Ve.duration), ie("idle"), P == null || P(Z());
  }, [Z, ie, P]), ve = M(() => {
    U(!0), ie("playing"), N == null || N(Z());
  }, [Z, ie, N]), $e = M(() => {
    U(!1), ie("paused"), T == null || T(Z());
  }, [Z, ie, T]), He = M(() => {
    U(!1), ie("ended"), _ == null || _(Z());
  }, [Z, ie, _]), we = M(() => {
    ie("error"), O == null || O(new Error("音频加载失败"));
  }, [ie, O]);
  de(() => {
  ...
  const Ae = j(() => {
    const Ve = ["land-audio"];
    return W === "error" && Ve.push("land-audio--error"), f && Ve.push("land-audio--with-wave"), te && Ve.push(te), Ve.join(" ");
  }, [W, f, te]);
  return /* @__PURE__ */ g("div", { className: Ae, style: B, children: [
    /* @__PURE__ */ s(
      "audio",
      {
        ref: z,
    ...
    /* @__PURE__ */ g("div", { className: "land-audio__content", children: [
      ...
      /* @__PURE__ */ g("div", { className: "land-audio__controls", children: [
        ...
        p && /* @__PURE__ */ g("div", { className: "land-audio__time", children: [
          ...
          /* @__PURE__ */ s("span", { className: "land-audio__time-duration", children: zr(he) })
        ] })
      ] })
    ] }),
    Q
...
const om = ({
  ...
  const l = le(null), [c, u] = F(!1), [d, p] = F(!0);
  de(() => {
...
const Cr = ({
  ...
  const y = le(null), C = le(null), [w, b] = F(v), x = le(!0), N = le(u), T = le(d), _ = le(i), V = le(a);
  de(() => {
  ...
  const [P, O] = F({ top: 0, left: 0 }), [Y, te] = F(i), [B, X] = F(a), Q = le();
  Q.current = () => {
    if (!y.current || !x.current) return;
    const ae = y.current.getBoundingClientRect(), D = window.innerWidth, fe = window.innerHeight, ne = C.current, ge = (ne == null ? void 0 : ne.offsetWidth) || 200, I = (ne == null ? void 0 : ne.offsetHeight) || 150;
    let E = _.current, Z = V.current;
    const ie = fe - ae.bottom, ee = ae.top;
    if (_.current === "bottom" && ie < I && ee > I ? E = "top" : _.current === "top" && ee < I && ie > I && (E = "bottom"), S) {
      const R = parseFloat(
      ...
      se < 0 ? (se = 0, Z = "left") : se + ge > D && (se = D - ge, Z = "right"), oe < 0 ? oe = 0 : oe + I > fe && (oe = fe - I), O((ve) => ve.top === oe && ve.left === se ? ve : { top: oe, left: se });
    }
    te((R) => R === E ? R : E), X((R) => R === Z ? R : Z);
  };
  const z = M(() => {
    var ae;
    (ae = Q.current) == null || ae.call(Q);
  }, []);
  de(() => {
    if (w && !l) {
    ...
    const ae = () => {
      var fe;
      return (fe = Q.current) == null ? void 0 : fe.call(Q);
    }, D = () => {
      var fe;
      return (fe = Q.current) == null ? void 0 : fe.call(Q);
    };
  ...
  de(() => {
    var ae, D;
    W.current !== w && (W.current = w, w ? (ae = N.current) == null || ae.call(N) : (D = T.current) == null || D.call(T));
  }, [w]), de(() => {
    if (!w || l) return;
    const ae = (D) => {
      var ne, ge;
      const fe = D.target;
      (ne = y.current) != null && ne.contains(fe) || (ge = C.current) != null && ge.contains(fe) || b(!1);
    };
  ...
  const q = M((ae) => {
    ...
    p,
    L
  ].filter(Boolean).join(" "), [w, l, p, L]), U = j(() => [
    `${Tt}__panel`,
    w && `${Tt}__panel--open`,
    S && `${Tt}__panel--portal`,
    `${Tt}__panel--${B}`,
    `${Tt}__panel--${Y}`
  ].filter(Boolean).join(" "), [w, S, B, Y]), re = j(() => [`${Tt}__content`, f].filter(Boolean).join(" "), [f]), pe = M(() => {
    l || e === "click" && b((ae) => !ae);
  }, [l, e]), he = M(() => {
    l || e !== "hover" || b(!0);
  }, [l, e]), ce = M(() => {
    ...
    "div",
    {
      ...
      onMouseEnter: S ? he : void 0,
      onMouseLeave: S ? ce : void 0,
  ...
  const H = e ?? t ?? [], S = c ?? Q0[u] ?? "outline", P = n ?? r, O = o ?? i, [Y, te] = F(P), [B, X] = F(O), [Q, z] = F(!1), W = le(O), q = le(B);
  q.current = B, de(() => {
    P !== void 0 && te((I) => I === P ? I : P);
  }, [P]), de(() => {
    const I = W.current;
    I.length === O.length && I.every((Z, ie) => Z === O[ie]) || (W.current = O, X(O));
  });
  const $ = j(() => a ? H.filter((I) => B.includes(I.key)) : H.filter((I) => I.key === Y), [a, H, B, Y]), U = j(() => $.map((I) => I.label), [$]), re = M(
    (I) => a ? B.includes(I) : Y === I,
    [a, B, Y]
  ), pe = M(
    (I, E) => {
      if (E.stopPropagation(), !I.disabled)
        if (a) {
          const ie = [...q.current], ee = ie.indexOf(I.key);
          ee > -1 ? ie.splice(ee, 1) : ie.push(I.key), X(ie);
          const R = H.filter(
            (oe) => ie.includes(oe.key)
          );
          _ == null || _(ie, I, R);
        } else
          te(I.key), _ == null || _(I.key, I), z(!1);
    },
    [a, H, _]
  ), he = M(() => {
    z(!0);
    ...
    var I;
    return y ? y({
      values: a ? B : Y !== void 0 ? [Y] : [],
      items: $,
      isMultiple: a,
      placeholder: l
    }) : (a ? U.length === 0 : Y === void 0 || Y === "") ? /* @__PURE__ */ s("span", { className: `${nt}__placeholder`, children: l }) : a ? v !== void 0 && U.length > v ? /* @__PURE__ */ g("span", { className: `${nt}__value`, children: [
      U.slice(0, v).join(m),
      "等",
      U.length,
      "个选项"
    ] }) : /* @__PURE__ */ s("span", { className: `${nt}__value`, children: U.join(m) }) : /* @__PURE__ */ s("span", { className: `${nt}__value`, children: (I = $[0]) == null ? void 0 : I.label });
  }, [
    y,
    a,
    B,
    ...
    [H, ae, w, N, T]
  ), fe = j(() => [nt, b].filter(Boolean).join(" "), [b]), ne = j(() => ({
    ...
    Q && `${nt}__trigger--open`
  ].filter(Boolean).join(" "), [S, d, p, Q]);
  return /* @__PURE__ */ s("div", { className: fe, style: ne, children: /* @__PURE__ */ s(
    Cr,
    {
      trigger: "click",
      disabled: p,
...
const i3 = (e) => {
  const {
    ...
    children: P,
    ...O
  } = e, Y = /* @__PURE__ */ new Date(), [te, B] = F(() => t || n || Y), [X, Q] = F(() => t ?? n ?? null), z = t !== void 0, W = z ? t : X, q = te.getFullYear(), $ = te.getMonth(), { yearRange: U, showYearSelector: re } = j(() => ({
    yearRange: mc(a, l),
    ...
    return !ys(Me, K, a, l);
  }, [$, q, a, l]), ce = j(() => h ? q !== Y.getFullYear() || $ !== Y.getMonth() : !1, [h, q, $]), Ce = j(() => {
    const K = W == null ? void 0 : W.getDate(), Me = W == null ? void 0 : W.getMonth(), xe = W == null ? void 0 : W.getFullYear();
    return s3(q, $, void 0, a, l).map((De) => ({
      ...De,
      isSelected: De.isCurrentMonth && De.dayNumber === K && De.month === Me && De.year === xe
    }));
  }, [q, $, W, a, l]), ae = j(() => o3(q, $, void 0, a, l), [q, $, a, l]), D = j(() => [
    { zh: "一月", en: "Jan" },
    { zh: "二月", en: "Feb" },
    { zh: "三月", en: "Mar" },
    { zh: "四月", en: "Apr" },
    ...
    ...Me,
    value: xe,
    isCurrentMonth: q === Y.getFullYear() && xe === Y.getMonth(),
    isSelected: W ? q === W.getFullYear() && xe === W.getMonth() : !1,
    isDisabled: !ys(q, xe, a, l)
  })), [q, W, a, l]), fe = j(() => {
    const K = Math.floor(Y.getMonth() / 3) + 1, Me = W ? Math.floor(W.getMonth() / 3) + 1 : null;
    return [
      ...
      ...xe,
      isCurrentQuarter: q === Y.getFullYear() && xe.value === K,
      isSelected: W ? q === W.getFullYear() && xe.value === Me : !1,
      isDisabled: !n3(q, xe.value, a, l)
    }));
  }, [q, W, o, a, l]), ne = Math.floor(q / 10) * 10, ge = j(() => Array.from({ length: 10 }, (K, Me) => {
    const xe = ne + Me;
    return {
      year: xe,
      isCurrentYear: xe === Y.getFullYear(),
      isSelected: W ? xe === W.getFullYear() : !1,
    ...
    let K;
    r === "date" || r === "week" ? K = new Date(q, $ - 1, 1) : r === "month" || r === "quarter" ? K = new Date(q - 1, $, 1) : K = new Date(ne - 10, 0, 1), I(K);
  }, [r, q, $, ne, I]), Z = M(() => {
    let K;
    r === "date" || r === "week" ? K = new Date(q, $ + 1, 1) : r === "month" || r === "quarter" ? K = new Date(q + 1, $, 1) : K = new Date(ne + 10, 0, 1), I(K);
  }, [r, q, $, ne, I]), ie = M((K) => {
    ...
    const Me = fe.find((lt) => lt.value === K);
    ...
    if (r === "year") {
      K = `${ne}-${ne + 9}`;
      const [xe, De] = U, lt = Math.floor(xe / 10) * 10, wt = Math.floor(De / 10) * 10;
      Me = [];
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar__grid land-calendar__grid--week", children: ae.map((K, Me) => {
      const xe = W ? K.dates.some((De) => De.toDateString() === W.toDateString()) : !1;
      return /* @__PURE__ */ s(
        "div",
        {
          ...
          children: K.dates.map((De, lt) => /* @__PURE__ */ s(
            "div",
            {
              className: `land-calendar__cell ${De.toDateString() === Y.toDateString() ? "land-calendar__cell--today" : ""} ${De.getMonth() !== $ ? "land-calendar__cell--other" : ""}`,
    ...
    Me
  )) }), Ue = () => /* @__PURE__ */ s("div", { className: "land-calendar__grid land-calendar__grid--quarter", children: fe.map((K, Me) => /* @__PURE__ */ g(
    "div",
    {
    ...
    Me
  )) }), Fe = () => /* @__PURE__ */ s("div", { className: "land-calendar__grid land-calendar__grid--year", children: ge.map((K, Me) => /* @__PURE__ */ s(
    "div",
    {
  ...
  const {
    ...
    contentStyle: N,
    htmlProps: T
  } = e, _ = c !== void 0, [V, H] = F(u), S = _ ? c : V, P = le(null), O = le(null), [Y, te] = F(S ? "auto" : 0), [B, X] = F(!1), [Q, z] = F(S || !h), W = M(() => O.current ? O.current.scrollHeight : 0, []);
  de(() => {
    if (!f) {
      te(S ? "auto" : 0), z(S || !h);
      return;
  ...
  const q = M(() => {
    ...
    const D = [kt];
    return D.push(`${kt}--${t}`), S && D.push(`${kt}--expanded`), d && D.push(`${kt}--disabled`), B && D.push(`${kt}--animating`), y && D.push(y), D.join(" ");
  }, [t, S, d, B, y]), pe = j(() => {
    const D = [`${kt}__header`];
    ...
    ...N,
    height: Y === "auto" ? "auto" : `${Y}px`,
    transitionDuration: f ? `${m}ms` : "0ms"
  }), [N, Y, f, m]), Ce = () => p ? null : l !== void 0 ? typeof l == "function" ? /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: l(S) }) : /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: l }) : /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: /* @__PURE__ */ s(
    Le,
    {
      name: "arrow",
      strokeWidth: 4,
  ...
  return /* @__PURE__ */ g("div", { className: re, style: C, ...T, children: [
    ...
    /* @__PURE__ */ s(
      "div",
      {
        ...
        style: ce,
        "aria-hidden": !S,
        children: /* @__PURE__ */ s("div", { ref: O, className: `${kt}__content-inner`, children: Q && ae() })
      }
    )
  ] });
  ...
  const x = le(null), N = le(null), [T, _] = F(i ?? ""), V = le(!1);
  de(() => {
    V.current || _(i ?? "");
  }, [i]);
  const H = j(
    ...
    var pe, he, ce;
    if ($.type === "default")
      return /* @__PURE__ */ s("span", { children: $.text }, U);
    if (b)
      return /* @__PURE__ */ s(pn.Fragment, { children: b($.text, $.item) }, U);
    const re = {};
    return (pe = $.item) != null && pe.color && (re.color = $.item.color), (he = $.item) != null && he.backgroundColor && (re.backgroundColor = $.item.backgroundColor), /* @__PURE__ */ s(
      "span",
      {
        className: `${Qe}__highlight-item ${((ce = $.item) == null ? void 0 : ce.className) || ""}`,
        style: re,
        children: $.text
      },
      U
  ...
  return /* @__PURE__ */ s("div", { className: S, style: y, children: /* @__PURE__ */ g("div", { className: `${Qe}__content`, children: [
    ...
    /* @__PURE__ */ g("div", { className: `${Qe}__body ${Qe}__body--highlight`, children: [
      W(),
      /* @__PURE__ */ s("input", { className: `${Qe}__input--transparent`, ...Q })
    ] }),
  ...
  const N = le(null), T = le(null), [_, V] = F(i ?? ""), H = le(!1);
  de(() => {
    H.current || V(i ?? "");
  }, [i]);
  const S = j(() => [
  ...
  ] }) : null, W = () => !m || !_ ? null : /* @__PURE__ */ g("div", { className: `${Ee}__suffix-ghost`, children: [
...
const ln = "land-divider", qt = ({
  ...
  const Y = e !== void 0, [te, B] = F(() => e !== void 0 ? e : t);
  de(() => {
    e !== void 0 && B(e);
  }, [e]);
  const X = Y ? e : te, Q = M(
    ...
    (ne) => {
      let ge = ne;
      return u !== void 0 && ge < u && (ge = u), d !== void 0 && ge > d && (ge = d), Q(ge);
    },
    [u, d, Q]
  ), W = M(
    (ne) => {
    ...
    (ne, ge) => {
      if (k) return;
      let I = ne;
      I !== void 0 && (I = z(I), h && !W(I)) || (Y || B(I), V == null || V(I, ge));
    },
    [k, z, h, W, Y, V]
  ), U = M(
    (ne, ge) => {
    ...
    (ne, ge) => {
      if (k) return;
      const I = X ?? 0, E = ne === "up" ? c : -c, Z = Q(I + E);
      ne === "up" && Z > d || ne === "down" && Z < u || ($(Z, { source: "step", event: ge }), H == null || H(Z, ne));
    },
    [k, X, c, Q, d, u, $, H]
  ), pe = M(
    (ne) => {
  ...
  }, [o, i, a, k, C, N, w]), ae = X !== void 0 && X <= u, D = X !== void 0 && X >= d, fe = (ne) => {
    const ge = k || (ne === "up" ? D : ae), I = [
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      "data-value": X,
      children: [
        a === "both" && /* @__PURE__ */ s("div", { className: "land-number-input__stepper land-number-input__stepper--left", children: fe("down") }),
        C ? /* @__PURE__ */ s(
          at,
          {
            attach: "body",
        ...
        a === "both" && /* @__PURE__ */ s("div", { className: "land-number-input__stepper land-number-input__stepper--right", children: fe("up") })
      ]
    }
  );
}, Te = {
  ...
  const {
    ...
    onOpenChange: H,
    onClear: S
  } = e, [P, O] = F(n), [Y, te] = F(r || "hex"), [B, X] = F(!1), [Q, z] = F(0), [W, q] = F(100), [$, U] = F(100), [re, pe] = F(1), [he, ce] = F(""), [Ce, ae] = F({ r: 0, g: 0, b: 0 }), [D, fe] = F({ h: 0, s: 0, l: 0 }), [ne, ge] = F({ h: 0, s: 0, v: 0 }), I = le(!1), E = le(null), Z = le(null), ie = le(null), ee = t !== void 0, R = ee ? t : P, oe = M((A) => {
    const G = Te.hexToRgb(A);
  ...
  de(() => {
    if (!I.current && R) {
      const A = oe(R);
      if (A) {
        z(A.h), q(A.s), U(A.v), ge(A);
        const G = Te.hsvToRgb(A.h, A.s, A.v), me = Te.rgbToHex(G.r, G.g, G.b), J = Te.rgbToHsl(G.r, G.g, G.b);
        ce(me), ae(G), fe(J);
      }
      I.current = !0;
    }
  ...
  const se = j(() => {
    const A = Te.hsvToRgb(Q, W, $), G = Te.rgbToHex(A.r, A.g, A.b), me = Te.rgbToHsl(A.r, A.g, A.b), J = { h: Q, s: W, v: $ }, ke = `rgb(${A.r}, ${A.g}, ${A.b})`, je = `rgba(${A.r}, ${A.g}, ${A.b}, ${re})`, be = `hsl(${me.h}, ${me.s}%, ${me.l}%)`, Ze = `hsv(${J.h}, ${J.s}%, ${J.v}%)`;
    let Vt = G;
    switch (Y) {
      case "rgb":
        Vt = ke;
    ...
    (A) => {
      ee || O(A.hex), T == null || T(A), _ == null || _(A.color, A.hex, A.rgba);
    },
    [ee, T, _]
  ), $e = M(
    (A) => {
      const G = Te.hsvToRgb(A.h, A.s, A.v), me = Te.rgbToHex(G.r, G.g, G.b), J = Te.rgbToHsl(G.r, G.g, G.b);
      ce(me), ae(G), fe(J), ge(A);
    },
    []
  ), He = M(
    (A, G) => {
      q(A), U(G);
      const me = { h: Q, s: A, v: G };
      $e(me);
      const J = Te.hsvToRgb(Q, A, G), ke = Te.rgbToHex(J.r, J.g, J.b), je = Te.rgbToHsl(J.r, J.g, J.b), be = {
        color: ke,
        hex: ke,
        rgb: `rgb(${J.r}, ${J.g}, ${J.b})`,
        rgba: `rgba(${J.r}, ${J.g}, ${J.b}, ${re})`,
    ...
    (A) => {
      ...
      const G = { h: A, s: W, v: $ };
      $e(G);
      const me = Te.hsvToRgb(A, W, $), J = Te.rgbToHex(me.r, me.g, me.b), ke = Te.rgbToHsl(me.r, me.g, me.b), je = {
        color: J,
        hex: J,
        rgb: `rgb(${me.r}, ${me.g}, ${me.b})`,
        rgba: `rgba(${me.r}, ${me.g}, ${me.b}, ${re})`,
    ...
    (A) => {
      pe(A);
      const G = Te.hsvToRgb(Q, W, $), me = Te.rgbToHex(G.r, G.g, G.b), J = Te.rgbToHsl(G.r, G.g, G.b), ke = { h: Q, s: W, v: $ }, je = {
        color: me,
        hex: me,
        rgb: `rgb(${G.r}, ${G.g}, ${G.b})`,
        rgba: `rgba(${G.r}, ${G.g}, ${G.b}, ${A})`,
        hsl: `hsl(${J.h}, ${J.s}%, ${J.l}%)`,
        hsv: `hsv(${Q}, ${W}%, ${$}%)`,
        alpha: A,
        rgbObject: G,
    ...
    (A) => {
      let G = A.replace("#", "").toUpperCase();
      G = G.replace(/[^0-9A-F]/g, "").slice(0, 6);
      const me = G.length > 0 ? `#${G}` : "#";
      if (ce(me), G.length === 6) {
        const J = Te.hexToRgb(me);
        if (J) {
          const ke = Te.rgbToHsv(J.r, J.g, J.b);
          z(ke.h), q(ke.s), U(ke.v), $e(ke);
          const je = Te.rgbToHsl(J.r, J.g, J.b), be = {
            color: me,
            hex: me,
            rgb: `rgb(${J.r}, ${J.g}, ${J.b})`,
            rgba: `rgba(${J.r}, ${J.g}, ${J.b}, ${re})`,
    ...
    (A, G) => {
      const me = Math.max(0, Math.min(255, Math.round(G))), J = { ...Ce, [A]: me };
      ae(J);
      const ke = Te.rgbToHsv(J.r, J.g, J.b), je = Te.rgbToHex(J.r, J.g, J.b), be = Te.rgbToHsl(J.r, J.g, J.b);
      z(ke.h), q(ke.s), U(ke.v), ce(je), ge(ke), fe(be);
      const Ze = {
        color: `rgb(${J.r}, ${J.g}, ${J.b})`,
        hex: je,
        rgb: `rgb(${J.r}, ${J.g}, ${J.b})`,
        rgba: `rgba(${J.r}, ${J.g}, ${J.b}, ${re})`,
    ...
    (A, G) => {
      let me = G;
      A === "h" ? me = (G % 360 + 360) % 360 : me = Math.max(0, Math.min(100, Math.round(G)));
      const J = { ...ne, [A]: me };
      ge(J), z(J.h), q(J.s), U(J.v);
      const ke = Te.hsvToRgb(J.h, J.s, J.v), je = Te.rgbToHex(ke.r, ke.g, ke.b), be = Te.rgbToHsl(ke.r, ke.g, ke.b);
      ce(je), ae(ke), fe(be);
      const Ze = {
        color: `hsv(${J.h}, ${J.s}%, ${J.v}%)`,
        hex: je,
        rgb: `rgb(${ke.r}, ${ke.g}, ${ke.b})`,
        rgba: `rgba(${ke.r}, ${ke.g}, ${ke.b}, ${re})`,
        hsl: `hsl(${be.h}, ${be.s}%, ${be.l}%)`,
        hsv: `hsv(${J.h}, ${J.s}%, ${J.v}%)`,
        alpha: re,
        rgbObject: ke,
    ...
    (A, G) => {
      ...
      const J = { ...D, [A]: me };
      fe(J);
      const ke = Te.hslToRgb(J.h, J.s, J.l), je = Te.rgbToHsv(ke.r, ke.g, ke.b), be = Te.rgbToHex(ke.r, ke.g, ke.b);
      z(je.h), q(je.s), U(je.v), ce(be), ae(ke), ge(je);
      const Ze = {
        color: `hsl(${J.h}, ${J.s}%, ${J.l}%)`,
        hex: be,
        rgb: `rgb(${ke.r}, ${ke.g}, ${ke.b})`,
        rgba: `rgba(${ke.r}, ${ke.g}, ${ke.b}, ${re})`,
        hsl: `hsl(${J.h}, ${J.s}%, ${J.l}%)`,
    ...
    (A) => {
      const G = Te.hexToRgb(A);
      if (G) {
        const me = Te.rgbToHsv(G.r, G.g, G.b), J = Te.rgbToHsl(G.r, G.g, G.b);
        z(me.h), q(me.s), U(me.v), ce(A), ae(G), ge(me), fe(J);
        const ke = {
          color: A,
          hex: A,
          rgb: `rgb(${G.r}, ${G.g}, ${G.b})`,
    ...
    (A) => {
      if (!E.current) return;
      const G = (ke, je) => {
        const be = E.current.getBoundingClientRect(), Ze = Math.max(0, Math.min(1, (ke - be.left) / be.width)), Vt = Math.max(0, Math.min(1, (je - be.top) / be.height));
        He(Ze * 100, (1 - Vt) * 100);
      };
      G(A.clientX, A.clientY);
      const me = (ke) => {
        G(ke.clientX, ke.clientY);
      }, J = () => {
        document.removeEventListener("mousemove", me), document.removeEventListener("mouseup", J);
      };
      document.addEventListener("mousemove", me), document.addEventListener("mouseup", J);
    },
    [He]
  ), xe = M(
    (A) => {
      if (!Z.current) return;
      const G = (ke) => {
        const je = Z.current.getBoundingClientRect(), be = Math.max(0, Math.min(1, (ke - je.left) / je.width));
        we(be * 360);
      };
      G(A.clientX);
      const me = (ke) => {
    ...
    (A) => {
      ...
      const G = (ke) => {
        const je = ie.current.getBoundingClientRect(), be = Math.max(0, Math.min(1, (ke - je.left) / je.width));
        Ae(be);
      };
      G(A.clientX);
      const me = (ke) => {
    ...
    const A = ["land-color-picker"];
    return a && a !== "default" && A.push(`land-color-picker--${a}`), i && A.push("land-color-picker--disabled"), L && A.push(L), A.join(" ");
  }, [a, i, L]), wt = j(() => {
    const A = Te.hsvToRgb(Q, 100, 100);
    return { backgroundColor: Te.rgbToHex(A.r, A.g, A.b) };
  }, [Q]), ue = j(() => {
    const A = Te.hsvToRgb(Q, W, $);
    return {
      background: `linear-gradient(to right, transparent 0%, ${Te.rgbToHex(A.r, A.g, A.b)} 100%)`
    };
  }, [Q, W, $]), _e = j(
    () => ({
      width: k,
    ...
    o && /* @__PURE__ */ s(
      At,
      {
        ...
        onChange: (A) => Ae(Math.max(0, Math.min(100, Math.round(A))) / 100),
        min: 0,
        max: 100,
        suffix: "%",
        stepperPosition: "none"
    ...
    const A = d || a3;
    return !A || A.length === 0 ? null : /* @__PURE__ */ s("div", { className: "land-color-picker__presets", children: A.map((G, me) => /* @__PURE__ */ s(
      "div",
      {
...
const fm = (e) => {
  const {
    ...
    // 兼容旧 API
    ...Ce
  } = e, ae = Ce.pickerType || r, D = Ce.showConfirmButton ?? m, fe = Ce.clearable ?? h, [ne, ge] = F(_), [I, E] = F(() => {
    const be = t ?? n ?? Ce.value;
    return be ? new Date(be) : null;
  }), [Z, ie] = F(null), [ee, R] = F(""), [oe, se] = F(!1), ve = le(null), [$e, He] = F(void 0), we = t !== void 0 || Ce.value !== void 0, Ae = T !== void 0, Oe = we ? t ?? Ce.value ? new Date(t ?? Ce.value) : null : I, Ve = Ae ? T : ne, Ue = M((be) => be ? typeof p == "function" ? p(be, ae, o) : h3(be, ae, o) : "", [p, ae, o]), Fe = j(() => Ue(Oe), [Oe, Ue]), Ge = j(() => d || u3(ae, o), [d, ae, o]), ze = j(() => ({
    date: "date",
    week: "week",
    month: "month",
    quarter: "quarter",
    ...
    x || N || (Ae || ge(be), S == null || S(be), !be && D && ie(null));
  }, [x, N, Ae, D, S]), Me = M(() => {
    K(!0);
  }, [K]), xe = M(() => {
    K(!1);
    ...
    if (x) return;
    const be = Z || Oe;
    !we && Z && E(Z), H == null || H(be), B == null || B(be), ie(null), xe();
  }, [x, Z, Oe, we, H, B, xe]), wt = M(() => {
    ie(null), xe();
  }, [xe]), ue = M(() => {
    x || N || (we || E(null), H == null || H(null), te == null || te(), R(""));
  }, [x, N, we, H, te]), _e = M((be) => {
    x || N || !f || ae !== "date" || R(be);
  }, [x, N, f, ae]), Be = M((be) => {
    x || N || (f && ae === "date" ? (se(!0), R(Fe)) : Me(), O == null || O(be));
  }, [x, N, f, ae, Fe, Me, O]), Se = M((be) => {
    if (!(x || N)) {
      if (f && ae === "date") {
        if (se(!1), ee.trim()) {
          const Ze = ga(ee);
  ...
  de(() => {
    ...
    if (q && ve.current) {
      const be = Fe || Ge;
      ve.current.textContent = be;
      const Vt = ve.current.offsetWidth + 64, Tn = typeof $ == "number" ? $ : parseInt($, 10) || 120;
      He(Math.max(Vt, Tn));
    }
  }, [q, Fe, Ge, $]);
  const G = () => C ? b || w || /* @__PURE__ */ s(Le, { name: "calendar" }) : null, me = () => /* @__PURE__ */ g("div", { className: `land-date-picker__dropdown ${he || ""}`, style: pe, children: [
    /* @__PURE__ */ s(
      i3,
      {
        mode: ze,
  ...
  const O = j(() => {
    ...
    e && `${Ut}--show`,
    T
  ].filter(Boolean).join(" "), [e, T]), te = M((Q) => {
    if (Q.key === "Escape" && w && e && k && k(), Q.key === "Enter" && b && e && y && !f) {
      const z = Q.target;
      z.tagName === "INPUT" || z.tagName === "TEXTAREA" || z.isContentEditable || y();
    }
  }, [w, b, e, k, y, f]);
  de(() => (e && (w || b) && document.addEventListener("keydown", te), () => {
    document.removeEventListener("keydown", te);
  }), [e, w, b, te]);
  const B = j(() => i || k || r || o || n, [i, k, r, o, n]), X = j(() => u || y || C || l || c, [u, y, C, l, c]);
  return /* @__PURE__ */ g(
    "div",
    {
      className: Y,
      ...
      children: [
        ...
        e && /* @__PURE__ */ g(
          dt.div,
          {
            ...
            style: { ..._, width: O },
            children: [
              i || B && /* @__PURE__ */ g("div", { className: `${Ut}__header`, children: [
              ...
              d && X && /* @__PURE__ */ s(qt, {}),
              u || X && /* @__PURE__ */ g("div", { className: `${Ut}__footer`, children: [
  ...
  }, [w, t]), z = j(() => b && (r || a || o), [b, r, a, o]), W = j(() => a || b || o || i, [a, b, o, i]), q = j(() => d || x || N || c || u, [d, x, N, c, u]), $ = j(() => [
    Mt,
    e && `${Mt}--show`,
    `${Mt}--${t}`,
    S
  ].filter(Boolean).join(" "), [e, t, S]), U = M((pe) => {
    if (pe.key === "Escape" && T && e && b && b(), pe.key === "Enter" && _ && e && x && !v) {
      const he = pe.target;
      he.tagName === "INPUT" || he.tagName === "TEXTAREA" || he.isContentEditable || x();
    }
  }, [T, _, e, b, x, v]);
  de(() => (e && (T || _) && document.addEventListener("keydown", U), () => {
      ...
      dt.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(
            "div",
            {
              className: `${Mt}__body ${te}`,
              style: Y,
              children: V
            }
          ),
          p && q && /* @__PURE__ */ s(qt, {}),
          q && /* @__PURE__ */ g("div", { className: `${Mt}__footer`, children: [
  ...
  const c = le(null), [u, d] = F(!1), [p, h] = F(0), f = j(() => t || n || "", [t, n]), m = j(() => {
...
const Je = "land-menu", gc = ({
  ...
  const {
    ...
    htmlProps: T,
    imgProps: _
  } = e, [V, H] = F("idle"), [S, P] = F(t), [O, Y] = F(!1), [te, B] = F(), X = le(null);
  de(() => {
    t ? (H("loading"), P(t), Y(!1), B(void 0)) : (H("idle"), P(void 0));
  }, [t]);
  const Q = M((ce) => {
    const Ce = ce.currentTarget;
    Ce.naturalWidth && Ce.naturalHeight && B(Ce.naturalWidth / Ce.naturalHeight), H("success"), k == null || k(ce);
  }, [k]), z = M((ce) => {
    if (!O && h) {
      Y(!0), P(h);
      return;
    ...
    const ce = [Ht];
    return ce.push(`${Ht}--${V}`), u && ce.push(`${Ht}--round`), C && ce.push(`${Ht}--clickable`), w && ce.push(w), ce.join(" ");
  }, [V, u, C, w]), $ = j(() => {
    const ce = { ...b };
    r !== void 0 && (ce.width = typeof r == "number" ? `${r}px` : r), o !== void 0 && (ce.height = typeof o == "number" ? `${o}px` : o);
    const Ce = l ?? (V === "success" ? te : void 0);
    return Ce !== void 0 && (ce.aspectRatio = `${Ce}`), u ? ce.borderRadius = "50%" : c !== void 0 && (ce.borderRadius = typeof c == "number" ? `${c}px` : c), ce;
  }, [b, r, o, l, te, V, u, c]), U = j(() => ({
    objectFit: i,
...
const y3 = ({ className: e }) => /* @__PURE__ */ s("svg", { className: e, viewBox: "0 0 48 48", fill: "currentColor", children: /* @__PURE__ */ s("path", { d: "M22.683 5.415c.568-1.043 2.065-1.043 2.634 0l5.507 10.098a1.5 1.5 0 0 0 1.04.756l11.306 2.117c1.168.219 1.63 1.642.814 2.505l-7.902 8.359a1.5 1.5 0 0 0-.397 1.223l1.48 11.407c.153 1.177-1.058 2.057-2.131 1.548l-10.391-4.933a1.5 1.5 0 0 0-1.287 0l-10.39 4.933c-1.073.51-2.284-.37-2.131-1.548l1.48-11.407a1.5 1.5 0 0 0-.398-1.223L4.015 20.89c-.816-.863-.353-2.286.814-2.505l11.306-2.117a1.5 1.5 0 0 0 1.04-.756l5.508-10.098Z" }) }), Nm = (e) => {
  const {
    ...
    onBlur: V,
    onKeyDown: H
  } = e, [S, P] = F(n), [O, Y] = F(void 0), [te, B] = F(!1), X = le(null), Q = t !== void 0, z = Q ? t : S, W = O ?? z;
  de(() => {
  ...
  const q = M(
    ...
    (I) => {
      ...
      Z !== z && (Q || P(Z), N == null || N(Z)), H == null || H(I);
    },
    [l, c, o, z, r, Q, N, H]
  ), D = M(
    (I) => {
    ...
    const I = ["land-rate"];
    return a && a !== "default" && I.push(`land-rate--${a}`), l && I.push("land-rate--disabled"), c && I.push("land-rate--readonly"), te && I.push("land-rate--focused"), m && I.push(m), I.join(" ");
  }, [a, l, c, te, m]), ne = j(
    () => ({
    ...
    (I) => {
      const E = U(I, !0), Z = U(I, !1), ie = E && Z, ee = E && !Z, R = D(I);
      return /* @__PURE__ */ g(
        "div",
        {
          className: `land-rate__character ${w || ""} ${ie ? "land-rate__character--active" : ""} ${ee ? "land-rate__character--half" : ""}`,
          style: C,
          title: R,
          children: [
            o && /* @__PURE__ */ s(
  ...
  const S = j(() => e ?? i ?? [], [e, i]), P = j(() => d || (p ? w3[p] ?? "outline" : "outline"), [d, p]), [O, Y] = F(() => t !== void 0 ? t : a != null && a.key !== void 0 ? a.key : r), [te, B] = F(() => n !== void 0 ? n : l != null && Array.isArray(l) ? l.filter((E) => E != null).map((E) => E.key) : o ?? []);
  de(() => {
    t !== void 0 ? Y(t) : a != null && a.key !== void 0 && Y(a.key);
  }, [t, a]), de(() => {
    n !== void 0 ? B(n) : l != null && Array.isArray(l) && B(l.filter((E) => E != null).map((E) => E.key));
  }, [n, l]);
  const [X, Q] = F([]), z = j(() => {
    if (c)
      return Cs(S, te);
    ...
    isMultiple: !!c,
    placeholder: u
  }) : W(), [C, W, c, te, O, z, u]), $ = M((E) => {
    if (E === 0) return S;
    let Z = S;
    for (let ie = 0; ie < E; ie++) {
      const ee = X[ie], R = Z.find((oe) => oe.key === ee);
    ...
    return Z;
  }, [S, X]), U = M((E) => c ? te.includes(E.key) : O === E.key, [c, te, O]), re = M((E) => {
    if (!c || !E.children) return !1;
    const Z = Er(E), ie = Z.filter((ee) => te.includes(ee)).length;
    ...
    return ie(S).forEach((R) => {
      const oe = Er(R), se = oe.filter(($e) => Z.includes($e)).length, ve = Z.includes(R.key);
      se === oe.length && !ve ? Z.push(R.key) : se === 0 && ve && (Z = Z.filter(($e) => $e !== R.key));
    }), Z;
  }, [S]), he = M((E, Z) => {
    if (E.children && E.children.length > 0) {
      const ee = X[Z] === E.key ? X.slice(0, Z) : [...X.slice(0, Z), E.key];
      Q(ee), H == null || H(ee);
    } else if (c) {
      let ee = U(E) ? te.filter((oe) => oe !== E.key) : [...te, E.key];
      ee = pe(ee), B(ee);
      const R = Cs(S, ee);
      V == null || V(ee, E, R);
    } else
      Y(E.key), V == null || V(E.key, E, [E]);
  }, [X, c, U, te, V, pe, S, H]), ce = M((E) => {
    if (!c) return;
    let Z = [...te];
    if (U(E)) {
      const R = [E.key, ...Er(E)];
    ...
    const ie = Z + 1, ee = $(ie);
    return { level: ie, levelData: ee };
  }).filter(({ levelData: E }) => E.length > 0), [X, $]), fe = j(() => [
    ht,
    `${ht}--${h}`,
    x
  ...
  return /* @__PURE__ */ s("div", { className: fe, style: I, children: /* @__PURE__ */ s(
    Cr,
    {
      disabled: f,
      trigger: "click",
      ...
      children: /* @__PURE__ */ g("div", { className: ne, children: [
        /* @__PURE__ */ s("div", { className: `${ht}__content`, children: C ? q() : W() }),
...
const La = {
  ...
  const [d, p] = F(""), [h, f] = F(!1), m = le(null), v = le(null), L = le(null), k = le(null), y = le(e), C = le(!0), b = { ...{
    duration: 1e3,
    easing: "easeOut",
    delay: 0,
    loop: !1,
    loopInterval: 2e3
  }, ...a }, x = M((te) => l > 0 ? te.toFixed(l) : Math.floor(te).toString(), [l]), N = M(() => {
    ...
    const $ = V3[Q], U = () => {
      if (!C.current) return;
      q++;
      const re = q / W, pe = $(re), he = te + (B - te) * pe;
      p(x(he)), q < W ? m.current = requestAnimationFrame(U) : (p(x(B)), m.current = null);
    };
  ...
  const S = j(() => x(e).split("").map((B) => B === "." ? "." : B === "-" ? "-" : parseInt(B, 10)), [e, x]), P = j(() => ({
    bounce: {
  ...
  }), []), O = M(() => i === "bounce" ? P.bounce : i === "fade" ? P.fade : i === "slide" ? P.slide : i === "scale" ? P.scale : i === "flip" ? P.flip : P.fade, [i, P]), Y = j(() => [
    Kt,
    h && `${Kt}--animating`,
    u
  ].filter(Boolean).join(" "), [h, u]);
  return /* @__PURE__ */ g("div", { className: Y, style: c, children: [
    t && /* @__PURE__ */ s("div", { className: `${Kt}__prefix`, children: t }),
    /* @__PURE__ */ g("div", { className: `${Kt}__value`, children: [
      /* @__PURE__ */ s(Q2, { mode: "wait", children: i === "random" ? /* @__PURE__ */ s("div", { className: `${Kt}__random-wrapper`, children: S.map((te, B) => /* @__PURE__ */ s(
        "div",
        {
  ...
  const {
    ...
    onFocus: S,
    onBlur: P
  } = e, O = t !== void 0, [Y, te] = F(n), B = O ? t : Y, X = !y && !C && !k, Q = j(() => {
    switch (v) {
      case "small":
        return 12;
      case "large":
    ...
    const D = ["land-switch"];
    return v && v !== "default" && D.push(`land-switch--${v}`), L === "left" && D.push("land-switch--label-left"), B && D.push("land-switch--checked"), y && D.push("land-switch--disabled"), C && D.push("land-switch--readonly"), k && D.push("land-switch--loading"), z && D.push("land-switch--has-content"), w && D.push(w), D.join(" ");
  }, [v, L, B, y, C, k, z, w]), q = j(() => {
  ...
  }, he = () => !l && !c ? null : /* @__PURE__ */ s("span", { className: "land-switch__track-content", children: B ? c : l }), ce = () => k ? /* @__PURE__ */ s(Gn, { className: "land-switch__loading-icon", strokeSize: 2, size: v === "small" ? 10 : v === "large" ? 14 : 12 }) : (B ? d : u) || null, Ce = () => h ? /* @__PURE__ */ s("div", { className: "land-switch__icon-tip", children: /* @__PURE__ */ s(at, { content: h, theme: "dark", ...m, children: /* @__PURE__ */ s(Le, { name: "info-stroke", size: v === "small" ? 14 : 16 }) }) }) : null, ae = /* @__PURE__ */ g(
    "div",
    {
      className: W,
      style: b,
      ...
      children: [
        ...
        /* @__PURE__ */ g("div", { className: q, style: N, children: [
          z && !B && /* @__PURE__ */ s("div", { className: $, style: _, children: ce() }),
          he(),
          z ? B && /* @__PURE__ */ s("div", { className: $, style: _, children: ce() }) : /* @__PURE__ */ s(
            dt.div,
            {
              className: $,
              style: _,
  ...
  const t = S3(e), {
    ...
    onVisibleChange: H,
    onCheck: S
  } = t, [P, O] = F(a), [Y, te] = F(x), B = i ?? P, X = b ?? Y, Q = M(
    ($) => {
      if (!N) {
        if (w) {
          const U = !X;
          b === void 0 && te(U), S == null || S(U);
        }
        _ == null || _($);
      }
    },
...
const bt = "land-tag-input", bs = (e) => typeof e == "string" ? e : e.label, I3 = (e, t) => typeof e == "string" ? `${e}-${t}` : e.key ?? `${e.label}-${t}`, P3 = (e) => typeof e == "string" ? !0 : e.closable !== !1, Im = ({
  ...
  const [O, Y] = F(""), [te, B] = F(
    e ?? t ?? n ?? []
  ), [X, Q] = F(!1), z = le(null), W = le(null), q = e !== void 0, $ = q ? e : te, U = o ?? i, re = $.length >= U, pe = h && $.length > 0 && !d && !p;
  de(() => {
    q && B(e);
  }, [q, e]);
  const he = M(
    (ee, R) => {
      q || B(ee), b == null || b(ee, R);
    },
    [q, b]
  ), ce = M(
    (ee) => {
      const R = ee.trim();
      if (!R || re || a && R.length > a || !l && $.some((ve) => bs(ve) === R))
        return;
      const oe = [...$, R];
      he(oe, "add"), x == null || x(R), Y("");
    },
    [$, re, a, l, he, x]
  ), Ce = M(
    (ee) => {
      if (d || p) return;
      const R = $[ee], oe = $.filter((se, ve) => ve !== ee);
      he(oe, "remove"), N == null || N(R, ee), P == null || P(bs(R));
    },
    [$, d, p, he, N, P]
  ), ae = M(() => {
    var ee;
    d || p || (he([], "clear"), T == null || T(), (ee = W.current) == null || ee.focus());
  }, [d, p, he, T]), D = M(
    (ee) => {
      if (ee.key === "Enter") {
        ee.preventDefault(), ce(O), _ == null || _(O, ee);
        return;
      }
      ee.key === "Backspace" && !O && $.length > 0 && Ce($.length - 1);
    },
    [O, $.length, ce, Ce, _]
  ), fe = M(
    (ee) => {
      const R = ee.target.value;
      Y(R), V == null || V(R, ee);
    },
    [V]
  ), ne = M(
    ...
    (ee) => {
      Q(!1), O.trim() && ce(O), S == null || S(ee);
    },
    [O, ce, S]
  ), I = M(() => {
    var ee;
    !d && !p && ((ee = W.current) == null || ee.focus());
  }, [d, p]), E = j(() => [
    bt,
    `${bt}--${c}`,
    `${bt}--${u}`,
    ...
    (ee, R) => {
      const oe = bs(ee), se = I3(ee, R), ve = P3(ee) && !d && !p, $e = typeof ee == "object" ? { ...k, ...ee.style } : k, He = typeof ee == "object" ? `${bt}__tag ${L} ${ee.className ?? ""}` : `${bt}__tag ${L}`;
      return y ? /* @__PURE__ */ s(pn.Fragment, { children: y(ee, R, () => Ce(R)) }, se) : /* @__PURE__ */ s(
        Mr,
        {
          className: He,
          style: $e,
...
function Pm(e) {
  const t = R3(e) ? { ...B3(e), ...e } : e, {
    ...
    row: {},
    col: {}
  }), [B, X] = F({ field: void 0, order: null }), Q = le(null), z = le(null), W = le(null), q = j(() => n.filter((R) => !R.hidden), [n]), $ = j(() => {
    const R = [];
    ...
    if (!B.field || !B.order)
      return r;
    const R = n.find((ve) => ve.dataIndex === B.field);
    if (!(R != null && R.sorter))
      return r;
    const oe = typeof R.sorter == "object" ? R.sorter.compare : void 0;
    return [...r].sort((ve, $e) => {
      const He = xs(ve, B.field), we = xs($e, B.field);
      if (oe) {
        const Oe = oe(ve, $e);
        return B.order === "descend" ? -Oe : Oe;
      }
      if (He === we) return 0;
      if (He == null) return 1;
      if (we == null) return -1;
      const Ae = He > we ? 1 : -1;
      return B.order === "descend" ? -Ae : Ae;
    });
  }, [r, B, n]), re = M(
    (R, oe) => {
      f && O({ row: R, col: oe });
    ...
    if (!f || !P || !Q.current) return;
    const R = Q.current, oe = R.querySelector("thead tr"), se = R.querySelectorAll("tbody tr");
    if (!oe || se.length === 0) return;
    const ve = oe.getBoundingClientRect().height, $e = se[0].getBoundingClientRect().height;
    let He = 0, we = 0;
    for (let Ae = 0; Ae < oe.children.length; Ae++) {
      const Ve = oe.children[Ae].getBoundingClientRect().width;
      if (Ae === P.col) {
        we = Ve;
        break;
      }
    ...
    if ($.length === 0 || !Q.current) return;
    const oe = Q.current.querySelector("thead tr");
    if (!oe) return;
    let se = 0;
    const ve = z.current;
    if (ve)
      for (let $e = 0; $e < Math.min($.length, oe.children.length); $e++) {
        ...
        ve.style.setProperty(`--fixed-col-${$e}-left`, `${se}px`), se += we;
      }
  }, [$.length]), Ce = M(
    (R) => {
      if (!R.sorter) return;
      const oe = B.field !== R.dataIndex ? "ascend" : B.order === "ascend" ? "descend" : B.order === "descend" ? null : "ascend", se = {
  ...
  de(() => {
    ...
    $.length > 0 && requestAnimationFrame(ce);
  }, [$.length, ce]), de(() => {
    if ((f || $.length > 0) && Q.current)
      return W.current = new ResizeObserver(() => {
        P && he(), $.length > 0 && ce();
      }), W.current.observe(Q.current), () => {
        var R;
        (R = W.current) == null || R.disconnect();
      };
  }, [f, $.length, P, he, ce]);
  const ae = (R, oe) => {
    const se = R.fixed === "left" || R.fixed === !0 || S > 0 && oe < S, ve = !!R.sorter, $e = B.field === R.dataIndex, He = (N == null ? void 0 : N(R, oe)) || {}, we = [
      "land-table__header-cell",
      se && "land-table__cell--fixed",
      ve && "land-table__header-cell--sortable",
      $e && `land-table__header-cell--sorted-${B.order}`,
      R.headerClassName
    ].filter(Boolean).join(" ");
    return /* @__PURE__ */ s(
      "th",
        ...
        children: /* @__PURE__ */ g("div", { className: "land-table__header-content", children: [
          ...
          ve && /* @__PURE__ */ g("span", { className: "land-table__sorter", children: [
            /* @__PURE__ */ s(
              "span",
              {
                className: `land-table__sorter-icon land-table__sorter-icon--ascend ${$e && B.order === "ascend" ? "land-table__sorter-icon--active" : ""}`,
                children: "▲"
              }
            ),
            /* @__PURE__ */ s(
              "span",
              {
                className: `land-table__sorter-icon land-table__sorter-icon--descend ${$e && B.order === "descend" ? "land-table__sorter-icon--active" : ""}`,
                children: "▼"
              }
            )
          ] })
    ...
    const $e = se.fixed === "left" || se.fixed === !0 || S > 0 && ve < S, He = xs(R, se.dataIndex), we = (x == null ? void 0 : x(R, oe, se, ve)) || {}, Ae = [
      "land-table__cell",
    ...
    const se = A3(R, oe, o), ve = (b == null ? void 0 : b(R, oe)) || {}, $e = [
      "land-table__row",
      h && oe % 2 === 1 && "land-table__row--striped"
    ].filter(Boolean).join(" ");
    return /* @__PURE__ */ s("tr", { className: $e, ...ve, children: q.map((He, we) => D(R, oe, He, we)) }, se);
  }, ne = [
    "land-table-wrapper",
  ...
  ].filter(Boolean).join(" "), I = () => i ? /* @__PURE__ */ s("div", { className: "land-table__title", children: typeof i == "function" ? i() : i }) : null, E = () => a ? /* @__PURE__ */ s("div", { className: "land-table__footer", children: typeof a == "function" ? a(U) : a }) : null, Z = () => /* @__PURE__ */ s("tr", { className: "land-table__empty-row", children: /* @__PURE__ */ s("td", { colSpan: q.length, className: "land-table__empty-cell", children: c }) }), ie = () => C ? /* @__PURE__ */ g("div", { className: "land-table__loading", children: [
    /* @__PURE__ */ s("div", { className: "land-table__loading-spinner" }),
    w && /* @__PURE__ */ s("div", { className: "land-table__loading-text", children: w })
  ] }) : null, ee = {};
  return y != null && y.x && (ee.overflowX = "auto", typeof y.x == "number" && (ee.minWidth = y.x)), y != null && y.y && (ee.overflowY = "auto", ee.maxHeight = y.y), /* @__PURE__ */ g(
    "div",
    {
      ref: z,
      className: ne,
      ...
      children: [
        I(),
        /* @__PURE__ */ g("table", { ref: Q, className: ge, children: [
          ...
          /* @__PURE__ */ s("tbody", { className: "land-table__body", children: U.length > 0 ? U.map(fe) : Z() }),
          l && /* @__PURE__ */ s("tfoot", { className: "land-table__summary", children: l(U) })
        ] }),
        f && P && /* @__PURE__ */ g(tt, { children: [
          /* @__PURE__ */ s("div", { className: "land-table__row-overlay", style: Y.row }),
          /* @__PURE__ */ s("div", { className: "land-table__col-overlay", style: Y.col })
        ] }),
        ie(),
        E()
      ]
...
const Dr = "land-title", Am = ({
  ...
  const Y = le(null), [te, B] = F(r ?? o ?? ""), [X, Q] = F(!1), z = le(!1);
  de(() => {
    r !== void 0 && !z.current && B(r);
  }, [r]);
  const W = M(() => {
    if (!m || !Y.current) return;
    const Z = Y.current;
    Z.style.height = "auto";
    const ie = window.getComputedStyle(Z), ee = parseFloat(ie.lineHeight) || 22, R = parseFloat(ie.paddingTop) || 0, oe = parseFloat(ie.paddingBottom) || 0, se = parseFloat(ie.borderTopWidth) || 0, ve = parseFloat(ie.borderBottomWidth) || 0;
    let $e = 0, He = 1 / 0;
    if (typeof m == "object") {
      const Oe = m.minRows ?? h, Ve = m.maxRows ?? f;
      Oe && ($e = Oe * ee + R + oe + se + ve), Ve && (He = Ve * ee + R + oe + se + ve);
    } else
      h && ($e = h * ee + R + oe + se + ve), f && (He = f * ee + R + oe + se + ve);
    const we = Z.scrollHeight, Ae = Math.min(Math.max(we, $e), He);
    Z.style.height = `${Ae}px`;
  }, [m, h, f]);
  de(() => {
    W();
  }, [te, W]);
  const q = M((Z) => {
    ...
    r === void 0 && B(ie), b == null || b(ie, Z);
  }, [r, b]), $ = M((Z) => {
    Q(!0), x == null || x(Z);
  }, [x]), U = M((Z) => {
    Q(!1), N == null || N(Z);
  }, [N]), re = M((Z) => {
    T == null || T(Z), Z.key === "Enter" && !Z.shiftKey && (_ == null || _(te, Z));
  }, [T, _, te]), pe = M(() => {
    z.current = !0;
  }, []), he = M((Z) => {
    z.current = !1;
    const ie = Z.target.value;
    r === void 0 && B(ie), b == null || b(ie);
  }, [r, b]), ce = M(() => {
    r === void 0 && B(""), V == null || V();
  }, [r, V]), Ce = te.length, ae = c !== void 0 && Ce > c, D = j(() => u ? d ? d(Ce, c) : c !== void 0 ? `${Ce}/${c}` : `${Ce}` : null, [u, d, Ce, c]), fe = j(() => [
    it,
    `${it}--${e}`,
    `${it}--${t}`,
    `${it}--align-${n}`,
    ...
    ae && `${it}--over-limit`,
    H
  ].filter(Boolean).join(" "), [e, t, n, a, l, L, X, V, ae, H]), ne = !m && v !== "none", ge = j(() => ({
    ...S,
    ...k !== void 0 ? { width: typeof k == "number" ? `${k}px` : k } : {},
    // 允许 resize 时不设置固定高度，避免限制拖动
    ...!ne && y !== void 0 ? { height: typeof y == "number" ? `${y}px` : y } : {}
  }), [S, k, y, ne]), I = j(() => ({
    resize: m ? "none" : v
  }), [m, v]), E = {
    ref: Y,
  ...
  return /* @__PURE__ */ g("div", { className: fe, style: ge, children: [
    ...
    /* @__PURE__ */ g("div", { className: `${it}__body`, children: [
      /* @__PURE__ */ g("div", { className: `${it}__wrapper`, children: [
        ...
        V && /* @__PURE__ */ s(
          "div",
          {
            className: `${it}__clear ${te ? `${it}__clear--visible` : ""}`,
            onClick: ce,
            children: /* @__PURE__ */ s(Le, { name: "error-fill" })
          }
        )
...
const Rm = (e) => {
  const {
    ...
    onDrop: ae,
    onExceed: D
  } = e, [fe, ne] = F(z), [ge, I] = F(!1), E = le(null), Z = le(0), ie = Q !== void 0, ee = ie ? Q : fe, R = M(
    (ue, _e) => {
      ie || ne(_e), W == null || W(ue, _e);
    },
    [ie, W]
  ), oe = M((ue) => new Promise((_e) => {
    if (wa({ name: ue.name, type: ue.type })) {
      const Be = URL.createObjectURL(ue);
      _e(Be);
    } else
      _e("");
  }), []), se = M(
    async (ue, _e) => {
      if (!p) {
        const Re = await oe(ue), Ie = {
          ...
          url: Re,
          thumbUrl: Re
        }, A = ee.map((G) => G.uid === _e.uid ? Ie : G);
        R(Ie, A), U == null || U(null, Ie);
        return;
      }
      const Be = new FormData();
      if (Be.append(i || "file", ue), m) {
        const Re = typeof m == "function" ? m(_e) : m;
        Object.entries(Re).forEach(([Ie, A]) => {
          A instanceof Blob ? Be.append(Ie, A) : A != null && Be.append(Ie, String(A));
        });
      }
      ...
      Se.open(h, p, !0), f && Object.entries(f).forEach(([Re, Ie]) => {
        ...
        if (Re.lengthComputable) {
          const Ie = Math.round(Re.loaded / Re.total * 100), A = { ..._e, percent: Ie }, G = ee.map((me) => me.uid === _e.uid ? A : me);
          R(A, G), $ == null || $(Ie, A);
        }
      }, Se.onload = async () => {
        ...
        if (Se.status >= 200 && Se.status < 300) {
          ...
          const A = {
            ...
            thumbUrl: Re,
            response: Ie
          }, G = ee.map((me) => me.uid === _e.uid ? A : me);
          R(A, G), U == null || U(Ie, A);
        } else {
          const Ie = new Error(`Upload failed with status ${Se.status}`), A = {
            ..._e,
            status: "error",
            error: Ie.message,
            url: Re,
          ...
          R(A, G), re == null || re(Ie, A);
        }
      }, Se.onerror = async () => {
        const Re = await oe(ue), Ie = new Error("Network error"), A = {
          ..._e,
          status: "error",
          error: Ie.message,
          url: Re,
    ...
    async (ue) => {
      ...
      if (u) {
        const Be = u - ee.length;
        if (Be <= 0) {
          D == null || D(_e);
          return;
        }
        _e.length > Be && (D == null || D(_e.slice(Be)), _e = _e.slice(0, Be));
      }
      for (const Be of _e) {
        ...
        if (q)
          try {
            const Ie = await q(Be, _e);
            if (Ie === !1)
              continue;
            if (Ie instanceof File) {
              const A = ya(Ie), G = [...ee, A];
              R(A, G), se(Ie, A);
              continue;
            }
          } catch {
    ...
    (ue) => {
      ...
      _e && _e.length > 0 && ve(_e), ue.target.value = "";
    },
    [ve]
  ), we = M(
    (ue) => {
      ue.preventDefault(), ue.stopPropagation(), !(r || o || !L) && (Z.current++, ue.dataTransfer.items && ue.dataTransfer.items.length > 0 && (I(!0), ce == null || ce(ue)));
    },
    [r, o, L, ce]
  ), Ae = M(
    (ue) => {
    ...
    (ue) => {
      ...
      _e && _e.length > 0 && (ve(_e), ae == null || ae(ue));
    },
    [r, o, L, ve, ae]
  ), Ue = M(
    async (ue) => {
      if (r || o || pe && await pe(ue) === !1)
        return;
      ue.url && ue.url.startsWith("blob:") && URL.revokeObjectURL(ue.url);
      const _e = { ...ue, status: "removed" }, Be = ee.filter((Se) => Se.uid !== ue.uid);
      R(_e, Be);
    },
    [r, o, ee, R, pe]
  ), Fe = M(
    ...
    return ge && ue.push("land-uploader__dropzone--dragging"), te && ue.push(te), ue.join(" ");
  }, [ge, te]), K = j(
    () => ({
    ...
    (ue) => {
      const _e = wa(ue), Be = N !== "text" && _e && ue.thumbUrl;
      return /* @__PURE__ */ g(
        "div",
        {
          className: `land-uploader__file-item land-uploader__file-item--${ue.status}`,
          children: [
            Be && /* @__PURE__ */ s("div", { className: "land-uploader__file-thumb", children: /* @__PURE__ */ s("img", { src: ue.thumbUrl, alt: ue.name }) }),
            !Be && /* @__PURE__ */ s("div", { className: "land-uploader__file-icon", children: /* @__PURE__ */ s(Le, { name: _e ? "image" : "file" }) }),
    ...
    [N, T, V, _, o, Fe, Ue]
  ), wt = M(() => !x || ee.length === 0 ? null : /* @__PURE__ */ s(
    "div",
    {
  ...
  const v = le(null), L = le(null), [k, y] = F({ width: 0, height: 0 }), C = j(() => [Ir, m].filter(Boolean).join(" "), [m]), w = M(() => {
    const { width: _, height: V } = k;
    if (_ === 0 || V === 0) return [];
    const [H, S] = i, [P, O] = a, Y = Math.max(H, r), te = Math.max(S, o), B = _ - r, X = V - o, Q = Math.max(0, Math.min(P, B)), z = Math.max(0, Math.min(O, X)), W = Math.ceil((B - Q) / Y) + 1, q = Math.ceil((X - z) / te) + 1, $ = [];
    for (let U = 0; U < q; U++)
      for (let re = 0; re < W; re++) {
        const pe = Q + re * Y, he = z + U * te;
        pe + r <= _ && he + o <= V && $.push({ id: `${U}-${re}`, x: pe, y: he });
      }
    if ($.length < 4) {
      const U = (_ - r) / 2, re = (V - o) / 2;
      $.push({ id: "center", x: U, y: re });
      const pe = 20;
      [
        { x: pe, y: pe },
        { x: _ - r - pe, y: pe },
        ...
        ce.x >= 0 && ce.y >= 0 && $.push({ id: `corner-${Ce}`, x: ce.x, y: ce.y });
      });
    }
    return $;
  ...
  const h = le(null), [f, m] = F(0), [v, L] = F(!1), [k, y] = F(!1), [C, w] = F(0);
  de(() => {
    if (!h.current) return;
  ...
  const b = M((S) => {
    ...
    const P = h.current.getBoundingClientRect(), O = S - P.left;
    return Math.max(0, Math.min(1, O / P.width));
  }, []), x = M((S) => {
    if (o) return;
    ...
    var Y;
    if (o) return;
    const P = (Y = h.current) == null ? void 0 : Y.getBoundingClientRect();
    if (!P) return;
    const O = b(S.clientX);
    w(O), k && (i == null || i(O)), l == null || l(O, S.clientX - P.left, P.width);
  }, [o, k, b, i, l]), T = M((S) => {
    var Y;
    if (o) return;
    L(!0);
    ...
    if (!P) return;
    const O = b(S.clientX);
    w(O), a == null || a(O, S.clientX - P.left, P.width);
  }, [o, b, a]), _ = M(() => {
  ...
  const we = le(null), Ae = le(null), Oe = le(null), Ve = le(null), Ue = le(null), [Fe, Ge] = F("idle"), [ze, K] = F(0), [Me, xe] = F(0), [De, lt] = F(0), [wt, ue] = F(16 / 9), [_e, Be] = F(!1), [Se, Re] = F(h), [Ie, A] = F(h), [G, me] = F(p), [J, ke] = F(d), [je, be] = F(f), [Ze, Vt] = F(!1), [Tn, br] = F(!1), [rn, wc] = F(!1), [Cc, Mc] = F(!1), [Gt, xr] = F(!1), es = le(null), [bc, Ao] = F(!1), [xc, _c] = F(0), [ts, Bo] = F(!1), [ns, Ro] = F(!1), [rs, Eo] = F(!1), _r = j(() => typeof l == "number" ? `${l}px` : l, [l]), Oo = j(() => a || wt, [a, wt]), $c = j(() => S / (wt || 1.7777777777777777), [S, wt]), Et = M(() => ({
    currentTime: Me,
    duration: ze,
    ...
    Re(Pe), we.current.volume = Pe / 100, Pe > 0 && G && (me(!1), we.current.muted = !1), U == null || U(Pe, Pe === 0);
  }, [G, U]), ss = M(() => {
    if (we.current)
      if (G) {
        const ye = Ie > 0 ? Ie : 100;
        we.current.volume = ye / 100, we.current.muted = !1, Re(ye), me(!1), U == null || U(ye, !1);
      } else
        A(Se), we.current.volume = 0, we.current.muted = !0, Re(0), me(!0), U == null || U(0, !0);
  }, [G, Ie, Se, U]), Fo = M((ye) => {
    ...
    const Pe = ye * ze;
    we.current.currentTime = Pe, xe(Pe), ne == null || ne(Pe);
  }, [ze, ne]), Uo = M(async () => {
    if (we.current)
      try {
    ...
    Oe.current && (document.fullscreenElement ? (document.exitFullscreen(), he == null || he()) : (Oe.current.requestFullscreen(), pe == null || pe()));
  }, [pe, he]), Ko = M((ye, Pe, Ct) => {
    if (!H || !Ae.current) return;
    Ae.current.currentTime = ye * ze;
    const Ot = S / 2;
    let vt = Pe - Ot;
    ...
    Be(!1), Ge("paused"), W == null || W(Et());
  }, [Et, W]), Sc = M(() => {
    Be(!1), Ge("ended"), q == null || q(Et());
  }, [Et, q]), Hc = M(() => {
    Ge("buffering"), D == null || D();
  }, [D]), Dc = M(() => {
    Fe === "buffering" && Ge(_e ? "playing" : "paused"), fe == null || fe();
  }, [Fe, _e, fe]), Ic = M(() => {
      ...
      switch (ye.code) {
        ...
        case "ArrowLeft":
          if (ye.preventDefault(), !Pe.paused) {
            const vt = Math.max(0, Pe.currentTime - O);
            Pe.currentTime = vt, xe(vt), Bo(!0);
          }
          break;
        case "ArrowRight":
          if (ye.preventDefault(), !Pe.paused) {
            const vt = Math.min(Pe.duration, Pe.currentTime + O);
            Pe.currentTime = vt, xe(vt), Ro(!0);
          }
          break;
        case "ArrowUp":
          ye.preventDefault(), $r(Se + Y);
          break;
        case "ArrowDown":
          ye.preventDefault(), $r(Se - Y);
          break;
  ...
  de(() => {
    ...
    we.current && (we.current.pause(), Be(!1), xe(0), lt(0), K(0), Ge("idle"));
  }, [t]), G3(Ue, () => {
    Ze && Vt(!1);
  }), de(() => {
    const ye = () => {
      if (!Ve.current) return;
      const Ct = Ve.current.offsetWidth, Ot = 150 + (te || B ? 80 : 0);
      Mc(Ct < Ot + 280 + 30);
    };
    ye();
    ...
    Cr,
    {
      ...
      content: /* @__PURE__ */ g("div", { className: "land-video__dropdown", children: [
        ...
        _ && /* @__PURE__ */ s("div", { className: "land-video__dropdown-section", children: /* @__PURE__ */ g(
          "button",
          {
            className: `land-video__dropdown-toggle ${J ? "land-video__dropdown-toggle--active" : ""}`,
            onClick: () => Zo(!J),
            children: [
              /* @__PURE__ */ s(Le, { name: "loop", size: 16 }),
              /* @__PURE__ */ s("span", { children: "循环播放" }),
              /* @__PURE__ */ s("div", { className: `land-video__dropdown-switch ${J ? "land-video__dropdown-switch--active" : ""}` })
            ]
          }
        ) }),
              ...
              /* @__PURE__ */ g("div", { className: "land-video__controls-bar", ref: Ve, children: [
                /* @__PURE__ */ g("div", { className: "land-video__controls-left", children: [
                  ...
                  B && /* @__PURE__ */ s(
                    "button",
                    {
                      className: `land-video__button land-video__button--next ${Q ? "land-video__button--disabled" : ""}`,
                      onClick: I,
                      disabled: Q,
                      children: /* @__PURE__ */ s(Le, { name: "arrow-nav", size: 20 })
                    }
  ...
  const [a, l] = F(40), [c, u] = F(32), d = le(null);
  return de(() => {
  ...
  const [c, u] = F(!1), [d, p] = F(t), h = le(null);
  de(() => {
    p(t);
  }, [t]);
  const f = () => {
...
`) && w.push({ type: "default", msg: /* @__PURE__ */ s("br", {}) }), w;
  ...
  const u = le(null), d = le(null), p = le(null), [h, f] = F(0);
  de(() => {
    var y;
