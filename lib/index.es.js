...
import je, { useMemo as K, useState as D, useEffect as Z, createContext as Ht, useRef as q, useLayoutEffect as Ml, useId as uo, useContext as ye, useInsertionEffect as Ji, useCallback as F, Children as xl, isValidElement as bl, forwardRef as Qi, Fragment as sn, createElement as Wi, Component as Nl, useDebugValue as cs, useImperativeHandle as Vl } from "react";
const Sl = ({
  ltOption: e,
  rtOption: t,
  rtOption2: n,
            ...
            return A.option ? /* @__PURE__ */ s(
              "div",
              {
                style: {
                  ...
                  right: $(A.placement, A.option.gap),
                  top: S(A.placement, A.option.gap, A.option.top || 0),
                  bottom: j(A.placement, A.option.gap),
                ...
                onClick: (O) => {
                  var E, z;
                  O.stopPropagation(), (z = (E = A.option) == null ? void 0 : E.onClick) == null || z.call(E, O);
                },
  ...
  out: Ru,
  adjustment: Fu,
  "alphabetical-sorting": Zu,
  "alphabetical-sorting-reverse": Yu,
  brightness: _u,
  layer: oh,
  "layer-front": Uu,
  "layer-back": zu,
  ...
  "align-left": p1,
  "align-right": f1,
  "align-horizontally": m1,
  "align-vertically": g1,
  "text-align-left": v1,
  "text-align-right": k1,
  "text-align-center": L1,
  "text-align-justify": w1,
  "text-align-middle": y1,
  "align-bottom-center": C1,
  "align-bottom-left": M1,
  "align-bottom-right": x1,
  "align-horizontal-bottom": b1,
  "align-horizontal-center": N1,
  "align-horizontal-top": V1,
  "align-left-bottom": S1,
  "align-left-center": $1,
  "align-left-top": T1,
  "align-right-bottom": j1,
  "align-right-center": A1,
  "align-right-top": I1,
  "align-top-center": P1,
  "align-top-left": H1,
  "align-top-right": R1,
  "align-vertical-left": E1,
  "align-vertical-center": D1,
  "align-vertical-right": B1,
  "flip-horizontally": O1,
  "flip-vertically": F1,
  "font-size": Z1,
  "line-height": Y1,
  "text-bold": ph,
  ...
  "drop-shadow-down": J1,
  "drop-shadow-left": Q1,
  "drop-shadow-right": W1,
  "inner-shadow-up": eh,
  "inner-shadow-down": th,
  "inner-shadow-left": nh,
  "inner-shadow-right": rh,
  "check-list": sh,
  "alphabet-list": ih,
  "checkbox-list": ah,
  "radio-list": ch,
...
const fo = typeof window < "u", ta = fo ? Ml : Z, Xn = /* @__PURE__ */ Ht(null);
function mo(e, t) {
...
const Te = /* @__NO_SIDE_EFFECTS__ */ (e) => e, bh = (e, t) => (n) => t(e(n)), an = (...e) => e.reduce(bh), Jt = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
  const r = t - e;
  return r === 0 ? 1 : (n - e) / r;
};
class ko {
...
function Ih(e, t) {
  ...
  const u = {
    ...
    process: (h) => {
      ...
      o = !0, [n, r] = [r, n], n.forEach(d), t && hs.value && hs.value.frameloop[t].push(l), l = 0, n.clear(), o = !1, i && (i = !1, u.process(h));
    }
  };
  return u;
}
...
function ga(e, t) {
  ...
  const o = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, i = () => n = !0, a = wn.reduce((C, x) => (C[x] = Ih(i, t ? x : void 0), C), {}), { setup: c, read: l, resolveKeyframes: d, preUpdate: u, update: h, preRender: p, render: f, postRender: v } = a, k = () => {
    const C = Xe.useManualTiming ? o.timestamp : performance.now();
    n = !1, Xe.useManualTiming || (o.delta = r ? 1e3 / 60 : Math.max(Math.min(C - o.timestamp, Ph), 1)), o.timestamp = C, o.isProcessing = !0, c.process(o), l.process(o), d.process(o), u.process(o), h.process(o), p.process(o), f.process(o), v.process(o), o.isProcessing = !1, n && t && (r = !1, e(k));
  }, M = () => {
...
const { schedule: le, cancel: We, state: Le, steps: mr } = /* @__PURE__ */ ga(typeof requestAnimationFrame < "u" ? requestAnimationFrame : Te, !0);
let Sn;
function Hh() {
  Sn = void 0;
}
const Ne = {
  now: () => (Sn === void 0 && Ne.set(Le.isProcessing || Xe.useManualTiming ? Le.timestamp : performance.now()), Sn),
  set: (e) => {
    Sn = e, queueMicrotask(Hh);
  }
}, va = (e) => (t) => typeof t == "string" && t.startsWith(e), Co = /* @__PURE__ */ va("--"), Rh = /* @__PURE__ */ va("var(--"), Mo = (e) => Rh(e) ? Dh.test(e.split("/*")[0].trim()) : !1, Dh = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, Dt = {
...
const Bh = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, bo = (e, t) => (n) => !!(typeof n == "string" && Bh.test(n) && n.startsWith(e) || t && !Eh(n) && Object.prototype.hasOwnProperty.call(n, t)), ka = (e, t, n) => (r) => {
  if (typeof r != "string")
    return r;
...
const Ir = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), qe = /* @__PURE__ */ ln("deg"), Ze = /* @__PURE__ */ ln("%"), ee = /* @__PURE__ */ ln("px"), Zh = /* @__PURE__ */ ln("vh"), Yh = /* @__PURE__ */ ln("vw"), ps = {
  ...Ze,
...
}, _h = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
function Uh(e) {
  var t, n;
  return isNaN(e) && typeof e == "string" && (((t = e.match(xo)) == null ? void 0 : t.length) || 0) + (((n = e.match(_h)) == null ? void 0 : n.length) || 0) > 0;
}
const La = "number", wa = "color", zh = "var", Xh = "var(", fs = "${}", Kh = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Wt(e) {
  ...
  let i = 0;
  const c = t.replace(Kh, (l) => (me.test(l) ? (r.color.push(i), o.push(wa), n.push(me.parse(l))) : l.startsWith(Xh) ? (r.var.push(i), o.push(zh), n.push(l)) : (r.number.push(i), o.push(La), n.push(parseFloat(l))), ++i, fs)).split(fs);
...
function Ca(e) {
  ...
  return (o) => {
    ...
    for (let a = 0; a < r; a++)
      if (i += t[a], o[a] !== void 0) {
        const c = n[a];
        c === La ? i += zt(o[a]) : c === wa ? i += me.transform(o[a]) : i += o[a];
      }
    return i;
  };
}
const Gh = (e) => typeof e == "number" ? 0 : me.test(e) ? me.getAnimatableNone(e) : e;
function qh(e) {
  const t = ya(e);
  return Ca(e)(t.map(Gh));
}
const et = {
  test: Uh,
  parse: ya,
...
function Jh({ hue: e, saturation: t, lightness: n, alpha: r }) {
  e /= 360, t /= 100, n /= 100;
  let o = 0, i = 0, a = 0;
  if (!t)
    o = i = a = n;
...
const gs = (e, t) => {
  ...
  if (!n || !r)
    return En(e, t);
  const o = { ...n };
  return (i) => (o.red = kr(n.red, r.red, i), o.green = kr(n.green, r.green, i), o.blue = kr(n.blue, r.blue, i), o.alpha = ue(n.alpha, r.alpha, i), it.transform(o));
...
function No(e) {
  return typeof e == "number" ? t2 : typeof e == "string" ? Mo(e) ? En : me.test(e) ? gs : o2 : Array.isArray(e) ? Ma : typeof e == "object" ? me.test(e) ? gs : n2 : En;
}
function Ma(e, t) {
...
const o2 = (e, t) => {
  ...
  return r.indexes.var.length === o.indexes.var.length && r.indexes.color.length === o.indexes.color.length && r.indexes.number.length >= o.indexes.number.length ? Pr.has(e) && !o.values.length || Pr.has(t) && !r.values.length ? e2(e, t) : an(Ma(r2(r, o), o.values), n) : (Rt(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), En(e, t));
};
function xa(e, t, n) {
  return typeof e == "number" && typeof t == "number" && typeof n == "number" ? ue(e, t, n) : No(e)(e, t);
}
const s2 = (e) => {
...
function i2(e, t = 100, n) {
  const r = n({ ...e, keyframes: [0, t] }), o = Math.min(Vo(r), Bn);
  return {
    type: "keyframes",
...
function c2({ duration: e = de.duration, bounce: t = de.bounce, velocity: n = de.velocity, mass: r = de.mass }) {
  let o, i;
  ...
  a = Ue(de.minDamping, de.maxDamping, a), e = Ue(de.minDuration, de.maxDuration, /* @__PURE__ */ Fe(e)), a < 1 ? (o = (d) => {
    const u = d * a, h = u * e, p = u - n, f = Hr(d, a), v = Math.exp(-h);
    return Lr - p / f * v;
  }, i = (d) => {
    const h = d * a * e, p = h * n + n, f = Math.pow(a, 2) * Math.pow(d, 2) * e, v = Math.exp(-h), k = Hr(Math.pow(d, 2), a);
    return (-o(d) + Lr > 0 ? -1 : 1) * ((p - f) * v) / k;
  }) : (o = (d) => {
...
const u2 = ["duration", "bounce"], h2 = ["stiffness", "damping", "mass"];
function vs(e, t) {
...
function On(e = de.visualDuration, t = de.bounce) {
  ...
  const i = n.keyframes[0], a = n.keyframes[n.keyframes.length - 1], c = { done: !1, value: i }, { stiffness: l, damping: d, mass: u, duration: h, velocity: p, isResolvedFromDuration: f } = p2({
    ...n,
    velocity: -/* @__PURE__ */ Fe(n.velocity || 0)
  }), v = p || 0, k = d / (2 * Math.sqrt(l * u)), M = a - i, g = /* @__PURE__ */ Fe(Math.sqrt(l / u)), y = Math.abs(M) < 5;
  r || (r = y ? de.restSpeed.granular : de.restSpeed.default), o || (o = y ? de.restDelta.granular : de.restDelta.default);
  let C;
  if (k < 1) {
    const N = Hr(g, k);
    C = (L) => {
  ...
  const x = {
    ...
    next: (N) => {
      ...
      if (f)
        ...
        const b = Math.abs(w) <= r, $ = Math.abs(a - L) <= o;
        c.done = b && $;
      }
      return c.value = c.done ? a : L, c;
    },
    toString: () => {
      const N = Math.min(Vo(x), Bn), L = ba((w) => x.next(N * w).value, N, 30);
      return N + "ms " + L;
    },
    toTransition: () => {
    }
...
function Rr({ keyframes: e, velocity: t = 0, power: n = 0.8, timeConstant: r = 325, bounceDamping: o = 10, bounceStiffness: i = 500, modifyTarget: a, min: c, max: l, restDelta: d = 0.5, restSpeed: u }) {
  ...
  return w(0), {
    ...
    next: (b) => {
      let $ = !1;
      return !L && N === void 0 && ($ = !0, x(b), w(b)), N !== void 0 && b >= N ? L.next(b - N) : (!$ && x(b), p);
    }
  };
}
function f2(e, t, n) {
...
function m2(e, t, { clamp: n = !0, ease: r, mixer: o } = {}) {
  const i = e.length;
  ...
  const c = f2(t, r, o), l = c.length, d = (u) => {
    if (a && u < e[0])
      return t[0];
    let h = 0;
    if (l > 1)
...
const w2 = (e) => e !== null;
function So(e, { repeat: t, repeatType: n = "loop" }, r, o = 1) {
  const i = e.filter(w2), c = o < 0 || t && n !== "loop" && t % 2 === 1 ? 0 : i.length - 1;
...
class To extends $o {
  ...
  initAnimation() {
    ...
    let { keyframes: c } = t;
    const l = n || yt;
    process.env.NODE_ENV !== "production" && l !== yt && ze(c.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${c}`), l !== yt && typeof c[0] != "number" && (this.mixKeyframes = an(C2, xa(c[0], c[1])), c = [0, 100]);
    const d = l({ ...t, keyframes: c });
    i === "mirror" && (this.mirroredGenerator = l({
      ...t,
      keyframes: [...c].reverse(),
      velocity: -a
    })), d.calculatedDuration === null && (d.calculatedDuration = Vo(d));
  ...
  tick(t, n = !1) {
    ...
    if (this.startTime === null)
      return r.next(0);
    const { delay: d = 0, keyframes: u, repeat: h, repeatType: p, repeatDelay: f, type: v, onUpdate: k, finalKeyframe: M } = this.options;
    ...
    const g = this.currentTime - d * (this.playbackSpeed >= 0 ? 1 : -1), y = this.playbackSpeed >= 0 ? g < 0 : g > o;
    ...
    if (h) {
      ...
      let $ = Math.floor(b), S = b % 1;
      !S && b >= 1 && (S = 1), S === 1 && $--, $ = Math.min($, h + 1), !!($ % 2) && (p === "reverse" ? (S = 1 - S, f && (S -= f / c)) : p === "mirror" && (x = a)), C = Ue(0, 1, S) * c;
    }
    const N = y ? { done: !1, value: u[0] } : x.next(C);
    i && (N.value = i(N.value));
    let { done: L } = N;
    ...
    return w && v !== Rr && (N.value = So(u, this.options, M, this.speed)), k && k(N.value), w && this.finish(), N;
  }
  /**
  ...
  play() {
    ...
    if (this.isStopped)
      return;
    const { driver: t = s2, startTime: n } = this.options;
...
}, Er = (e) => (e = e % 360, e < 0 && (e += 360), e), ks = Dr, Ls = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), ws = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), b2 = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
const Et = [
  ...
  "skewX",
  "skewY"
], Bt = new Set(Et), ys = (e) => e === Dt || e === ee, S2 = /* @__PURE__ */ new Set(["x", "y", "z"]), $2 = Et.filter((e) => !S2.has(e));
function T2(e) {
  const t = [];
  return $2.forEach((n) => {
...
class jo {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (dt.add(this), Fr || (Fr = !0, le.read($a), le.resolveKeyframes(Sa))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
const A2 = (e) => e.startsWith("--");
function I2(e, t, n) {
  A2(t) ? e.style.setProperty(t, n) : e.style[t] = n;
}
const P2 = /* @__PURE__ */ vo(() => window.ScrollTimeline !== void 0), H2 = {};
function R2(e, t) {
  const n = /* @__PURE__ */ vo(e);
  return () => H2[t] ?? n();
}
const Ta = /* @__PURE__ */ R2(() => {
  try {
...
function ja(e, t) {
  if (e)
    return typeof e == "function" ? Ta() ? ba(e, t) : "ease-out" : ma(e) ? _t(e) : Array.isArray(e) ? e.map((n) => ja(n, t) || Cs.easeOut) : Cs[e];
}
...
class B2 extends $o {
  constructor(t) {
    ...
    this.animation = D2(n, r, o, d, i), d.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !i) {
        const u = So(o, this.options, c, this.speed);
  ...
  attachTimeline({ timeline: t, observe: n }) {
    var r;
    return this.allowFlatten && ((r = this.animation.effect) == null || r.updateTiming({ easing: "linear" })), this.animation.onfinish = null, t && P2() ? (this.animation.timeline = t, Te) : n(this);
  }
}
const Ia = {
  anticipate: ua,
...
function F2(e) {
  typeof e.ease == "string" && O2(e.ease) && (e.ease = Ia[e.ease]);
}
const Ms = 10;
class Z2 extends B2 {
  constructor(t) {
    F2(t), Va(t), super(t), t.startTime && (this.startTime = t.startTime), this.options = t;
  }
  /**
   * WAAPI doesn't natively have any interruption capabilities.
   *
...
function _2(e, t, n, r) {
  ...
  return Rt(a === c, `You are trying to animate ${t} from "${o}" to "${i}". ${o} is not an animatable value - to enable this animation set ${o} to a value animatable to ${i} via the \`style\` property.`), !a || !c ? !1 : Y2(e) || (n === "spring" || Aa(n)) && r;
}
function Ao(e) {
...
const U2 = /* @__PURE__ */ new Set([
  ...
  // "background-color"
]), z2 = /* @__PURE__ */ vo(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function X2(e) {
  var d;
  const { motionValue: t, name: n, repeatDelay: r, repeatType: o, damping: i, type: a } = e;
  if (!Ao((d = t == null ? void 0 : t.owner) == null ? void 0 : d.current))
    return !1;
  const { onUpdate: c, transformTemplate: l } = t.owner.getProps();
  return z2() && n && U2.has(n) && (n !== "transform" || !l) && /**
...
class G2 extends $o {
  constructor({ autoplay: t = !0, delay: n = 0, type: r = "keyframes", repeat: o = 0, repeatDelay: i = 0, repeatType: a = "loop", keyframes: c, name: l, motionValue: d, element: u, ...h }) {
    ...
    const p = {
      ...
      element: u,
      ...h
    }, f = (u == null ? void 0 : u.KeyframeResolver) || jo;
    this.keyframeResolver = new f(c, (k, M, g) => this.onKeyframesResolved(k, M, p, !g), l, d, u), (v = this.keyframeResolver) == null || v.scheduleResolve();
  }
  onKeyframesResolved(t, n, r, o) {
    this.keyframeResolver = void 0;
    const { name: i, type: a, velocity: c, delay: l, isHandoff: d, onUpdate: u } = r;
    this.resolvedAt = Ne.now(), _2(t, i, a, c) || ((Xe.instantAnimations || !l) && (u == null || u(So(t, r, n))), t[0] = t[t.length - 1], r.duration = 0, r.repeat = 0);
    const p = {
      startTime: o ? this.resolvedAt ? this.resolvedAt - this.createdAt > K2 ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: n,
      ...r,
      keyframes: t
    }, f = !d && X2(p) ? new Z2({
  ...
  get animation() {
    var t;
    return this._animation || ((t = this.keyframeResolver) == null || t.resume(), j2()), this._animation;
  }
  get duration() {
...
const Q2 = 4;
function Pa(e, t, n = 1) {
  ze(n <= Q2, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
  const [r, o] = J2(e);
  if (!r)
    return;
...
const Ha = /* @__PURE__ */ new Set([
  ...
  test: (e) => e === "auto",
  parse: (e) => e
}, Ra = (e) => (t) => t.test(e), Da = [Dt, ee, Ze, qe, Yh, Zh, W2], bs = (e) => Da.find(Ra(e));
function e4(e) {
  return typeof e == "number" ? e === 0 : e !== null ? e === "none" || e === "0" || oa(e) : !0;
}
const t4 = /* @__PURE__ */ new Set(["brightness", "contrast", "saturate", "opacity"]);
function n4(e) {
...
const r4 = /\b([a-z-]*)\(.*?\)/gu, _r = {
  ...et,
  getAnimatableNone: (e) => {
    const t = e.match(r4);
    return t ? t.map(n4).join(" ") : e;
  }
}, Ns = {
  ...Dt,
...
const i4 = /* @__PURE__ */ new Set(["auto", "none", "0"]);
function a4(e, t, n) {
  let r = 0, o;
  for (; r < e.length && !o; ) {
    const i = e[r];
    typeof i == "string" && !i4.has(i) && Wt(i).values.length && (o = e[r]), r++;
  }
  if (o && n)
    for (const i of t)
      e[i] = Ba(n, o);
...
class c4 extends jo {
  ...
  readKeyframes() {
    ...
    for (let l = 0; l < t.length; l++) {
      let d = t[l];
      if (typeof d == "string" && (d = d.trim(), Mo(d))) {
        const u = Pa(d, n.current);
...
const Oa = (e, t) => t && typeof e == "number" ? t.transform(e) : e, Vs = 30, d4 = (e) => !isNaN(parseFloat(e));
class u4 {
  /**
  ...
  setCurrent(t) {
    this.current = t, this.updatedAt = Ne.now(), this.canTrackVelocity === null && t !== void 0 && (this.canTrackVelocity = d4(this.current));
  }
  ...
  getVelocity() {
    const t = Ne.now();
    if (!this.canTrackVelocity || this.prevFrameValue === void 0 || t - this.updatedAt > Vs)
      return 0;
    const n = Math.min(this.updatedAt - this.prevUpdatedAt, Vs);
...
function Za(e, t) {
  const n = l4(e), r = new AbortController(), o = {
    passive: !0,
    ...t,
    signal: r.signal
  };
...
function p4(e, t, n = {}) {
  const [r, o, i] = Za(e, n), a = (c) => {
    ...
    if (typeof d != "function" || !l)
      return;
    const u = (h) => {
      Ss(h) && (d(h), l.removeEventListener("pointerleave", u));
    };
...
const Ya = (e, t) => t ? e === t ? !0 : Ya(e, t.parentElement) : !1, Ro = (e) => e.pointerType === "mouse" ? typeof e.button != "number" || e.button <= 0 : e.isPrimary !== !1, f4 = /* @__PURE__ */ new Set([
  "BUTTON",
  "INPUT",
  "SELECT",
  "TEXTAREA",
...
function m4(e) {
  return f4.has(e.tagName) || e.tabIndex !== -1;
}
...
function v4(e, t, n = {}) {
  const [r, o, i] = Za(e, n), a = (c) => {
    ...
    $n.add(l);
    const d = t(l, c), u = (f, v) => {
      window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", p), $n.has(l) && $n.delete(l), Ts(f) && typeof d == "function" && d(f, { success: v });
    }, h = (f) => {
  ...
  return r.forEach((c) => {
    (n.useGlobalTarget ? window : c).addEventListener("pointerdown", a, o), Ao(c) && (c.addEventListener("focus", (d) => g4(d, o)), !m4(c) && !c.hasAttribute("tabindex") && (c.tabIndex = 0));
  }), i;
}
function _a(e) {
...
const xe = (e) => !!(e && e.getVelocity), L4 = [...Da, me, et], w4 = (e) => L4.find(Ra(e)), Do = Ht({
  transformPagePoint: (e) => e,
  isStatic: !1,
  reducedMotion: "never"
});
class y4 extends lo.Component {
...
function C4({ children: e, isPresent: t, anchorX: n, root: r }) {
  ...
  }, [t]), s(y4, { isPresent: t, childRef: i, sizeRef: a, children: lo.cloneElement(e, { ref: i }) });
}
const M4 = ({ children: e, initial: t, isPresent: n, onExitComplete: r, custom: o, presenceAffectsLayout: i, mode: a, anchorX: c, root: l }) => {
  const d = po(x4), u = uo();
  let h = !0, p = K(() => (h = !1, {
    id: u,
    initial: t,
  ...
  return i && h && (p = { ...p }), K(() => {
    d.forEach((f, v) => d.set(v, !1));
  }, [n]), lo.useEffect(() => {
    !n && !d.size && r && r();
  }, [n]), a === "popLayout" && (e = s(C4, { isPresent: n, anchorX: c, root: l, children: e })), s(Xn.Provider, { value: p, children: e });
};
function x4() {
...
const b4 = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: o = !0, mode: i = "sync", propagate: a = !1, anchorX: c = "left", root: l }) => {
  const [d, u] = Ua(a), h = K(() => js(e), [e]), p = a && !d ? [] : h.map(Cn), f = q(!0), v = q(h), k = po(() => /* @__PURE__ */ new Map()), [M, g] = D(h), [y, C] = D(h);
  ta(() => {
  ...
  if (h !== M) {
    ...
    for (let w = 0; w < y.length; w++) {
      const b = y[w], $ = Cn(b);
      p.includes($) || (L.splice(w, 0, b), x.push(b));
    }
    return i === "wait" && x.length && (L = x), C(js(L)), g(h), null;
  }
  ...
  return s(pe, { children: y.map((L) => {
    const w = Cn(L), b = a && !d ? !1 : h === y || p.includes(w), $ = () => {
      if (k.has(w))
        k.set(w, !0);
      else
        return;
      ...
      k.forEach((j) => {
        j || (S = !1);
      }), S && (N == null || N(), C(v.current), a && (u == null || u()), r && r());
    };
    return s(M4, { isPresent: b, initial: !f.current || n ? void 0 : !1, custom: t, presenceAffectsLayout: o, mode: i, root: l, onExitComplete: b ? void 0 : $, anchorX: c, children: L }, w);
  }) });
}, za = Ht({ strict: !1 }), As = {
  animation: [
    "animate",
...
function A4(e) {
  const { initial: t, animate: n } = j4(e, ye(Kn));
...
const Oo = (e) => e.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), H4 = "framerAppearId", Ga = "data-" + Oo(H4), qa = Ht({});
function R4(e, t, n, r, o) {
  var k, M;
  const { visualElement: i } = ye(Kn), a = ye(za), c = ye(Xn), l = ye(Do).reducedMotion, d = q(null);
  ...
  return ta(() => {
    u && (p.current = !0, window.MotionIsMounted = !0, u.updateFeatures(), Ho.render(u.render), v.current && u.animationState && u.animationState.animateChanges());
  }), Z(() => {
...
function E4({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: o }) {
  e && N4(e);
  function i(c, l) {
    let d;
    const u = {
      ...
      ...c,
      layoutId: B4(c)
    }, { isStatic: h } = u, p = A4(c), f = r(c, h);
    if (!h && fo) {
      O4(u, e);
      const v = F4(u);
      d = v.MeasureLayout, p.visualElement = R4(o, f, u, t, v.ProjectionNode);
    }
    return m(Kn.Provider, { value: p, children: [d && p.visualElement ? s(d, { visualElement: p.visualElement, ...u }) : null, n(o, c, P4(f, p.visualElement, l), f, h, p.visualElement)] });
  }
  i.displayName = `motion.${typeof o == "string" ? o : `create(${o.displayName ?? o.name ?? ""})`}`;
  const a = Qi(i);
  return a[I4] = o, a;
}
function B4({ layoutId: e }) {
  const t = ye(ho).id;
...
function Fo(e, t, n) {
  ...
  if (t.transform || (a || n ? r.transform = U4(t, e.transform, n) : r.transform && (r.transform = "none")), c) {
...
function X4(e, t) {
  const n = e.style || {}, r = {};
  return Wa(r, n, e), Object.assign(r, z4(e, t)), r;
}
function K4(e, t) {
  const n = {}, r = X4(e, t);
...
function ec(e, {
  ...
  h.transform && (p.transform = h.transform, delete h.transform), (p.transform || h.transformOrigin) && (p.transformOrigin = h.transformOrigin ?? "50% 50%", delete h.transformOrigin), p.transform && (p.transformBox = (u == null ? void 0 : u.transformBox) ?? "fill-box", delete h.transformBox), t !== void 0 && (h.x = t), n !== void 0 && (h.y = n), r !== void 0 && (h.scale = r), o !== void 0 && J4(h, o, i, a, !1);
}
const tc = () => ({
  ...Zo(),
  attrs: {}
...
function ep(e = !1) {
  return (n, r, o, { latestValues: i }, a) => {
    const l = (Yo(n) ? Q4 : K4)(r, i, a, n), d = $4(r, typeof n == "string", e), u = n !== sn ? { ...d, ...l, ref: o } : {}, { children: h } = r, p = K(() => xe(h) ? h.get() : h, [h]);
    return Wi(n, {
      ...u,
      children: p
    });
...
function tp({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, o) {
  return {
    latestValues: np(n, r, o, e),
    renderState: t()
  };
}
const rc = (e) => (t, n) => {
  const r = ye(Kn), o = ye(Xn), i = () => tp(e, t, r, o);
  return n ? i() : po(i);
};
function np(e, t, n, r) {
  const o = {}, i = r(e, {});
...
function Uo(e, t, n) {
  ...
  const { style: r } = e, o = {};
  for (const a in r)
    (xe(r[a]) || t.style && xe(t.style[a]) || Qa(a, e) || ((i = n == null ? void 0 : n.getValue(a)) == null ? void 0 : i.liveStyle) !== void 0) && (o[a] = r[a]);
  return o;
}
const rp = {
  useVisualState: rc({
...
const dp = (e) => e !== null;
function up(e, { repeat: t, repeatType: n = "loop" }, r) {
  const o = e.filter(dp), i = t && n !== "loop" && t % 2 === 1 ? 0 : o.length - 1;
  return o[i];
}
const hp = {
  type: "spring",
  ...
  duration: 0.3
}, gp = (e, { keyframes: t }) => t.length > 2 ? fp : Bt.has(e) ? e.startsWith("scale") ? pp(t[1]) : hp : mp;
function vp({ when: e, delay: t, delayChildren: n, staggerChildren: r, staggerDirection: o, repeat: i, repeatType: a, repeatDelay: c, from: l, elapsed: d, ...u }) {
...
const zo = (e, t, n, r = {}, o, i) => (a) => {
  ...
  vp(c) || Object.assign(u, gp(e, u)), u.duration && (u.duration = /* @__PURE__ */ He(u.duration)), u.repeatDelay && (u.repeatDelay = /* @__PURE__ */ He(u.repeatDelay)), u.from !== void 0 && (u.keyframes[0] = u.from);
  let h = !1;
  ...
  return c.isSync ? new To(u) : new G2(u);
};
function kp({ protectedKeys: e, needsAnimating: t }, n) {
...
function ic(e, t, { delay: n = 0, transitionOverride: r, type: o } = {}) {
  ...
  for (const u in c) {
    ...
    if (window.MotionHandoffAnimation) {
      const g = sc(e);
      if (g) {
        const y = window.MotionHandoffAnimation(g, u, le);
        y !== null && (f.startTime = y, k = !0);
      }
    }
    zr(e, u), h.start(zo(u, h, p, e.shouldReduceMotion && Ha.has(u) ? { type: !1 } : f, e, k));
    const M = h.animation;
    M && l.push(M);
  }
...
function Xr(e, t, n = {}) {
  ...
  const i = r ? () => Promise.all(ic(e, r, n)) : () => Promise.resolve(), a = e.variantChildren && e.variantChildren.size ? (d = 0) => {
    const { delayChildren: u = 0, staggerChildren: h, staggerDirection: p } = o;
    return Lp(e, t, d, u, h, p, n);
...
const Mp = [...Eo].reverse(), xp = Eo.length;
function bp(e) {
  return (t) => Promise.all(t.map(({ animation: n, options: r }) => yp(e, n, r)));
}
function Np(e) {
  let t = bp(e), n = Hs(), r = !0;
  const o = (l) => (d, u) => {
  ...
  function a(l) {
    const { props: d } = e, u = cc(e.parent) || {}, h = [], p = /* @__PURE__ */ new Set();
    let f = {}, v = 1 / 0;
    for (let M = 0; M < xp; M++) {
      const g = Mp[M], y = n[g], C = d[g] !== void 0 ? d[g] : u[g], x = en(C), N = g === l ? y.isActive : null;
      N === !1 && (v = M);
      let L = C === u[g] && C !== d[g] && x;
      ...
      let j = S.reduce(o(g), {});
      N === !1 && (j = {});
      const { prevResolvedValues: V = {} } = y, A = {
        ...V,
        ...j
      }, T = (E) => {
        b = !0, p.has(E) && ($ = !0, p.delete(E)), y.needsAnimating[E] = !0;
      ...
      y.prevProp = C, y.prevResolvedValues = j, y.isActive && (f = { ...f, ...j }), r && e.blockInitialAnimation && (b = !1), b && (!(L && w) || $) && h.push(...S.map((E) => ({
        animation: E,
        options: { type: g }
      })));
    }
    ...
    let k = !!h.length;
    return r && (d.initial === !1 || d.initial === d.animate) && !e.manuallyAnimateOnMount && (k = !1), r = !1, k ? t(h) : Promise.resolve();
  }
  function c(l, d) {
    var h;
    if (n[l].isActive === d)
...
class Sp extends tt {
   ...
   */
  constructor(t) {
    super(t), t.animationState || (t.animationState = Np(t));
  }
...
const Ap = (e) => (t) => Ro(t) && e(t, dn(t));
function Xt(e, t, n, r) {
  return rn(e, t, Ap(n), r);
}
...
const dc = 1e-4, Hp = 1 - dc, Rp = 1 + dc, uc = 0.01, Dp = 0 - uc, Ep = 0 + uc;
function be(e) {
  return e.max - e.min;
}
function Bp(e, t, n) {
...
function Rs(e, t, n, r = 0.5) {
  e.origin = r, e.originPoint = ue(t.min, t.max, e.origin), e.scale = be(n) / be(t), e.translate = ue(n.min, n.max, e.origin) - e.originPoint, (e.scale >= Hp && e.scale <= Rp || isNaN(e.scale)) && (e.scale = 1), (e.translate >= Dp && e.translate <= Ep || isNaN(e.translate)) && (e.translate = 0);
}
function Kt(e, t, n, r) {
...
function fc(e, t) {
  return lc(Pp(e.getBoundingClientRect(), t));
}
function Zp(e, t, n) {
  ...
  constructor(t, n, { transformPagePoint: r, contextWindow: o = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3 } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
      if (!(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const p = Mr(this.lastMoveEventInfo, this.history), f = this.startEvent !== null, v = Yp(p.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
      if (!f && !v)
        return;
    ...
    const c = dn(t), l = Cr(c, this.transformPagePoint), { point: d } = l, { timestamp: u } = Le;
...
function Xp(e, { top: t, left: n, bottom: r, right: o }) {
  return {
    x: Ks(e.x, n, o),
    y: Ks(e.y, t, r)
  };
...
class Wp {
  ...
  start(t, { snapToCursor: n = !1, distanceThreshold: r } = {}) {
    ...
    const i = (h) => {
      ...
      if (f && !v && (this.openDragLock && this.openDragLock(), this.openDragLock = h4(f), !this.openDragLock))
        return;
      this.latestPointerEvent = h, this.latestPanInfo = p, this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), $e((g) => {
        ...
        if (Ze.test(y)) {
          ...
          if (C && C.layout) {
            ...
            x && (y = be(x) * (parseFloat(y) / 100));
          }
        }
        this.originPoint[g] = y;
      }), k && le.postRender(() => k(h, p)), zr(this.visualElement, "transform");
      ...
      if (v && this.currentDirection === null) {
        this.currentDirection = ef(g), this.currentDirection !== null && k && k(this.currentDirection);
        return;
      }
  ...
  resolveConstraints() {
    ...
    t && Ct(t) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : t && r ? this.constraints = Xp(r.layoutBox, t) : this.constraints = !1, this.elastic = Jp(n), o !== this.constraints && r && this.constraints && !this.hasMutatedConstraints && $e((a) => {
      this.constraints !== !1 && this.getAxisMotionValue(a) && (this.constraints[a] = qp(r.layoutBox[a], this.constraints[a]));
    });
  }
  resolveRefConstraints() {
    ...
    if (!o || !o.layout)
      return !1;
    const i = Zp(r, o.root, this.visualElement.getTransformPagePoint());
    let a = Kp(o.layout.layoutBox, i);
    if (n) {
      const c = n(Ip(a));
  ...
  scalePositionWithinConstraints() {
    ...
    $e((a) => {
      ...
      if (c && this.constraints !== !1) {
        const l = c.get();
        o[a] = Gp({ min: l, max: l }, this.constraints[a]);
      }
    });
...
class tf extends tt {
  constructor(t) {
    super(t), this.removeGroupControls = Te, this.removeListeners = Te, this.controls = new Wp(t);
  }
  mount() {
...
class of extends Nl {
  ...
  componentDidMount() {
    ...
    Z4(sf), i && (n.group && n.group.add(i), r && r.register && o && r.register(i), ei && i.root.didUpdate(), i.addEventListener("animationComplete", () => {
      this.safeToRemove();
    }), i.setOptions({
      ...i.options,
  ...
  getSnapshotBeforeUpdate(t) {
    ...
    return a && (a.isPresent = i, ei = !0, o || t.layoutDependency !== n || n === void 0 || t.isPresent !== i ? a.willUpdate() : this.safeToRemove(), t.isPresent !== i && (i ? a.promote() : a.relegate() || le.postRender(() => {
      const c = a.getStack();
...
function kc(e) {
  ...
  return s(of, { ...e, layoutGroup: r, switchLayoutGroup: ye(qa), isPresent: t, safeToRemove: n });
}
const sf = {
  borderRadius: {
    ...Yt,
...
const Lc = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"], uf = Lc.length, ti = (e) => typeof e == "string" ? parseFloat(e) : e, ni = (e) => typeof e == "number" || ee.test(e);
function hf(e, t, n, r, o, i) {
  o ? (e.opacity = ue(0, n.opacity ?? 1, pf(r)), e.opacityExit = ue(t.opacity ?? 1, 0, ff(r))) : i && (e.opacity = ue(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let a = 0; a < uf; a++) {
    const c = `border${Lc[a]}Radius`;
    let l = ri(t, c), d = ri(n, c);
    if (l === void 0 && d === void 0)
      continue;
    l || (l = 0), d || (d = 0), l === 0 || d === 0 || ni(l) === ni(d) ? (e[c] = Math.max(ue(ti(l), ti(d), r), 0), (Ze.test(d) || Ze.test(l)) && (e[c] += "%")) : e[c] = d;
  }
...
const pf = /* @__PURE__ */ wc(0, 0.5, ha), ff = /* @__PURE__ */ wc(0.5, 0.95, Te);
function wc(e, t, n) {
...
function mf(e, t = 0, n = 1, r = 0.5, o, i = e, a = e) {
...
function ai(e, t, [n, r, o], i, a) {
  mf(e, t[n], t[r], t[o], t.scale, i, a);
}
const gf = ["x", "scaleX", "originX"], vf = ["y", "scaleY", "originY"];
function ci(e, t, n, r) {
  ai(e.x, t, gf, n ? n.x : void 0, r ? r.x : void 0), ai(e.y, t, vf, n ? n.y : void 0, r ? r.y : void 0);
}
function li(e) {
...
function wf(e, t, n) {
  ...
  if ((o || i || a) && (r = `translate3d(${o}px, ${i}px, ${a}px) `), (t.x !== 1 || t.y !== 1) && (r += `scale(${1 / t.x}, ${1 / t.y}) `), n) {
    const { transformPerspective: d, rotate: u, rotateX: h, rotateY: p, skewX: f, skewY: v } = n;
    d && (r = `perspective(${d}px) ${r}`), u && (r += `rotate(${u}deg) `), h && (r += `rotateX(${h}deg) `), p && (r += `rotateY(${p}deg) `), f && (r += `skewX(${f}deg) `), v && (r += `skewY(${v}deg) `);
  }
  const c = e.x.scale * t.x, l = e.y.scale * t.y;
  return (c !== 1 || l !== 1) && (r += `scale(${c}, ${l})`), r || "none";
}
const xr = ["", "X", "Y", "Z"], yf = 1e3;
let Cf = 0;
function br(e, t, n, r) {
  ...
  return class {
    constructor(a = {}, c = t == null ? void 0 : t()) {
      this.id = Cf++, this.animationId = 0, this.animationCommitId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = { x: 1, y: 1 }, this.eventHandlers = /* @__PURE__ */ new Map(), this.hasTreeAnimated = !1, this.updateScheduled = !1, this.scheduleUpdate = () => this.update(), this.projectionUpdateScheduled = !1, this.checkUpdateFailed = () => {
        ...
        this.projectionUpdateScheduled = !1, this.nodes.forEach(bf), this.nodes.forEach($f), this.nodes.forEach(Tf), this.nodes.forEach(Nf);
      ...
      this.root === this && (this.nodes = new lf());
    }
    ...
    mount(a) {
      if (this.instance)
        return;
      this.isSVG = _a(a) && !k4(a), this.instance = a;
      ...
      if (d && !d.current && d.mount(a), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (l || c) && (this.isLayoutDirty = !0), e) {
        ...
        le.read(() => {
          ...
          f !== h && (h = f, this.root.updateBlockedByResize = !0, u && u(), u = df(p, 250), jn.hasAnimatedSinceResize && (jn.hasAnimatedSinceResize = !1, this.nodes.forEach(gi)));
        });
      }
      c && this.root.registerSharedNode(c, this), this.options.animate !== !1 && d && (c || l) && this.addEventListener("didUpdate", ({ delta: u, hasLayoutChanged: h, hasRelativeLayoutChanged: p, layout: f }) => {
        ...
        const v = this.options.transition || d.getDefaultTransition() || Hf, { onLayoutAnimationStart: k, onLayoutAnimationComplete: M } = d.getProps(), g = !this.targetLayout || !Cc(this.targetLayout, f), y = !h && p;
        if (this.options.layoutRoot || this.resumeFrom || y || h && (g || !this.currentAnimation)) {
          ...
          (d.shouldReduceMotion || this.options.layoutRoot) && (C.delay = 0, C.type = !1), this.startAnimation(C), this.setAnimationOrigin(u, y);
        } else
    ...
    update() {
      ...
      this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(Sf), this.nodes.forEach(Mf), this.nodes.forEach(xf)) : this.nodes.forEach(mi), this.clearAllSnapshots();
      const c = Ne.now();
    ...
    clearAllSnapshots() {
      this.nodes.forEach(Vf), this.sharedNodes.forEach(Af);
    }
    ...
    resetTransform() {
      if (!o)
        return;
      const a = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout, c = this.projectionDelta && !yc(this.projectionDelta), l = this.getTransformTemplate(), d = l ? l(this.latestValues, "") : void 0, u = d !== this.prevTransformTemplateValue;
    ...
    measure(a = !0) {
      ...
      return a && (l = this.removeTransform(l)), Rf(l), {
        animationId: this.root.animationId,
        measuredBox: c,
        layoutBox: l,
        latestValues: {},
    ...
    removeTransform(a) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        if (!d.instance || !ot(d.latestValues))
          continue;
        Kr(d.latestValues) && d.updateSnapshot();
        const u = fe(), h = d.measurePageBox();
        Se(u, h), ci(c, d.latestValues, d.snapshot ? d.snapshot.layoutBox : void 0, u);
      }
    ...
    resolveTargetDelta(a = !1) {
      ...
      if (!(!this.layout || !(u || h))) {
        ...
        if (!(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = fe(), this.targetWithTransforms = fe()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Op(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : Se(this.target, this.layout.layoutBox), pc(this.target, this.targetDelta)) : Se(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
    ...
    calcProjection() {
      ...
      Fp(this.layoutCorrected, this.treeScale, this.path, c), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox, a.targetWithTransforms = fe());
      const { target: f } = a;
      if (!f) {
    ...
    setAnimationOrigin(a, c = !1) {
      ...
      const p = fe(), f = l ? l.source : void 0, v = this.layout ? this.layout.source : void 0, k = f !== v, M = this.getStack(), g = !M || M.members.length <= 1, y = !!(k && !g && this.options.crossfade === !0 && !this.path.some(Pf));
      this.animationProgress = 0;
      let C;
      this.mixTargetDelta = (x) => {
        const N = x / 1e3;
        vi(h.x, a.x, N), vi(h.y, a.y, N), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Gt(p, this.layout.layoutBox, this.relativeParent.layout.layoutBox), If(this.relativeTarget, this.relativeTargetOrigin, p, N), C && kf(this.relativeTarget, C) && (this.isProjectionDirty = !1), C || (C = fe()), Se(C, this.relativeTarget)), k && (this.animationValues = u, hf(u, d, this.latestValues, N, y, g)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = N;
    ...
    startAnimation(a) {
      ...
      this.notifyListeners("animationStart"), (c = this.currentAnimation) == null || c.stop(), (d = (l = this.resumingFrom) == null ? void 0 : l.currentAnimation) == null || d.stop(), this.pendingAnimation && (We(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = le.update(() => {
        jn.hasAnimatedSinceResize = !0, this.motionValue || (this.motionValue = Nt(0)), this.currentAnimation = af(this.motionValue, [0, 1e3], {
          ...a,
          velocity: 0,
          isSync: !0,
          onUpdate: (u) => {
    ...
    registerSharedNode(a, c) {
      this.sharedNodes.has(a) || this.sharedNodes.set(a, new Lf()), this.sharedNodes.get(a).add(c);
    ...
    resetSkewAndRotation() {
      ...
      if ((l.z || l.rotate || l.rotateX || l.rotateY || l.rotateZ || l.skewX || l.skewY) && (c = !0), !c)
        return;
      const d = {};
      l.z && br("z", a, d, this.animationValues);
      for (let u = 0; u < xr.length; u++)
        br(`rotate${xr[u]}`, a, d, this.animationValues), br(`skew${xr[u]}`, a, d, this.animationValues);
      a.render();
      for (const u in d)
    ...
    applyProjectionStyles(a, c) {
      ...
      let h = wf(this.projectionDeltaWithTransform, this.treeScale, u);
      ...
      for (const v in tn) {
        if (u[v] === void 0)
          continue;
        const { correct: k, applyTo: M, isCSSVariable: g } = tn[v], y = h === "none" ? u[v] : k(u[v], d);
        if (M) {
          const C = M.length;
          for (let x = 0; x < C; x++)
            a[M[x]] = y;
      ...
      this.options.layoutId && (a.pointerEvents = d === this ? Tn(c == null ? void 0 : c.pointerEvents) || "" : "none");
    }
    clearSnapshot() {
    ...
    if (!e.resumeFrom) {
      ...
      if (h && !h.resumeFrom) {
        ...
        if (p && f) {
          ...
          const k = fe();
          Gt(k, r, f.layoutBox), Cc(v, k) || (u = !0), h.options.layoutRoot && (e.relativeTarget = k, e.relativeTargetOrigin = v, e.relativeParent = h);
        }
      }
    }
...
function bc(e, t, n) {
  return e === "position" || e === "preserve-aspect" && !Bp(hi(t), hi(n), 0.2);
}
function Df(e) {
  var t;
...
function Ci(e, t, n) {
  ...
  i && le.postRender(() => i(t, dn(t)));
}
class Of extends tt {
  mount() {
    const { current: t } = this.node;
    t && (this.unmount = p4(t, (n, r) => (Ci(this.node, r, "Start"), (o) => Ci(this.node, o, "End"))));
  }
  unmount() {
  }
}
...
class Zf extends tt {
  mount() {
    const { current: t } = this.node;
    t && (this.unmount = v4(t, (n, r) => (Mi(this.node, r, "Start"), (o, { success: i }) => Mi(this.node, o, i ? "End" : "Cancel")), { useGlobalTarget: this.node.props.globalTapTarget }));
  }
  unmount() {
  }
}
const Jr = /* @__PURE__ */ new WeakMap(), Vr = /* @__PURE__ */ new WeakMap(), Yf = (e) => {
  const t = Jr.get(e.target);
  t && t(e);
}, _f = (e) => {
  e.forEach(Yf);
};
function Uf({ root: e, ...t }) {
  const n = e || document;
  Vr.has(n) || Vr.set(n, {});
  const r = Vr.get(n), o = JSON.stringify(t);
  return r[o] || (r[o] = new IntersectionObserver(_f, { root: e, ...t })), r[o];
}
function zf(e, t, n) {
  const r = Uf(t);
...
class Kf extends tt {
  ...
  startObserver() {
    ...
    const { viewport: t = {} } = this.node.getProps(), { root: n, margin: r, amount: o = "some", once: i } = t, a = {
      ...
      rootMargin: r,
      threshold: typeof o == "number" ? o : Xf[o]
    }, c = (l) => {
...
class t0 {
  ...
  constructor({ parent: t, props: n, presenceContext: r, reducedMotionConfig: o, blockInitialAnimation: i, visualState: a }, c = {}) {
    this.current = null, this.children = /* @__PURE__ */ new Set(), this.isVariantNode = !1, this.isControllingVariants = !1, this.shouldReduceMotion = null, this.values = /* @__PURE__ */ new Map(), this.KeyframeResolver = jo, this.features = {}, this.valueSubscriptions = /* @__PURE__ */ new Map(), this.prevMotionValues = {}, this.events = {}, this.propEventSubscriptions = {}, this.notifyUpdate = () => this.notify("Update", this.latestValues), this.render = () => {
  ...
  mount(t) {
    this.current = t, Wf.set(t, this), this.projection && !this.projection.instance && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, r) => this.bindToMotionValue(r, n)), Vc.current || Qf(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Qr.current, process.env.NODE_ENV !== "production" && Lo(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected."), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext);
  }
  unmount() {
  ...
  update(t, n) {
    ...
    this.prevMotionValues = e0(this, this.scrapeMotionValuesFromProps(t, this.prevProps, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue();
  }
  getProps() {
    return this.props;
  }
  ...
  readValue(t, n) {
    ...
    return r != null && (typeof r == "string" && (na(r) || oa(r)) ? r = parseFloat(r) : !w4(r) && et.test(n) && (r = Ba(t, n)), this.setBaseTarget(t, xe(r) ? r.get() : r)), xe(r) ? r.get() : r;
  }
  /**
...
class Sc extends t0 {
  constructor() {
    super(...arguments), this.KeyframeResolver = c4;
  }
...
function $c(e, { style: t, vars: n }, r, o) {
  const i = e.style;
  let a;
  for (a in t)
    i[a] = t[a];
...
class r0 extends Sc {
  ...
  readValueFromInstance(t, n) {
    var r;
    if (Bt.has(n))
      return (r = this.projection) != null && r.isProjecting ? Br(n) : N2(t, n);
    {
...
const i0 = (e, t) => Yo(e) ? new s0(t) : new r0(t, {
  ...
  const w = 8, b = F(() => {
    ...
    const P = N.current.getBoundingClientRect(), O = window.innerWidth, E = window.innerHeight;
    let z = 0, I = 0, R = r;
    const H = (X) => {
      switch (X) {
        case "top":
    ...
    z = B.top, I = B.left, R = B.placement, (() => {
      if (I < w && (I = w), I + g.width > O - w && (I = O - g.width - w), z < w) {
        if (R === "top") {
          const X = H("bottom");
          X.top + g.height <= E - w ? (z = X.top, I = X.left, R = "bottom") : z = w;
        }
      } else if (z + g.height > E - w && R === "bottom") {
        const X = H("top");
        X.top >= w ? (z = X.top, I = X.left, R = "top") : z = E - g.height - w;
      }
      if ((I < w || I + g.width > O - w) && (R === "top" || R === "bottom")) {
        const X = H("left");
        if (X.left >= w)
          z = X.top, I = X.left, R = "left";
        else {
          const _ = H("right");
          _.left + g.width <= O - w && (z = _.top, I = _.left, R = "right");
        }
      }
    })(), M({ top: z, left: I }), x(R);
  }, [r, i, g]);
  ...
  const V = () => {
    ...
    if (!N.current || !i || g.width === 0 || g.height === 0) return {};
    const P = N.current.getBoundingClientRect(), O = 12, E = P.left + P.width / 2, z = P.top + P.height / 2, I = k.left, R = k.top, H = E - I, B = z - R, U = (X, _, W) => _ >= 0 && _ <= W ? Math.max(O, Math.min(W - O, _)) : _ < 0 ? O : W - O;
    switch (C) {
      case "top":
        return {
  ...
  const k = () => ({
    ...
    if (!C) return null;
    const N = typeof C == "boolean" ? t === "_blank" ? /* @__PURE__ */ s(Y, { name: "share", size: 16 }) : /* @__PURE__ */ s(Y, { name: "link", size: 16 }) : C;
...
const jc = ({
  ...
  return /* @__PURE__ */ m("div", { className: `land-alert ${t} ${d} ${i ? "no-bg" : ""} ${a}`, style: c, children: [
    ...
    e === "loading" && /* @__PURE__ */ s(jc, { size: l, color: "var(--color-primary-6)" }),
  ...
  const d = q(null), [u, h] = D(""), [p, f] = D(0), v = F(() => l(), [l]), k = F((b) => b === window ? window.pageYOffset || document.documentElement.scrollTop : b.scrollTop, []), M = F((b, $) => {
    ...
    const b = [], $ = (S) => {
      S.forEach((j) => {
        j.key && b.push(j.key), j.children && $(j.children);
      });
    };
    return $(e), b;
  }, [e]), y = F((b, $) => {
    ...
    if (S)
      if (n === 0)
        ...
        const V = j === window ? { top: 0 } : j.getBoundingClientRect(), T = S.getBoundingClientRect().top - V.top, O = k(j) + T - n;
        M(j, O);
      }
    t == null || t(b);
  }, [n, t, v, k, M]);
      ...
      if (V.length > 0) {
        ...
        j.forEach((A) => {
          ...
          if (!A.isIntersecting && u === T) {
            const P = g.indexOf(T), O = g[P - 1] || null;
            h(O), f(g.indexOf(O)), O && (t == null || t(O));
          }
        });
    }, $ = v(), S = new IntersectionObserver(b, {
      threshold: [0, 0.5, 1],
      root: $ === window ? null : $,
  ...
  const C = (b, $ = 0) => b.map((S, j) => /* @__PURE__ */ m(
    "li",
    {
      style: { textIndent: $ > 0 ? `${$ * 0.5}em` : 0, paddingTop: j > 0 ? `${r}px` : 0 },
      onMouseEnter: () => {
        j !== p && (w(!0), N(j));
      },
      onMouseLeave: () => w(!1),
...
function l0(e, t, n, r, o = 2, i = 2, a = "#999", c = "#FF0000", l, d) {
  ...
  try {
    ...
    if (d) {
      const w = Math.min(...e), b = Math.max(...e), $ = Math.min(...e.filter((S) => S !== w));
      h = bi(
        e.filter((S) => S !== w),
        $,
        b
    ...
    for (let w = 0; w < C; w++) {
      const b = h[w] || 0, $ = w * g, S = Math.max(b * L, N), j = f - S;
      u.fillStyle = w < M ? c : a, u.fillRect($, j, o, S);
    }
  } catch (u) {
...
function u0({
  ...
  const h = q(null), p = q(null), f = q(), [v, k] = D([]), [M, g] = D(!1), [y, C] = D(null), [x, N] = D(t), L = F(async () => {
    if (e) {
      g(!0), C(null);
      try {
        const V = new (window.AudioContext || window.webkitAudioContext)(), T = await (await fetch(e)).arrayBuffer(), P = await V.decodeAudioData(T), O = d0(P, r);
        k(O || []), V.close();
      } catch (V) {
        C(V instanceof Error ? V.message : "Failed to generate wave data"), console.error("Error generating wave data:", V);
      } finally {
        g(!1);
      }
    }
  ...
  }, [v, r, o, i, a, c, l, d, u, e]), b = F((V, A, T, P, O) => {
    try {
      ...
      const R = T.currentTime || 0, H = T.duration || 1, B = Math.floor(R / H * V.length);
      if (E.clearRect(0, 0, z, I), V.length === 0) {
        console.warn("No data for line waveform");
        return;
      }
      const U = Math.max(...V), X = U > 0 ? I * 0.6 / U : 1, _ = z / (V.length - 1);
      if (E.beginPath(), E.strokeStyle = P, E.lineWidth = 1, E.setLineDash([2, 2]), E.moveTo(0, I / 2), E.lineTo(z, I / 2), E.stroke(), E.setLineDash([]), E.beginPath(), E.strokeStyle = P, E.lineWidth = 2, V.forEach((W, J) => {
        const Q = J * _, te = I / 2 - W * X;
        J === 0 ? E.moveTo(Q, te) : E.lineTo(Q, te);
      }), E.stroke(), B > 0) {
        E.beginPath(), E.strokeStyle = O, E.lineWidth = 3;
        for (let W = 0; W < Math.min(B, V.length); W++) {
          const J = W * _, Q = I / 2 - V[W] * X;
          W === 0 ? E.moveTo(J, Q) : E.lineTo(J, Q);
        }
        E.stroke();
      }
    } catch (E) {
  ...
  return Z(() => {
    ...
    return V.addEventListener("play", A), V.addEventListener("pause", T), V.addEventListener("ended", P), () => {
      V.removeEventListener("play", A), V.removeEventListener("pause", T), V.removeEventListener("ended", P), j();
    };
  }, [S, j, n]), Z(() => () => {
    j();
  }, [j]), {
...
const dm = ({
  ...
  var p;
  const c = q(null), [l, d] = D(!1), [u, h] = D(!0);
  return Z(() => {
  ...
  const x = K(() => !!(k && !f && !v), [k, f, v]), N = K(() => [
    ...
    n && `size-${n}`,
    u
  ].filter(Boolean).join(" "), [e, t, x, r, g, u]), L = () => /* @__PURE__ */ m(pe, { children: [
  ...
  return /* @__PURE__ */ s(ve, { theme: "dark", content: g, ...y, children: /* @__PURE__ */ s(
    "button",
    {
      ...w,
      children: L()
...
const Rc = (e, t) => {
  ...
  const [x, N] = D({
    ...
    if (!M.current) return;
    const O = M.current.getBoundingClientRect(), E = window.innerWidth, z = window.innerHeight, I = window.pageXOffset || document.documentElement.scrollLeft, R = window.pageYOffset || document.documentElement.scrollTop, H = 200, B = 150, U = 0;
    let X = 0, _ = 0, W = i, J = a;
    const Q = z - O.bottom - U, te = O.top - U;
    if (i === "bottom" && Q < B && te > B ? W = "top" : i === "top" && te < B && Q > B && (W = "bottom"), t) {
      if (!g.current) return;
      const oe = g.current.getBoundingClientRect(), ae = oe.width || H, Ce = oe.height || B;
      W === "bottom" ? X = O.bottom + U + R : X = O.top - Ce - U + R;
      let or = O.left + O.width / 2, sr = O.left, Ye = O.right;
      switch (a) {
        case "center":
          _ = or - ae / 2;
          break;
      ...
      _ < I ? (_ = I + U, J = "left") : _ + ae > I + E && (_ = I + E - ae - U, J = "right"), X < R ? X = R + U : X + Ce > R + z && (X = R + z - Ce - U);
    } else
      J = a;
    N({ top: X, left: _ }), w(W), $(J);
  }, [i, a, t]);
  Z(() => {
    if (y && !c) {
    ...
    if (y && !c) {
      const O = () => S(), E = () => S();
      return window.addEventListener("resize", O), window.addEventListener("scroll", E, !0), document.addEventListener("scroll", E, !0), () => {
        window.removeEventListener("resize", O), window.removeEventListener("scroll", E, !0), document.removeEventListener("scroll", E, !0);
      };
    }
  }, [y, c, S]), Z(() => {
    y ? d == null || d(y) : u == null || u(y);
  }, [y, d, u]);
  const j = (O) => {
  ...
  const L = K(() => e ? e.filter((T) => x.includes(T.key)).map((T) => T.label) : [], [e, x]), w = K(() => e ? e.filter((T) => x.includes(T.key)) : [], [e, x]), b = F(() => {
    var T;
    ...
    {
      const T = e == null ? void 0 : e.filter((E) => E.key === y)[0], P = T ? [T] : [], O = T ? [T.key] : [];
      return l({
        values: O,
        items: P,
        isMultiple: !1,
    ...
    (T) => {
      if (!T.disabled)
        if (o) {
          const P = [...x], O = P.indexOf(T.key);
          O > -1 ? P.splice(O, 1) : P.push(T.key), N(P);
    ...
    () => /* @__PURE__ */ s("div", { className: "land-select-list", children: e && e.length > 0 ? e == null ? void 0 : e.map((T) => /* @__PURE__ */ m(
      "div",
      {
        className: `land-select-drop-item ${T.tip ? "hover-pop" : ""} ${j(T.key) ? "selected" : ""} ${T.disabled ? "disabled" : ""}`,
        onClick: (P) => {
  ...
  return /* @__PURE__ */ s("div", { className: `land-select ${k}`, style: M, children: /* @__PURE__ */ s(un, { trigger: "click", disabled: p, dropContent: V, ...g, children: /* @__PURE__ */ m(
    "div",
    {
  ...
  return /* @__PURE__ */ m("div", { className: `land-calendar-header ${p}`, style: f, children: [
    ...
    /* @__PURE__ */ m("div", { className: "land-calendar-header-center", children: [
      ...
      g && n !== void 0 && /* @__PURE__ */ s(pe, { children: e === "zh" ? M[n + 1].zh : M[n + 1].en })
    ] }),
...
function k0(e, t, n, r, o) {
  ...
  for (let p = 0; p < c; p++) {
    ...
    u.push({
      date: v,
      isCurrentMonth: !1,
      isToday: v.toDateString() === d.toDateString(),
      isSelected: !1,
      isDisabled: !Sr(g, M, k, r, o),
      dayNumber: k,
      month: M,
      year: g
    });
...
const Oc = ({
  ...
  const [u, h] = D(/* @__PURE__ */ new Date()), [p, f] = D((/* @__PURE__ */ new Date()).getDate()), [v, k] = D((/* @__PURE__ */ new Date()).getFullYear()), [M, g] = D([]), y = (/* @__PURE__ */ new Date()).getDate(), C = (/* @__PURE__ */ new Date()).getMonth(), x = (/* @__PURE__ */ new Date()).getFullYear(), N = u.getFullYear(), L = u.getMonth();
  Z(() => {
    w0(N, e).then(g);
  }, [N, e]);
  const { yearRange: w, shouldShowYearSelector: b } = K(() => {
  ...
  const [l, d] = D(/* @__PURE__ */ new Date()), [u, h] = D(() => {
  ...
  }), p = l.getFullYear(), { yearRange: f, shouldShowYearSelector: v } = K(() => {
    ...
    h(b + 1);
    const $ = w[b];
    r == null || r($.weekStart, $.weekEnd, L.getFullYear());
  }, M = () => {
    const L = new Date(l.getFullYear(), l.getMonth() + 1, 1);
    d(L);
    const w = vt(L.getFullYear(), L.getMonth());
  ...
  return /* @__PURE__ */ m("div", { className: `land-calendar-week ${a}`, style: c, children: [
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar-week-days", children: x.map((L, w) => /* @__PURE__ */ s(
      "div",
      {
        ...
        children: L.dates.map((b, $) => /* @__PURE__ */ s(
          "div",
          {
  ...
  const l = /* @__PURE__ */ new Date(), d = l.getMonth(), u = l.getFullYear(), [h, p] = D(u), [f, v] = D(d), [k, M] = D(u), { yearRange: g, shouldShowYearSelector: y } = K(() => {
    const V = Ot(t, n), A = pn(t, n);
    return {
      yearRange: V,
    ...
    v(V), M(h), r == null || r(V, h);
  }, w = () => {
    p(u), v(d), M(u), r == null || r(d, u);
  }, b = [
  ...
  return /* @__PURE__ */ m("div", { className: `land-calendar-month ${a}`, style: c, children: [
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar-months-grid", children: b.map((V, A) => {
      const T = g0(h, V.value, t, n);
      return /* @__PURE__ */ s(
        "div",
        {
          className: `land-calendar-month-item ${$(V.value) ? "current" : ""} ${S(V.value) ? "selected" : ""} ${T ? "" : "disabled"}`,
          onClick: () => T && L(V.value),
          onMouseOver: (P) => {
            T && (o == null || o(V.value, h, "month", P));
          },
          onMouseOut: (P) => {
            T && (i == null || i(V.value, h, "month", P));
          },
  ...
  const [h, p] = D(d), [f, v] = D(u()), [k, M] = D(d), { yearRange: g, shouldShowYearSelector: y } = K(() => {
    const V = Ot(t, n), A = pn(t, n);
    return {
      yearRange: V,
      shouldShowYearSelector: A
  ...
  return /* @__PURE__ */ m("div", { className: `land-calendar-quarter ${a}`, style: c, children: [
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar-quarters-grid", children: b.map((V, A) => {
      const T = v0(h, V.value, t, n);
      return /* @__PURE__ */ m(
        "div",
        {
          className: `land-calendar-quarter-item ${$(V.value) ? "current" : ""} ${S(V.value) ? "selected" : ""} ${T ? "" : "disabled"}`,
          onClick: () => T && L(V.value),
          onMouseOver: (P) => {
            T && (o == null || o(V.value, h, "quarter", P));
          },
          onMouseOut: (P) => {
            T && (i == null || i(V.value, h, "quarter", P));
          },
          children: [
  ...
  const [h, p] = D(u()), [f, v] = D(d), { yearRange: k, shouldShowYearSelector: M } = K(() => {
    const V = Ot(t, n), A = pn(t, n);
    return {
      yearRange: V,
      shouldShowYearSelector: A
    ...
    const V = [], [A, T] = k, P = Math.floor(A / 10) * 10, O = Math.floor(T / 10) * 10;
    for (let E = P; E <= O; E += 10)
      V.push({
        key: E.toString(),
        label: `${E}-${E + 9}`
      });
    return V;
  }, [k]), b = (V) => V === d, $ = (V) => V === f, S = (V) => m0(V, t, n), j = L.includes(d);
  return /* @__PURE__ */ m("div", { className: `land-calendar-year ${a}`, style: c, children: [
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar-years-grid", children: L.map((V, A) => {
      ...
      return /* @__PURE__ */ m(
        "div",
        {
          className: `land-calendar-year-item ${b(V) ? "current" : ""} ${$(V) ? "selected" : ""} ${T ? "" : "disabled"}`,
          onClick: () => T && x(V),
          onMouseOver: (P) => {
            T && (o == null || o(V, "year", P));
          },
  ...
  { key: "hsv", label: "HSV" },
  { key: "hsl", label: "HSL" }
], S0 = "hex", $i = { h: 0, s: 100, v: 100 }, Ti = "var(--color-gray-3)", se = {
  // RGB转HSV
  rgbToHsv: (e, t, n) => {
  ...
  const n = q(null), [r, o] = D(!1), [i, a] = D({ x: 0, y: 0 }), c = K(() => {
  ...
  const u = F(
    (f) => {
      ...
      const { left: v, top: k } = ((b = n.current) == null ? void 0 : b.getBoundingClientRect()) || {
        left: 0,
        top: 0
      }, M = f.clientX - v, g = f.clientY - k, y = (($ = n.current) == null ? void 0 : $.clientWidth) || 0, C = ((S = n.current) == null ? void 0 : S.clientHeight) || 0, x = Math.max(0, Math.min(y, M)), N = Math.max(0, Math.min(C, g));
      a({ x, y: N });
      const L = x / y, w = 1 - N / C;
      t(L, w);
    },
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      className: `land-input ${u ? "disabled" : ""} ${M ? "clear" : ""} ${e} text-${h} ${g}`,
      style: {
  ...
  const [i, a] = D(S0), [c, l] = D($i.h), [d, u] = D(1), [h, p] = D(""), [f, v] = D({ r: 0, g: 0, b: 0 }), [k, M] = D($i), [g, y] = D({ h: 0, s: 0, l: 0 }), [C, x] = D({ x: 0, y: 0 }), N = q(!1), L = q(""), w = K(() => {
    switch (i) {
      case "hex":
        return h || "#000000";
      case "rgb":
    ...
    switch (i) {
      ...
      case "hsv":
        ...
        return se.rgbToHex(I.r, I.g, I.b);
      case "hsl":
        const R = se.hslToRgb(
          g.h,
          g.s,
    ...
    const I = se.hexToRgb(b);
    return I ? `rgba(${I.r}, ${I.g}, ${I.b}, ${d})` : `rgba(0, 0, 0, ${d})`;
  }, [b, d]), S = K(
    () => ({
      background: $,
      ...n
  ...
  Z(() => {
    if (e && e !== Ti && !N.current) {
      const I = se.hexToRgb(e);
      if (I) {
        const R = se.rgbToHsv(I.r, I.g, I.b), H = se.rgbToHsl(I.r, I.g, I.b);
  ...
  const j = F(() => {
    const I = `${w}-${b}-${$}`;
    I !== L.current && (L.current = I, t == null || t(w, b, $));
  }, [t, w, b, $]);
  Z(() => {
    N.current && j();
  }, [w, b, $, j]);
  const V = F(
    (I, R) => {
      ...
      M({ h: c, s: H, v: B });
      const X = se.hsvToRgb(c, H, B), _ = se.rgbToHsl(X.r, X.g, X.b), W = se.rgbToHex(X.r, X.g, X.b);
      v(X), y(_), p(W);
    },
    [c]
  ), A = (I) => {
    ...
    const R = { ...k, h: I };
    M(R);
    const H = se.hsvToRgb(I, R.s, R.v), B = se.rgbToHsl(H.r, H.g, H.b), U = se.rgbToHex(H.r, H.g, H.b);
    v(H), y(B), p(U);
  }, T = (I) => {
    u(I);
  }, P = (I) => {
    ...
    if (p(H), R.length === 6) {
      const B = se.hexToRgb(H);
      if (B) {
        const U = se.rgbToHsv(B.r, B.g, B.b), X = se.rgbToHsl(B.r, B.g, B.b);
        v(B), M(U), y(X), l(U.h);
      }
    }
  }, O = (I, R) => {
    ...
    v(B);
    const U = se.rgbToHsv(B.r, B.g, B.b), X = se.rgbToHsl(B.r, B.g, B.b), _ = se.rgbToHex(B.r, B.g, B.b);
    M(U), y(X), p(_), l(U.h);
  }, E = (I, R) => {
    let H = R;
    ...
    const B = { ...k, [I]: H };
    M(B);
    const U = se.hsvToRgb(B.h, B.s, B.v), X = se.rgbToHsl(U.r, U.g, U.b), _ = se.rgbToHex(U.r, U.g, U.b);
    v(U), y(X), p(_), l(B.h);
  }, z = (I, R) => {
    let H = R;
    I === "h" ? H = (R % 360 + 360) % 360 : H = Math.max(0, Math.min(100, Math.round(R)));
    const B = { ...g, [I]: H };
    y(B);
    const U = se.hslToRgb(B.h, B.s, B.l), X = se.rgbToHsv(U.r, U.g, U.b), _ = se.rgbToHex(U.r, U.g, U.b);
    v(U), M(X), p(_), l(B.h);
  };
  return /* @__PURE__ */ s(
    "div",
        ...
        un,
        {
          ...
          dropContent: /* @__PURE__ */ m(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ s($0, { hue: c, onPanelChange: V }),
  ...
  const L = F((R, H) => {
    if (!R) return "";
    const B = R.getFullYear(), U = R.getMonth() + 1, X = R.getDate();
    switch (H) {
      case "year":
        return `${B}年`;
      case "month":
      ...
      case "quarter":
        ...
        return `${B}年第${_}季度`;
      case "week":
        const W = new Date(B, 0, 1), J = Math.floor((R.getTime() - W.getTime()) / (24 * 60 * 60 * 1e3)), Q = Math.ceil((J + W.getDay() + 1) / 7);
        return `${B}年第${Q}周`;
      case "date":
      default:
        return `${B}-${U.toString().padStart(2, "0")}-${X.toString().padStart(2, "0")}`;
    }
  }, []), w = F((R) => {
  ...
  const b = F((...R) => {
    ...
    switch (c) {
      ...
      default:
        const [Q, te, oe] = R;
        H = new Date(oe, te - 1, Q);
        break;
    }
    k(H), u || (g(L(H, c)), t == null || t(H), f(!1));
  }, [c, u, L, t, e]), $ = F(() => {
  ...
  return Z(() => {
    const j = (V) => {
      V.key === "Escape" && g && e && v && v();
    };
    return e && g && document.addEventListener("keydown", j), () => {
            ...
            children: [
              ...
              d || /* @__PURE__ */ m("div", { className: "land-dialog-footer", children: [
                l || (h || p || M || k) && /* @__PURE__ */ m("div", { className: "land-dialog-footer-btn", children: [
                  M && /* @__PURE__ */ s(he, { type: "fill", status: "default", onClick: M, children: h }),
                  k && /* @__PURE__ */ s(
                    he,
                    {
                      type: "background",
  ...
  return Z(() => {
    ...
    "div",
    {
      className: `land-drawer ${e ? "show" : ""} ${t} ${j}`,
      style: S,
      children: [
        n && e && /* @__PURE__ */ s(
          we.div,
          ...
          we.div,
          {
            ...
            children: [
              /* @__PURE__ */ m("div", { className: "land-drawer-header-wrapper", children: [
                N && /* @__PURE__ */ s("div", { className: "land-drawer-header-close", children: /* @__PURE__ */ s(Y, { name: "close", onClick: N, strokeWidth: 3 }) }),
              ...
              h && (u || L || w || l || d) && /* @__PURE__ */ s(Re, {}),
              (u || L || w || l || d) && /* @__PURE__ */ m("div", { className: "land-drawer-footer", children: [
                d || (p || f || w || L) && /* @__PURE__ */ m("div", { className: "land-drawer-footer-btn", children: [
                  w && /* @__PURE__ */ s(
                    he,
                    {
                      type: "fill",
  ...
  const l = q(null), [d, u] = D(!1), [h, p] = D(0), f = t || n || "", v = F(() => {
    const g = l.current;
    if (g)
      if (e === 1) {
    ...
    const L = new MutationObserver((w) => {
      ...
      w.forEach(($) => {
        if ($.type === "childList" || $.type === "attributes") {
          const S = $.target;
          (g.contains(S) || S.contains(g) || g.parentElement && g.parentElement.contains(S)) && (b = !0);
        }
      }), b && k();
    });
...
const Fc = ({
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ m(
              ...
              {
                role: "button",
                className: `land-menu-link ${n === "column" ? "column" : ""} ${r === "column" && !M.titleDeputy ? "titleColumn" : ""} ${e === M.key && !(M.titleDeputy || i) ? "active" : ""} ${M.titleDeputy || i ? "title-deputy" : ""} ${u}`,
                onClick: (y) => {
          ...
          "div",
          {
            ...
            children: u && /* @__PURE__ */ s(
              Fc,
              {
                ...
                onChange: (y) => {
                  var C;
                  (C = u.onChange) == null || C.call(u, y), M(!1);
                },
                onDropChange: (y, C) => {
                  var x;
                  (x = u.onDropChange) == null || x.call(u, y, C), M(!1);
                }
              }
            )
          }
  ...
  const d = q(null), [u, h] = D("loading"), [p, f] = D(e), [v, k] = D("auto"), [M, g] = D(!1), [y, C] = D("idle");
  Z(() => {
  ...
  const x = () => {
    ...
    }, 150), d.current && k(`${d.current.width / d.current.height}`);
  }, N = () => {
  ...
  Z(() => {
    ...
    return S.complete && (M ? C("success") : h("success"), setTimeout(() => {
      M ? C("success") : h("success");
    }, 150), k(`${d.current.width / d.current.height}`)), S.addEventListener("load", x), S.addEventListener("error", N), () => {
      S == null || S.removeEventListener("load", x), S == null || S.removeEventListener("error", N);
    };
  }, [p, M]);
  const L = n || (u === "success" || y === "success" ? v : "1"), w = () => c && typeof c != "string" && u === "error" && (y === "error" || !l) ? c : u === "error" && (y === "error" || !l) && (!c || typeof c == "string") ? /* @__PURE__ */ s(Ac, { type: "error", title: "加载失败", direction: "column", className: "land-image-alert", noBg: !0 }) : null, b = u === "loading" || M && y === "loading", $ = p && (u === "success" || y === "success" || b);
  return /* @__PURE__ */ m(
    "div",
    {
      className: `land-image ${b ? "loading" : u === "success" || y === "success" ? "success" : "error"} ${r ?? ""}`,
      style: {
        aspectRatio: L,
        ...a
      },
      children: [
        ...
        $ && /* @__PURE__ */ s(
          "img",
          {
            ...
            alt: t,
            src: p,
            className: `land-image-img ${u === "success" || y === "success" ? "loaded" : ""} ${o}`,
            style: {
              opacity: u === "success" || y === "success" ? 1 : 0,
              ...i
            }
          }
        )
...
}, Mm = ({ children: e, style: t, className: n }) => /* @__PURE__ */ s("div", { className: `land-layout ${n}`, style: t, children: e });
var Ve = function() {
...
var Wn = 1, jt = 1, Xc = 0, Ae = 0, ge = 0, Ft = "";
function er(e, t, n, r, o, i, a, c) {
  return { value: e, root: t, parent: n, type: r, props: o, children: i, line: Wn, column: jt, length: a, return: "", siblings: c };
}
function Je(e, t) {
...
function _0() {
  return ge = Ae > 0 ? ke(Ft, --Ae) : 0, jt--, ge === 10 && (jt = 1, Wn--), ge;
}
function De() {
  return ge = Ae < Xc ? ke(Ft, Ae++) : 0, jt++, ge === 10 && (jt = 1, Wn++), ge;
}
function ut() {
  return ke(Ft, Ae);
}
...
function U0(e) {
  return Wn = jt = 1, Xc = Oe(Ft = e), Ae = 0, [];
}
function z0(e) {
  return Ft = "", e;
}
...
function X0(e) {
  for (; (ge = ut()) && ge < 33; )
    De();
  return eo(e) > 2 || eo(ge) > 3 ? "" : " ";
}
function K0(e, t) {
  for (; --t && De() && !(ge < 48 || ge > 102 || ge > 57 && ge < 65 || ge > 70 && ge < 97); )
    ;
...
function J0(e) {
  return z0(Hn("", null, null, null, [""], e = U0(e), 0, [0], e));
}
function Hn(e, t, n, r, o, i, a, c, l) {
  for (var d = 0, u = 0, h = a, p = 0, f = 0, v = 0, k = 1, M = 1, g = 1, y = 0, C = "", x = o, N = i, L = r, w = C; M; )
    switch (v = y, y = De()) {
      case 40:
        if (v != 108 && ke(w, h - 1) == 58) {
          In(w += ne($r(y), "&", "&\f"), "&\f", _c(d ? c[d - 1] : 0)) != -1 && (g = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (y) {
          ...
          case 125:
            M = 0;
          case 59 + u:
            g == -1 && (w = ne(w, /\f/g, "")), f > 0 && Oe(w) - h && Ut(f > 32 ? Pi(w + ";", r, n, h - 1, l) : Pi(ne(w, " ", "") + ";", r, n, h - 2, l), l);
            break;
          case 59:
            w += ";";
          default:
            if (Ut(L = Ii(w, t, n, d, u, o, c, C, x = [], N = [], h, i), i), y === 123)
              if (u === 0)
      ...
      default:
        ...
        switch (w += qo(y), y * k) {
          ...
          case 44:
            ...
            break;
          case 64:
            ut() === 45 && (w += $r(De())), p = ut(), u = h = Oe(C = w += q0(Pn())), y++;
            break;
          case 45:
            v === 45 && Oe(w) == 2 && (k = 0);
        }
...
function Ii(e, t, n, r, o, i, a, c, l, d, u, h) {
  for (var p = o - 1, f = o === 0 ? i : [""], v = zc(f), k = 0, M = 0, g = 0; k < r; ++k)
    for (var y = 0, C = Tt(e, p + 1, p = _c(M = a[k])), x = e; y < v; ++y)
      (x = Uc(M > 0 ? f[y] + " " + C : ne(C, /&\f/g, f[y]))) && (l[g++] = x);
  return er(e, t, n, o === 0 ? Qn : c, l, d, u, h);
}
function Q0(e, t, n, r) {
  return er(e, t, n, Zc, qo(Y0()), Tt(e, 2, -2), 0, r);
}
    ...
    case 4765:
      if (Oe(e) - 1 - t > 6)
        switch (ke(e, t + 1)) {
          ...
          case 115:
            return ~In(e, "stretch", 0) ? Kc(ne(e, "stretch", "fill-available"), t, n) + e : e;
        }
      break;
    case 5152:
    case 5920:
  ...
  if (e.length > -1 && !e.return)
    switch (e.type) {
      case Go:
        ...
        return;
      case Yc:
        return _n([Je(e, { value: ne(e.value, "@", "@" + ie) })], r);
      case Qn:
        if (e.length)
          return Z0(n = e.props, function(o) {
            switch (_e(o, r = /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                kt(Je(e, { props: [ne(o, /:(read-\w+)/, ":" + qt + "$1")] })), kt(Je(e, { props: [o] })), Wr(e, { props: Ai(n, r) });
                break;
              case "::placeholder":
                kt(Je(e, { props: [ne(o, /:(plac\w+)/, ":" + ie + "input-$1")] })), kt(Je(e, { props: [ne(o, /:(plac\w+)/, ":" + qt + "$1")] })), kt(Je(e, { props: [ne(o, /:(plac\w+)/, ce + "input-$1")] })), kt(Je(e, { props: [o] })), Wr(e, { props: Ai(n, r) });
                break;
            }
            return "";
          });
...
`, Un = typeof window < "u" && typeof document < "u", o3 = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Hi = /invalid hook call/i, xn = /* @__PURE__ */ new Set(), s3 = function(e, t) {
...
`, o = console.error;
    try {
      ...
      console.error = function(a) {
        ...
        Hi.test(a) ? (i = !1, xn.delete(r)) : o.apply(void 0, $t([a], c, !1));
...
var l3 = /(a)(d)/gi, bn = 52, Di = function(e) {
  return String.fromCharCode(e + (e > 25 ? 39 : 97));
};
function ro(e) {
  var t, n = "";
  for (t = Math.abs(e); t > bn; t = t / bn | 0) n = Di(t % bn) + n;
  return (Di(t % bn) + n).replace(l3, "$1-$2");
}
...
var el = typeof Symbol == "function" && Symbol.for, tl = el ? Symbol.for("react.memo") : 60115, u3 = el ? Symbol.for("react.forward_ref") : 60112, h3 = { childContextTypes: !0, contextType: !0, contextTypes: !0, defaultProps: !0, displayName: !0, getDefaultProps: !0, getDerivedStateFromError: !0, getDerivedStateFromProps: !0, mixins: !0, propTypes: !0, type: !0 }, p3 = { name: !0, length: !0, prototype: !0, caller: !0, callee: !0, arguments: !0, arity: !0 }, nl = { $$typeof: !0, compare: !0, defaultProps: !0, displayName: !0, propTypes: !0, type: !0 }, f3 = ((Tr = {})[u3] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }, Tr[tl] = nl, Tr);
function Ei(e) {
  return ("type" in (t = e) && t.type.$$typeof) === tl ? nl : "$$typeof" in e ? f3[e.$$typeof] : h3;
  var t;
}
var m3 = Object.defineProperty, g3 = Object.getOwnPropertyNames, Bi = Object.getOwnPropertySymbols, v3 = Object.getOwnPropertyDescriptor, k3 = Object.getPrototypeOf, Oi = Object.prototype;
function rl(e, t, n) {
  if (typeof t != "string") {
    if (Oi) {
      var r = k3(t);
...
}(), C3 = 1 << 30, Rn = /* @__PURE__ */ new Map(), zn = /* @__PURE__ */ new Map(), Dn = 1, Nn = function(e) {
  if (Rn.has(e)) return Rn.get(e);
  for (; zn.has(Dn); ) Dn++;
  var t = Dn++;
  if (process.env.NODE_ENV !== "production" && ((0 | t) < 0 || t > C3)) throw Zt(16, "".concat(t));
  return Rn.set(e, t), zn.set(t, e), t;
}, M3 = function(e, t) {
  Dn = t + 1, Rn.set(e, t), zn.set(t, e);
}, x3 = "style[".concat(pt, "][").concat(qc, '="').concat(nr, '"]'), b3 = new RegExp("^".concat(pt, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), N3 = function(e, t, n) {
  ...
  for (var n, r = ((n = t.textContent) !== null && n !== void 0 ? n : "").split(Jo), o = [], i = 0, a = r.length; i < a; i++) {
    ...
    if (c) {
      ...
      if (l) {
        ...
        d !== 0 && (M3(u, d), N3(e, u, l[3]), e.getTag().insertRules(d, o)), o.length = 0;
      } else o.push(c);
    }
  }
}, Zi = function(e) {
...
}(), Yi = Un, A3 = { isServer: !Un, useCSSOMInjection: !o3 }, sl = function() {
  function e(t, n, r) {
    t === void 0 && (t = At), n === void 0 && (n = {});
    var o = this;
    this.options = Ve(Ve({}, A3), t), this.gs = n, this.names = new Map(r), this.server = !!t.isServer, !this.server && Un && Yi && (Yi = !1, Zi(this)), Wo(this, function() {
      return function(i) {
...
function H3(e) {
  var t, n, r, o = At, i = o.options, a = i === void 0 ? At : i, c = o.plugins, l = c === void 0 ? rr : c, d = function(p, f, v) {
    return v.startsWith(n) && v.endsWith(n) && v.replaceAll(n, "").length > 0 ? ".".concat(t) : p;
  }, u = l.slice();
  u.push(function(p) {
    p.type === Qn && p.value.includes("&") && (p.props[0] = p.props[0].replace(I3, n).replace(r, d));
  }), a.prefix && u.push(n3), u.push(W0);
  var h = function(p, f, v, k) {
    f === void 0 && (f = ""), v === void 0 && (v = ""), k === void 0 && (k = "&"), t = k, n = f, r = new RegExp("\\".concat(n, "\\b"), "g");
    var M = p.replace(P3, ""), g = J0(v || f ? "".concat(v, " ").concat(f, " { ").concat(M, " }") : M);
    a.namespace && (g = il(g, a.namespace));
    var y = [];
    return _n(g, e3(u.concat(t3(function(C) {
      return y.push(C);
    })))), y;
  };
...
var R3 = new sl(), so = H3(), al = je.createContext({ shouldForwardProp: void 0, styleSheet: R3, stylis: so });
al.Consumer;
...
var cl = function(e) {
  ...
  for (var o in e) {
    var i = e[o];
    e.hasOwnProperty(o) && !cl(i) && (Array.isArray(i) && i.isCss || It(i) ? r.push("".concat(zi(o), ":"), i, ";") : Pt(i) ? r.push.apply(r, $t($t(["".concat(o, " {")], ll(i), !1), ["}"], !1)) : r.push("".concat(zi(o), ": ").concat((t = o, (n = i) == null || typeof n == "boolean" || n === "" ? "" : typeof n != "number" || n === 0 || t in r3 || t.startsWith("--") ? String(n).trim() : "".concat(n, "px")), ";")));
  }
  return r;
};
function ht(e, t, n, r) {
...
var B3 = Qc(nr), O3 = function() {
  function e(t, n, r) {
    this.rules = t, this.staticRulesId = "", this.isStatic = process.env.NODE_ENV === "production" && (r === void 0 || r.isStatic) && E3(t), this.componentId = n, this.baseHash = st(B3, n), this.baseStyle = r, sl.registerId(n);
  }
...
}(), dl = je.createContext(void 0);
dl.Consumer;
var Ar = {}, Xi = /* @__PURE__ */ new Set();
function F3(e, t, n) {
  var r = Qo(e), o = e, i = !jr(e), a = t.attrs, c = a === void 0 ? rr : a, l = t.componentId, d = l === void 0 ? function(x, N) {
    var L = typeof x != "string" ? "sc" : Ri(x);
    Ar[L] = (Ar[L] || 0) + 1;
    var w = "".concat(L, "-").concat(d3(nr + L + Ar[L]));
    return N ? "".concat(N, "-").concat(w) : w;
  }(t.displayName, t.parentComponentId) : l, u = t.displayName, h = u === void 0 ? function(x) {
    return jr(x) ? "styled.".concat(x) : "Styled(".concat(Wc(x), ")");
  }(e) : u, p = t.displayName && t.componentId ? "".concat(Ri(t.displayName), "-").concat(t.componentId) : t.componentId || d, f = r && o.attrs ? o.attrs.concat(c).filter(Boolean) : c, v = t.shouldForwardProp;
  ...
  function y(x, N) {
    return function(L, w, b) {
      var $ = L.attrs, S = L.componentStyle, j = L.defaultProps, V = L.foldedComponentIds, A = L.styledComponentId, T = L.target, P = je.useContext(dl), O = _i(), E = L.shouldForwardProp || O.shouldForwardProp;
      process.env.NODE_ENV !== "production" && cs(A);
      var z = i3(w, P, j) || At, I = function(_, W, J) {
        for (var Q, te = Ve(Ve({}, W), { className: void 0, theme: J }), oe = 0; oe < _.length; oe += 1) {
          var ae = It(Q = _[oe]) ? Q(te) : Q;
          for (var Ce in ae) te[Ce] = Ce === "className" ? ct(te[Ce], ae[Ce]) : Ce === "style" ? Ve(Ve({}, te[Ce]), ae[Ce]) : ae[Ce];
        }
        return W.className && (te.className = ct(te.className, W.className)), te;
      }($, w, z), R = I.as || T, H = {};
      for (var B in I) I[B] === void 0 || B[0] === "$" || B === "as" || B === "theme" && I.theme === z || (B === "forwardedAs" ? H.as = I.forwardedAs : E && !E(B, R) || (H[B] = I[B], E || process.env.NODE_ENV !== "development" || E0(B) || Xi.has(B) || !no.has(R) || (Xi.add(B), console.warn('styled-components: it looks like an unknown prop "'.concat(B, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var U = function(_, W) {
        var J = _i(), Q = _.generateAndInjectStyles(W, J.styleSheet, J.stylis);
        return process.env.NODE_ENV !== "production" && cs(Q), Q;
      }(S, I);
      process.env.NODE_ENV !== "production" && L.warnTooManyClasses && L.warnTooManyClasses(U);
      var X = ct(V, A);
      return U && (X += " " + U), I.className && (X += " " + I.className), H[jr(R) && !no.has(R) ? "class" : "className"] = X, b && (H.ref = b), Wi(R, H);
    }(C, x, N);
  }
  y.displayName = h;
  var C = je.forwardRef(y);
  return C.attrs = f, C.componentStyle = g, C.displayName = h, C.shouldForwardProp = v, C.foldedComponentIds = r ? ct(o.foldedComponentIds, o.styledComponentId) : "", C.styledComponentId = p, C.target = r ? o.target : e, Object.defineProperty(C, "defaultProps", { get: function() {
    ...
    this._foldedDefaultProps = r ? function(N) {
      ...
      for (var b = 0, $ = L; b < $.length; b++) oo(N, $[b], !0);
      return N;
    }({}, o.defaultProps, x) : x;
  } }), process.env.NODE_ENV !== "production" && (s3(h, p), C.warnTooManyClasses = /* @__PURE__ */ function(x, N) {
    var L = {}, w = !1;
    return function(b) {
      if (!w && (L[b] = !0, Object.keys(L).length >= 200)) {
        var $ = N ? ' with the id of "'.concat(N, '"') : "";
        console.warn("Over ".concat(200, " classes were generated for component ").concat(x).concat($, `.
...
function Z3(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  if (It(e) || Pt(e)) return Gi(ht(Ki(rr, $t([e], t, !0))));
  var r = e;
...
function io(e, t, n) {
  ...
  return r.attrs = function(o) {
    return io(e, t, Ve(Ve({}, n), { attrs: Array.prototype.concat(n.attrs, o).filter(Boolean) }));
  }, r.withConfig = function(o) {
    return io(e, t, Ve(Ve({}, n), o));
  }, r;
}
var ul = function(e) {
  return io(F3, e);
...
var Vn = "__sc-".concat(pt, "__");
process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "test" && typeof window < "u" && (window[Vn] || (window[Vn] = 0), window[Vn] === 1 && console.warn(`It looks like there are several instances of 'styled-components' initialized in this application. This may cause dynamic styles to not render properly, errors during the rehydration process, a missing theme prop, and makes your application bigger without good reason.

See https://s-c.sh/2BAXzed for more info.`), window[Vn] += 1);
const xm = ({
  type: e = "info",
  text: t = "这是一条全局提示",
  simple: n = !1,
...
const Ge = ao.getInstance(), bm = {
  ...
  const { pageData: u, curStart: h, isStartPreOut: p, isStartNextOut: f } = K(() => {
    ...
    const b = Array.from({ length: n }).map((j, V) => ({ id: V + 1 })).filter((j) => j.id > 1 && j.id < n).filter((j) => j.id >= w && j.id < w + L), $ = w <= L * 2, S = n - w < L * 2;
    return { pageData: b, curStart: w, isStartPreOut: $, isStartNextOut: S };
  }, [n, t, l]), v = F((L) => {
  ...
  const [f, v] = D([]), k = F(() => {
    ...
    let j = h || [];
    for (let V = 0; V < S; V++) {
      const A = f[V], T = j.find((P) => P.key === A);
    ...
    return j;
  }, [h, f]), y = F((S) => n ? c.some((j) => j.key === S.key) : (a == null ? void 0 : a.key) === S.key, [n, c, a]), C = F((S) => {
    if (!n || !S.children) return !1;
    const j = Lt(S), V = j.filter(
      (A) => c.some((T) => T.key === A)
    ).length;
    return V > 0 && V < j.length;
  }, [n, c]), x = F((S) => {
    let j = [...S];
    const V = (T) => {
      const P = [];
      return T.forEach((O) => {
        O.children && O.children.length > 0 && (P.push(O), P.push(...V(O.children)));
      }), P;
    };
    return V(h || []).forEach((T) => {
      const P = Lt(T), O = P.filter(
        (z) => j.some((I) => I.key === z)
      ).length, E = j.some((z) => z.key === T.key);
      O === P.length && !E ? j.push(T) : O === 0 && E && (j = j.filter((z) => z.key !== T.key));
    }), j;
  }, [h, Lt]), N = F((S, j) => {
    if (S.children && S.children.length > 0) {
      const V = f[j] === S.key;
      v(V ? f.slice(0, j) : [...f.slice(0, j), S.key]);
    } else if (n) {
      const V = y(S);
      let A;
      V ? A = c.filter((T) => T.key !== S.key) : A = [...c, S], A = x(A), p == null || p(A, S);
    } else
      p == null || p(S, S);
  }, [f, n, y, c, p, x]), L = F((S, j) => {
    if (!n) return;
    ...
    if (y(S)) {
      ...
      [S, ...hl(S)].forEach((P) => {
        V.some((O) => O.key === P.key) || V.push(P);
      });
    V = x(V), p == null || p(V, S);
  }, [n, c, p, y, Lt, x]), w = F(() => {
    v([]);
  }, []), b = K(() => g(0), [g]), $ = K(() => f.map((S, j) => {
    const V = j + 1, A = g(V);
    return { level: V, levelData: A };
  ...
  return /* @__PURE__ */ s("div", { className: "land-select-tree", children: /* @__PURE__ */ s(
    un,
    {
      ...
      dropContent: /* @__PURE__ */ m("div", { className: "land-select-tree-drop", children: [
        ...
        $.map(({ level: S, levelData: j }) => /* @__PURE__ */ s(
          co,
          {
            data: j,
            multiple: n,
  ...
  return /* @__PURE__ */ s("div", { className: "land-select-tree-drop-list", children: e == null ? void 0 : e.map((u) => {
    const h = r[n] === u.key, p = u.children && u.children.length > 0, f = a(u), v = c(u);
    return /* @__PURE__ */ m(
      "div",
      {
...
const Am = ({
  ...
  const [u, h] = D(""), [p, f] = D(!1), [v, k] = D(!1), M = q(null), g = q(null), y = q(e), x = { ...{
    duration: 1e3,
    easing: "easeOut",
    delay: 0,
    loop: !1,
    loopInterval: 2e3
  }, ...a }, N = F((V) => c > 0 ? V.toFixed(c) : Math.floor(V).toString(), [c]), L = F(() => {
    ...
    let E = 0;
    const z = U3[x.easing], I = () => {
      E++;
      const R = E / O, H = z(R), B = V + (A - V) * H;
      h(N(B)), E < O ? M.current = requestAnimationFrame(I) : (h(N(A)), M.current = null);
    };
  ...
  Z(() => {
  ...
  }, [i, e, x.delay, x.duration, b, N, w, L]), Z(() => {
    ...
    return p && V(), () => w();
  }, [x.loop, x.loopInterval, p, i, w]), Z(() => () => {
    L(), w();
  }, [L, w]), Z(() => {
    y.current !== e && i !== "none" && (f(!1), setTimeout(() => f(!0), 50)), y.current = e;
  }, [e, i]);
  const $ = K(() => N(e).split("").map((A) => A === "." ? "." : A === "-" ? "-" : parseInt(A, 10)), [e, N]), S = {
    bounce: {
  ...
  }, j = () => i === "bounce" ? S.bounce : i === "fade" ? S.fade : i === "slide" ? S.slide : i === "scale" ? S.scale : i === "flip" ? S.flip : S.fade;
  return /* @__PURE__ */ m("div", { className: `land-statistic ${d || ""}`, style: l, children: [
    ...
    /* @__PURE__ */ m("div", { className: "land-statistic-value", children: [
      /* @__PURE__ */ s(b4, { mode: "wait", children: i === "random" ? /* @__PURE__ */ s("div", { className: "flex items-center", children: $.map((V, A) => /* @__PURE__ */ s(
        "div",
        {
...
}, Pm = ({}) => /* @__PURE__ */ s("div", { children: "Swiper" }), pl = je.memo(({ item: e, index: t, isActive: n, isFinished: r, onClick: o, direction: i }) => {
  const a = F(() => {
    o == null || o(e);
  }, [o, e]), c = F((d) => {
...
const Hm = ({
  ...
  const h = K(() => t !== void 0 ? t : e.length > 0 ? e[0].key : void 0, [t, e]), p = K(() => Array.isArray(e) ? e.filter((y) => y && typeof y == "object" && y.key !== void 0) : [], [e]);
  if (p.length === 0)
    return d ? /* @__PURE__ */ s(pe, { children: d }) : null;
  const v = K(() => h !== void 0 && p.some((y) => y.key === h), [h, p]) ? h : p[0].key, k = F((y) => y.finished !== void 0 ? y.finished : n.includes(y.key), [n]), M = K(() => ["land-steps", a === "vertical" ? "vertical" : "", l].filter(Boolean).join(" "), [a, l]), g = F(() => p.map((y, C) => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ m(
          "div",
          {
            className: `land-switch-content ${u ? "dark" : ""} ${v ? "checked" : ""} ${f}`,
            style: p,
            onClick: (M) => {
              M.stopPropagation(), !h && (k(!v), d == null || d(v));
            },
            children: [
...
const X3 = ({
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "land-tag-input-container", children: [
          C == null ? void 0 : C.map((L, w) => /* @__PURE__ */ s(X3, { className: `land-tag-input-tag ${v}`, canDelete: !0, onDelete: () => {
  ...
  const [l, d] = D(null), [u, h] = D({ row: {}, col: {} }), p = q(null), f = q(null), v = (y, C) => {
    i && d({ row: y, col: C });
  }, k = () => {
    i && d(null);
  }, M = F(() => {
    if (i && l && p.current) {
      ...
      if (C && x.length > 0) {
        ...
        let w = 0, b = 0;
        for (let $ = 0; $ < C.children.length; $++) {
          const j = C.children[$].getBoundingClientRect().width;
          if ($ === l.col) {
            b = j;
            break;
          }
    ...
    if (c > 0 && p.current) {
      ...
      if (C) {
        ...
        for (let w = 0; w < Math.min(c, C.children.length); w++) {
          const $ = C.children[w].getBoundingClientRect().width;
          x[w] = {
            left: `${N}px`
          }, N += $;
        }
  ...
  const d = q(null), [u, h] = D(), [p, f] = D(), [v, k] = D(!1), M = (C, x) => {
  ...
  return /* @__PURE__ */ m(
    "label",
    {
      ...
      children: [
        ...
        r || (v ? /* @__PURE__ */ s(pe, { children: "上传中" }) : g ? /* @__PURE__ */ s("div", { className: "land-uploader-desc", children: "释放即可上传" }) : /* @__PURE__ */ m(pe, { children: [
  ...
  const k = q(null), M = q(null), [g, y] = D({ width: 0, height: 0 }), C = F(() => {
    const { width: b, height: $ } = g;
    if (b === 0 || $ === 0) return [];
    const [S, j] = i, [V, A] = a, T = Math.max(S, r), P = Math.max(j, o), O = b - r, E = $ - o, z = Math.max(0, Math.min(V, O)), I = Math.max(0, Math.min(A, E)), R = Math.ceil((O - z) / T) + 1, H = Math.ceil((E - I) / P) + 1, B = [];
    for (let U = 0; U < H; U++)
      for (let X = 0; X < R; X++) {
        const _ = z + X * T, W = I + U * P;
        _ + r <= b && W + o <= $ && B.push({
          id: `${U}-${X}`,
          x: _,
          y: W
    ...
    return B;
  }, [g, i, a, r, o]), x = K(() => C(), [C]), N = F(() => {
    if (k.current) {
      const { offsetWidth: b, offsetHeight: $ } = k.current;
      y({ width: b, height: $ });
    }
  }, []);
  Z(() => {
    N();
  }, [N]), Z(() => (M.current && (M.current.disconnect(), M.current = null), M.current = new ResizeObserver(() => {
    N();
  ...
  const L = K(
    ...
    (b) => {
      ...
      return /* @__PURE__ */ s("div", { className: `land-watermark-item ${n ? "img" : ""}`, style: $, children: n ? /* @__PURE__ */ s("img", { src: n, alt: "watermark" }) : t }, b.id);
    },
    [L, n, t]
  );
  return /* @__PURE__ */ m(
  ...
  const d = q(null), [u, h] = D(), [p, f] = D(!1), [v, k] = D(!1), [M, g] = D(0);
  Z(() => {
    const w = ($) => {
      $.forEach((S) => {
  ...
  const y = F((w) => {
    ...
    if (b) {
      const $ = (w.clientX - b.left) / b.width;
      g($), v && (r == null || r($, w)), o == null || o($, w.clientX - b.left, b.width, w);
    }
  }, [v, r, o]), C = F((w) => {
  ...
  }, [v, l]), /* @__PURE__ */ m(G3, { ref: d, className: `land-video-progress-bar ${p ? "hover" : ""}`, children: [
    /* @__PURE__ */ m(
      "div",
      {
...
`, q3 = ({
  ...
  /* @__PURE__ */ m(ji, { gap: 8, column: !0, children: [
    /* @__PURE__ */ s("span", { children: "倍数" }),
    /* @__PURE__ */ s(I0, { gap: 4, type: Be.ColumnRepeat, repeatNum: 3, children: e == null ? void 0 : e.map((i, a) => /* @__PURE__ */ m(
      Q3,
      {
  ...
  /* @__PURE__ */ m(ji, { justify: "space-between", width: "100%", children: [
    "自动循环",
...
`, qi = (e) => {
  ...
  tooltipFormatter: p = (w) => w.toString(),
  height: f = 4,
  thumbSize: v = 16,
  defaultBg: k = "var(--color-gray-4)",
  activeBg: M = "var(--color-primary-6)",
  thumbStyle: g,
  thumbClassName: y = "",
  onChange: C,
  onAfterChange: x,
  ...
  const w = q(null), [b, $] = D(null), [S, j] = D(null), V = () => {
    if (a)
  ...
  const P = (J) => (J - r) / (o - r) * 100, O = (J) => {
    const Q = J / 100 * (o - r) + r, te = Math.round(Q / i) * i;
    return Math.min(o, Math.max(r, te));
  }, E = (J) => {
    if (!w.current) return 0;
    const Q = w.current.getBoundingClientRect(), te = (J.clientX - Q.left) / Q.width * 100;
  ...
  const R = (J) => {
    ...
    const Q = E(J), te = O(Q);
    if (a) {
      const oe = Math.abs(te - A[0]), ae = Math.abs(te - A[1]), Ce = oe <= ae ? 0 : 1;
      z(Ce, te);
    } else
      z(0, te);
  }, H = () => {
    ...
    return J;
  }, B = (J, Q) => !u || !(b === J || S === J) ? null : /* @__PURE__ */ s(
    "div",
    {
      className: `land-slider-tooltip land-slider-tooltip-${h}`,
      children: p(Q)
    }
  ), U = P(A[0]), X = a ? P(A[1]) : U, _ = a ? U : 0, W = a ? X - U : U;
  return /* @__PURE__ */ m(
    "div",
    {
      className: `land-slider-wrapper ${N ? "land-slider-disabled" : ""} ${e}`,
      style: t,
      ...L,
      children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ s(
                "div",
                {
                  className: `land-slider-thumb ${y} ${b === 0 ? "land-slider-thumb-dragging" : ""}`,
                  style: {
                    left: `${U}%`,
                    width: `${v}px`,
                    height: `${v}px`,
              ...
              a && /* @__PURE__ */ s(
                "div",
                {
                  className: `land-slider-thumb ${y} ${b === 1 ? "land-slider-thumb-dragging" : ""}`,
                  style: {
                    left: `${X}%`,
                    width: `${v}px`,
                    height: `${v}px`,
  ...
  const g = q(null), y = q(null), C = q(null), [x, N] = D(1), [L, w] = D(0), [b, $] = D(0), [S, j] = D(0), [V, A] = D(!0), [T, P] = D(!1), [O, E] = D(!1), [z, I] = D(!1), [R, H] = D(!1), [B, U] = D(!1);
  q(null);
  const X = F(() => {
    if (g.current && !z) {
      const G = g.current;
  ...
  }, []), [W, J] = D(0), [Q, te] = D(!1), oe = K(() => (x || Number(t) || 1.7777777777777777) < 1 ? 100 : 200, [x, t]), ae = F((G, re, Me) => {
    if (!o) return;
    const Ee = y.current;
    Ee && (Ee.currentTime = G * L, re < oe / 2 ? J(0) : re < Me - oe / 2 ? J(re - oe / 2) : J(Me - oe));
  }, [Q]), Ce = F(() => {
    I(!0);
  }, []), or = F(() => {
    I(!1);
    ...
    const re = G * L;
    g.current.currentTime = re, $(re), g.current.paused && V && _();
  }, [L, V, _]), [Ye, mn] = D(100), [gn, fl] = D(100), [Ke, vn] = D(!0), es = q(null), [ts, ns] = D(!1);
  F((G) => {
  ...
  Z(() => {
    g.current && (g.current.pause(), H(!1), $(0), j(0), w(0), A(!0), P(!1), E(!1), cr(!1), dr(!1), hr(!1), te(!1)), y.current && (y.current.currentTime = 0);
  }, [e]), Rc(es, () => {
    ts && ns(!1);
  });
  const [rs, ml] = D(1), kn = F((G, re) => {
    ml(re.value), g.current && (console.log(G, g.current.playbackRate), g.current.playbackRate = G);
  }, []), [ft, os] = D(!1), ss = async () => {
    if (!g.current) return;
    const G = g.current;
    try {
  ...
  const pr = F((G) => {
    ...
    if (!(document.activeElement !== re && !document.fullscreenElement))
      switch (G.preventDefault(), G.code) {
        case "ArrowLeft":
          if (re.paused) return;
          const Me = Math.max(0, re.currentTime - r);
          re.currentTime = Me, $(Me), cr(!0);
          break;
        case "ArrowRight":
          if (re.paused) return;
          const Ee = Math.min(re.duration, re.currentTime + r);
          re.currentTime = Ee, $(Ee), dr(!0);
          break;
        case "Space":
  ...
  Z(() => {
    ...
    return G.addEventListener("play", re), G.addEventListener("pause", Me), G.addEventListener("ended", Ee), () => {
      G.removeEventListener("play", re), G.removeEventListener("pause", Me), G.removeEventListener("ended", Ee);
    };
  }, []);
  const gl = F((G) => {
    const re = G.target, Me = re.clientWidth / re.clientHeight;
    N(Me), w(re.duration), $(0), j(0), A(!0), P(!1), E(!1);
  }, []), fr = F(() => {
    if (!C.current) return;
    const re = C.current.offsetWidth, Me = 120, Ee = 60, kl = f || v ? 80 : 0, Ll = Me + Ee + kl, wl = re < Ll + 240 + 30;
    U(wl);
  }, [f, v]);
  Z(() => {
    fr();
  ...
  const vl = K(() => t || (x && x > 0 ? x.toString() : "auto"), [t, x]);
  return /* @__PURE__ */ m(
    "div",
    {
      className: `land-video ${T ? "error" : ""} ${nt ? "fullView" : ""} ${l}`,
      style: { aspectRatio: vl, ...d },
      children: [
        T ? /* @__PURE__ */ s(Ac, { type: "error", title: "视频错误", direction: "column", noBg: !0 }) : /* @__PURE__ */ s(pe, { children: /* @__PURE__ */ s(
          "video",
          {
            ref: g,
            src: e,
        ...
        !T && /* @__PURE__ */ s(
          Sl,
          {
                  ...
                  children: [
                    /* @__PURE__ */ m(pe, { children: [
                      /* @__PURE__ */ s(
                        ...
                        {
                          curPercentage: b / L,
                          bufferPercentage: S / L,
                          onClick: sr,
                          onMouseEnter: o ? (G, re, Me) => {
                            te(!0), ae(G, re, Me);
                          } : void 0,
                          onMove: o ? (G, re, Me) => ae == null ? void 0 : ae(G, re, Me) : void 0,
                        ...
                        "div",
                        {
                          ...
                          children: o && /* @__PURE__ */ s(
                            "video",
                            {
                              ...
                              muted: !0,
                              preload: "metadata",
                              style: { width: oe, height: oe / (x || Number(t) || 16 / 9), objectFit: "cover" },
                              onLoadedMetadata: () => {
                      ...
                      B ? /* @__PURE__ */ s("div", { className: "land-video-controls-right", children: /* @__PURE__ */ s(
                        ...
                        /* @__PURE__ */ m("button", { className: "land-video-controls-button setting hover-pop", children: [
                          ...
                          /* @__PURE__ */ s("div", { className: "land-video-setting-panel", children: /* @__PURE__ */ s("div", { className: "land-video-setting-content", children: /* @__PURE__ */ s(
                            ...
                            {
                              rateValue: rs,
                              onRateChange: (G, re) => kn == null ? void 0 : kn(G, re),
                              loop: ft,
                              onLoopChange: () => os(!ft)
                            }
                          ) }) })
            ...
            centerOption: {
              content: O && !V ? /* @__PURE__ */ s(jc, { size: 32, color: "white", strokeSize: 4 }) : /* @__PURE__ */ s("div", { className: "land-video-tags-container", children: R ? /* @__PURE__ */ s(Y, { name: "video-play", size: 20 }) : /* @__PURE__ */ s(Y, { name: "video-pause", size: 32 }) }),
              style: {
                opacity: ur || O || !R ? 1 : 0,
                pointerEvents: "none"
              }
  ...
  const [l, d] = D(!1), [u, h] = D(t), p = q(null);
  Z(() => {
    h(t);
  }, [t]);
  const f = () => {
    ...
    y.key === "Enter" && !y.shiftKey && (y.preventDefault(), v()), y.key === "Escape" && (h(t), d(!1));
  }, M = (y) => {
    h(y.target.value);
  }, g = () => {
    const y = {};
    ...
    const b = () => {
      ...
      for (let P = 0; P < u.length; P++)
        j += u[P], S[A] = {
          type: V,
          msg: j
        }, e.some((E) => j.includes(E) ? (V = E, !0) : !1) && (S[A].msg = j.split(V)[0], S.push({
          type: V,
          msg: V
        }), A += 2, j = "", V = "default");
      const T = S.map(
...
`) ? Object.assign(P, {
            msg: /* @__PURE__ */ s(pe, { children: P.msg })
          }) : P;
        }
      );
      return u.endsWith(`
`) && T.push({ type: "default", msg: /* @__PURE__ */ s("br", {}) }), T;
    ...
    return /* @__PURE__ */ m("div", { className: `land-highlight-textarea ${o}`, style: i, children: [
      /* @__PURE__ */ s(
        "div",
        {
          ...
          style: d,
          ref: C,
          children: $.length > 0 ? $.map((S, j) => S.type === "default" ? S.msg : r ? r(S.msg) : /* @__PURE__ */ s(
            "span",
            {
              className: "radius-4",
              style: {
  ...
  const v = K(() => nm(e, d), [e, d]), k = q(null), M = q(null), g = F(() => {
          ...
          /* @__PURE__ */ m("div", { className: "land-highlight-input-content", children: [
            e ? /* @__PURE__ */ s(
              "div",
              {
                ...
                children: v.map((N, L) => N.type === "default" ? N.msg : u ? u(N.msg) : /* @__PURE__ */ s("span", { className: "land-highlight-input-hight-string-item", children: N.msg }, N.msg + L))
              }
            ) : /* @__PURE__ */ s(
              "div",
              {
  ...
  }, [e, c]), h = K(() => e == null ? void 0 : e.map((k) => k.id), [e]), p = K(() => u == null ? void 0 : u.indexOf(i), [u, i]), f = K(() => h == null ? void 0 : h.indexOf(c), [h, c]), v = (k) => e.slice(0, k).reduce((M, g) => M + g.mediaData.length, 0);
  return Z(() => {
    if (n === void 0 || f === -1 || p === -1) return;
    let k = v(f);
    u.length <= 6 ? d.current && d.current.scrollTo({ top: (k - 1) * 96 + f * 8 + (k - f) * 1, behavior: "smooth" }) : p <= 5 ? d.current && d.current.scrollTo({ top: (k - 1) * 96 + f * 8 + (k - f) * 1, behavior: "smooth" }) : f === 0 ? d.current && d.current.scrollTo({ top: (k + Math.floor(p / 7) * 7) * 96 + f * 8 + (k - f + Math.floor(p / 7) * 7) * 1, behavior: "smooth" }) : d.current && d.current.scrollTo({ top: (k + 6 + Math.floor((p - 6) / 7) * 7) * 96 + f * 8 + (k - f + 6 + Math.floor((p - 6) / 7) * 7) * 1, behavior: "smooth" });
  }, [p, f]), Z(() => {
    if (!o) return;
    const k = (M) => {
      var g, y, C, x, N, L, w, b, $;
      if (!(M.repeat || f === -1 || p === -1))
        if (["TEXTAREA", "INPUT"].indexOf(M.target.tagName) === -1 && M.preventDefault(), M.code === "ArrowUp" || M.key === "ArrowUp") {
          if (p > 0)
            ...
            l(h[f - 1] ?? "");
            const S = (C = (y = e == null ? void 0 : e.filter((j) => j.id === h[f - 1])[0]) == null ? void 0 : y.mediaData) == null ? void 0 : C.length;
            a((N = (x = e[f - 1]) == null ? void 0 : x.mediaData[S - 1]) == null ? void 0 : N.id), r == null || r((L = e[f - 1]) == null ? void 0 : L.mediaData[S - 1], e[f - 1]);
          }
        } else (M.code === "ArrowDown" || M.key === "ArrowDown") && (p < (u == null ? void 0 : u.length) - 1 ? (a(u[p + 1]), r == null || r((w = e[f]) == null ? void 0 : w.mediaData[p + 1], e[f])) : f < h.length - 1 && (l(h[f + 1] ?? ""), a((b = e[f + 1]) == null ? void 0 : b.mediaData[0].id), r == null || r(($ = e[f + 1]) == null ? void 0 : $.mediaData[0], e[f + 1])));
    };
      ...
      children: e == null ? void 0 : e.map((k, M) => {
        ...
        return /* @__PURE__ */ s(
          "div",
          {
            ...
            children: (g = k.mediaData) == null ? void 0 : g.map((y, C) => /* @__PURE__ */ m(pe, { children: [
...
export {
  Be as GridType,
  Y as Icon,
  Sl as LandAffixContainer,
  Ac as LandAlert,
  cm as LandAnchor,
  Xo as LandAudio,
  lm as LandAutoContainer,
  _m as LandAutoWidthHeightTextarea,
  dm as LandBadge,
  ...
  ym as LandFooter,
  I0 as LandGrid,
  zm as LandGridTemplate,
  Cm as LandHeader,
  Xm as LandHighlightInput,
