...
var Ml = (e, t, n) => t in e ? Cl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
...
import $e, { useMemo as X, useState as R, useEffect as Y, createContext as Ht, useRef as q, useLayoutEffect as xl, useId as uo, useContext as ye, useInsertionEffect as Ji, useCallback as O, Children as bl, isValidElement as Nl, forwardRef as Qi, Fragment as sn, createElement as Wi, Component as Sl, useDebugValue as cs, useImperativeHandle as Vl } from "react";
const jl = ({
  ltOption: e,
  rtOption: t,
  rtOption2: n,
  ...
  const y = "var(--padding-m)", b = (A, T, P) => {
    const F = T !== void 0 ? T : y;
    switch (A) {
      case "lt":
      case "lb":
      case "lc":
  ...
  out: Eu,
  adjustment: Yu,
  "alphabetical-sorting": _u,
  "alphabetical-sorting-reverse": Uu,
  brightness: zu,
  layer: ih,
  "layer-front": Xu,
  "layer-back": Gu,
  ...
  "align-left": m1,
  "align-right": g1,
  "align-horizontally": v1,
  "align-vertically": k1,
  "text-align-left": L1,
  "text-align-right": w1,
  "text-align-center": y1,
  "text-align-justify": C1,
  "text-align-middle": M1,
  "align-bottom-center": x1,
  "align-bottom-left": b1,
  "align-bottom-right": N1,
  "align-horizontal-bottom": S1,
  "align-horizontal-center": V1,
  "align-horizontal-top": j1,
  "align-left-bottom": T1,
  "align-left-center": $1,
  "align-left-top": A1,
  "align-right-bottom": I1,
  "align-right-center": P1,
  "align-right-top": H1,
  "align-top-center": R1,
  "align-top-left": D1,
  "align-top-right": E1,
  "align-vertical-left": O1,
  "align-vertical-center": B1,
  "align-vertical-right": F1,
  "flip-horizontally": Z1,
  "flip-vertically": Y1,
  "font-size": _1,
  "line-height": U1,
  "text-bold": mh,
  ...
  "drop-shadow-down": W1,
  "drop-shadow-left": eh,
  "drop-shadow-right": th,
  "inner-shadow-up": nh,
  "inner-shadow-down": rh,
  "inner-shadow-left": oh,
...
const fo = typeof window < "u", ta = fo ? xl : Y, Xn = /* @__PURE__ */ Ht(null);
function mo(e, t) {
...
const Te = /* @__NO_SIDE_EFFECTS__ */ (e) => e, Sh = (e, t) => (n) => t(e(n)), an = (...e) => e.reduce(Sh), Jt = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
  const r = t - e;
  return r === 0 ? 1 : (n - e) / r;
};
class ko {
...
function ga(e, t) {
  ...
  const o = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, i = () => n = !0, a = wn.reduce((C, x) => (C[x] = Hh(i, t ? x : void 0), C), {}), { setup: c, read: l, resolveKeyframes: u, preUpdate: d, update: h, preRender: p, render: f, postRender: k } = a, v = () => {
    const C = Xe.useManualTiming ? o.timestamp : performance.now();
    n = !1, Xe.useManualTiming || (o.delta = r ? 1e3 / 60 : Math.max(Math.min(C - o.timestamp, Rh), 1)), o.timestamp = C, o.isProcessing = !0, c.process(o), l.process(o), u.process(o), d.process(o), h.process(o), p.process(o), f.process(o), k.process(o), o.isProcessing = !1, n && t && (r = !1, e(v));
  }, M = () => {
...
const Ne = {
  ...
  set: (e) => {
    Vn = e, queueMicrotask(Dh);
  }
}, va = (e) => (t) => typeof t == "string" && t.startsWith(e), Co = /* @__PURE__ */ va("--"), Eh = /* @__PURE__ */ va("var(--"), Mo = (e) => Eh(e) ? Bh.test(e.split("/*")[0].trim()) : !1, Bh = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, Dt = {
...
const Fh = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, bo = (e, t) => (n) => !!(typeof n == "string" && Fh.test(n) && n.startsWith(e) || t && !Oh(n) && Object.prototype.hasOwnProperty.call(n, t)), ka = (e, t, n) => (r) => {
  if (typeof r != "string")
    return r;
...
const Ir = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), qe = /* @__PURE__ */ ln("deg"), Ze = /* @__PURE__ */ ln("%"), J = /* @__PURE__ */ ln("px"), _h = /* @__PURE__ */ ln("vh"), Uh = /* @__PURE__ */ ln("vw"), ps = {
  ...Ze,
...
function Xh(e) {
  var t, n;
  return isNaN(e) && typeof e == "string" && (((t = e.match(xo)) == null ? void 0 : t.length) || 0) + (((n = e.match(zh)) == null ? void 0 : n.length) || 0) > 0;
}
const La = "number", wa = "color", Gh = "var", Kh = "var(", fs = "${}", qh = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Wt(e) {
  ...
  let i = 0;
  const c = t.replace(qh, (l) => (pe.test(l) ? (r.color.push(i), o.push(wa), n.push(pe.parse(l))) : l.startsWith(Kh) ? (r.var.push(i), o.push(Gh), n.push(l)) : (r.number.push(i), o.push(La), n.push(parseFloat(l))), ++i, fs)).split(fs);
...
const Jh = (e) => typeof e == "number" ? 0 : pe.test(e) ? pe.getAnimatableNone(e) : e;
function Qh(e) {
  const t = ya(e);
  return Ca(e)(t.map(Jh));
}
const et = {
  test: Xh,
  parse: ya,
...
function Wh({ hue: e, saturation: t, lightness: n, alpha: r }) {
  e /= 360, t /= 100, n /= 100;
  let o = 0, i = 0, a = 0;
  if (!t)
    o = i = a = n;
...
function No(e) {
  return typeof e == "number" ? r2 : typeof e == "string" ? Mo(e) ? En : pe.test(e) ? gs : i2 : Array.isArray(e) ? Ma : typeof e == "object" ? pe.test(e) ? gs : o2 : En;
}
function Ma(e, t) {
...
const i2 = (e, t) => {
  ...
  return r.indexes.var.length === o.indexes.var.length && r.indexes.color.length === o.indexes.color.length && r.indexes.number.length >= o.indexes.number.length ? Pr.has(e) && !o.values.length || Pr.has(t) && !r.values.length ? n2(e, t) : an(Ma(s2(r, o), o.values), n) : (Rt(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), En(e, t));
};
function xa(e, t, n) {
...
function d2({ duration: e = ce.duration, bounce: t = ce.bounce, velocity: n = ce.velocity, mass: r = ce.mass }) {
  let o, i;
  ...
  a = Ue(ce.minDamping, ce.maxDamping, a), e = Ue(ce.minDuration, ce.maxDuration, /* @__PURE__ */ Fe(e)), a < 1 ? (o = (u) => {
    const d = u * a, h = d * e, p = d - n, f = Hr(u, a), k = Math.exp(-h);
    return Lr - p / f * k;
  }, i = (u) => {
    const h = u * a * e, p = h * n + n, f = Math.pow(a, 2) * Math.pow(u, 2) * e, k = Math.exp(-h), v = Hr(Math.pow(u, 2), a);
    return (-o(u) + Lr > 0 ? -1 : 1) * ((p - f) * k) / v;
  }) : (o = (u) => {
...
const p2 = ["duration", "bounce"], f2 = ["stiffness", "damping", "mass"];
function vs(e, t) {
...
function On(e = ce.visualDuration, t = ce.bounce) {
  ...
  const i = n.keyframes[0], a = n.keyframes[n.keyframes.length - 1], c = { done: !1, value: i }, { stiffness: l, damping: u, mass: d, duration: h, velocity: p, isResolvedFromDuration: f } = m2({
    ...n,
    velocity: -/* @__PURE__ */ Fe(n.velocity || 0)
  }), k = p || 0, v = u / (2 * Math.sqrt(l * d)), M = a - i, g = /* @__PURE__ */ Fe(Math.sqrt(l / d)), w = Math.abs(M) < 5;
  ...
  const x = {
    ...
    next: (N) => {
      ...
      if (f)
        ...
        let y = N === 0 ? k : 0;
        v < 1 && (y = N === 0 ? /* @__PURE__ */ He(k) : Na(C, N, L));
    ...
    toString: () => {
      const N = Math.min(So(x), Bn), L = ba((y) => x.next(N * y).value, N, 30);
      return N + "ms " + L;
    },
    toTransition: () => {
    }
...
function v2(e, t, { clamp: n = !0, ease: r, mixer: o } = {}) {
  const i = e.length;
  ...
  const c = g2(t, r, o), l = c.length, u = (d) => {
    if (a && d < e[0])
      return t[0];
    let h = 0;
    if (l > 1)
...
function Vo(e, { repeat: t, repeatType: n = "loop" }, r, o = 1) {
  const i = e.filter(C2), c = o < 0 || t && n !== "loop" && t % 2 === 1 ? 0 : i.length - 1;
...
class To extends jo {
  ...
  initAnimation() {
    ...
    let { keyframes: c } = t;
    const l = n || yt;
    process.env.NODE_ENV !== "production" && l !== yt && ze(c.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${c}`), l !== yt && typeof c[0] != "number" && (this.mixKeyframes = an(x2, xa(c[0], c[1])), c = [0, 100]);
  ...
  tick(t, n = !1) {
    ...
    return y && k !== Rr && (N.value = Vo(d, this.options, M, this.speed)), v && v(N.value), y && this.finish(), N;
  }
  /**
  ...
  play() {
    ...
    if (this.isStopped)
      return;
    const { driver: t = a2, startTime: n } = this.options;
...
}, Er = (e) => (e = e % 360, e < 0 && (e += 360), e), ks = Dr, Ls = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), ws = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), S2 = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
function Or(e, t) {
  ...
  if (!o)
    return Br(t);
  const i = r[t], a = o[1].split(",").map(j2);
...
const Et = [
  ...
  "skewX",
  "skewY"
], Bt = new Set(Et), ys = (e) => e === Dt || e === J, T2 = /* @__PURE__ */ new Set(["x", "y", "z"]), $2 = Et.filter((e) => !T2.has(e));
function A2(e) {
  const t = [];
  return $2.forEach((n) => {
...
const R2 = /* @__PURE__ */ vo(() => window.ScrollTimeline !== void 0), D2 = {};
function E2(e, t) {
  const n = /* @__PURE__ */ vo(e);
  return () => D2[t] ?? n();
}
const Ta = /* @__PURE__ */ E2(() => {
  try {
...
function B2(e, t, n, { delay: r = 0, duration: o = 300, repeat: i = 0, repeatType: a = "loop", ease: c = "easeOut", times: l } = {}, u = void 0) {
  const d = {
    [t]: n
  };
  l && (d.offset = l);
...
class F2 extends jo {
  constructor(t) {
    ...
    const u = O2(t);
    this.animation = B2(n, r, o, u, i), u.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !i) {
        const d = Vo(o, this.options, c, this.speed);
        this.updateMotionValue ? this.updateMotionValue(d) : H2(n, r, d), this.animation.cancel();
      }
  ...
  attachTimeline({ timeline: t, observe: n }) {
    var r;
    return this.allowFlatten && ((r = this.animation.effect) == null || r.updateTiming({ easing: "linear" })), this.animation.onfinish = null, t && R2() ? (this.animation.timeline = t, Te) : n(this);
  }
}
const Ia = {
  anticipate: ua,
...
function Y2(e) {
  typeof e.ease == "string" && Z2(e.ease) && (e.ease = Ia[e.ease]);
}
const Ms = 10;
class _2 extends F2 {
  constructor(t) {
    Y2(t), Sa(t), super(t), t.startTime && (this.startTime = t.startTime), this.options = t;
  }
  /**
   * WAAPI doesn't natively have any interruption capabilities.
   *
...
function z2(e, t, n, r) {
  ...
  return Rt(a === c, `You are trying to animate ${t} from "${o}" to "${i}". ${o} is not an animatable value - to enable this animation set ${o} to a value animatable to ${i} via the \`style\` property.`), !a || !c ? !1 : U2(e) || (n === "spring" || Aa(n)) && r;
}
function Ao(e) {
...
const X2 = /* @__PURE__ */ new Set([
  ...
  // "background-color"
]), G2 = /* @__PURE__ */ vo(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function K2(e) {
  var u;
  ...
  return G2() && n && X2.has(n) && (n !== "transform" || !l) && /**
...
class J2 extends jo {
  ...
  onKeyframesResolved(t, n, r, o) {
    ...
    this.resolvedAt = Ne.now(), z2(t, i, a, c) || ((Xe.instantAnimations || !l) && (d == null || d(Vo(t, r, n))), t[0] = t[t.length - 1], r.duration = 0, r.repeat = 0);
    const p = {
      startTime: o ? this.resolvedAt ? this.resolvedAt - this.createdAt > q2 ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: n,
      ...r,
      keyframes: t
    }, f = !u && K2(p) ? new _2({
  ...
  get animation() {
    var t;
    return this._animation || ((t = this.keyframeResolver) == null || t.resume(), I2()), this._animation;
  }
  get duration() {
...
const e4 = 4;
function Pa(e, t, n = 1) {
  ze(n <= e4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
  const [r, o] = W2(e);
  if (!r)
    return;
...
const Ha = /* @__PURE__ */ new Set([
  ...
  test: (e) => e === "auto",
  parse: (e) => e
}, Ra = (e) => (t) => t.test(e), Da = [Dt, J, Ze, qe, Uh, _h, t4], bs = (e) => Da.find(Ra(e));
function n4(e) {
  return typeof e == "number" ? e === 0 : e !== null ? e === "none" || e === "0" || oa(e) : !0;
}
const r4 = /* @__PURE__ */ new Set(["brightness", "contrast", "saturate", "opacity"]);
function o4(e) {
...
function l4(e, t, n) {
  ...
  for (; r < e.length && !o; ) {
    const i = e[r];
    typeof i == "string" && !c4.has(i) && Wt(i).values.length && (o = e[r]), r++;
  }
  if (o && n)
    for (const i of t)
      e[i] = Ba(n, o);
...
const Oa = (e, t) => t && typeof e == "number" ? t.transform(e) : e, Ss = 30, h4 = (e) => !isNaN(parseFloat(e));
class p4 {
  /**
  ...
  setCurrent(t) {
    this.current = t, this.updatedAt = Ne.now(), this.canTrackVelocity === null && t !== void 0 && (this.canTrackVelocity = h4(this.current));
  }
...
function Za(e, t) {
  const n = u4(e), r = new AbortController(), o = {
    passive: !0,
    ...t,
    signal: r.signal
  };
...
const Ya = (e, t) => t ? e === t ? !0 : Ya(e, t.parentElement) : !1, Ro = (e) => e.pointerType === "mouse" ? typeof e.button != "number" || e.button <= 0 : e.isPrimary !== !1, g4 = /* @__PURE__ */ new Set([
  "BUTTON",
  "INPUT",
  "SELECT",
  "TEXTAREA",
...
function v4(e) {
  return g4.has(e.tagName) || e.tabIndex !== -1;
}
...
function L4(e, t, n = {}) {
  const [r, o, i] = Za(e, n), a = (c) => {
    ...
    jn.add(l);
    const u = t(l, c), d = (f, k) => {
      window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", p), jn.has(l) && jn.delete(l), Ts(f) && typeof u == "function" && u(f, { success: k });
    }, h = (f) => {
  ...
  return r.forEach((c) => {
    (n.useGlobalTarget ? window : c).addEventListener("pointerdown", a, o), Ao(c) && (c.addEventListener("focus", (u) => k4(u, o)), !v4(c) && !c.hasAttribute("tabindex") && (c.tabIndex = 0));
  }), i;
}
function _a(e) {
...
const Me = (e) => !!(e && e.getVelocity), y4 = [...Da, pe, et], C4 = (e) => y4.find(Ra(e)), Do = Ht({
  transformPagePoint: (e) => e,
  isStatic: !1,
  reducedMotion: "never"
});
class M4 extends lo.Component {
...
function x4({ children: e, isPresent: t, anchorX: n, root: r }) {
  ...
  }, [t]), s(M4, { isPresent: t, childRef: i, sizeRef: a, children: lo.cloneElement(e, { ref: i }) });
}
const b4 = ({ children: e, initial: t, isPresent: n, onExitComplete: r, custom: o, presenceAffectsLayout: i, mode: a, anchorX: c, root: l }) => {
  const u = po(N4), d = uo();
  let h = !0, p = X(() => (h = !1, {
    id: d,
    initial: t,
  ...
  return i && h && (p = { ...p }), X(() => {
    ...
    !n && !u.size && r && r();
  }, [n]), a === "popLayout" && (e = s(x4, { isPresent: n, anchorX: c, root: l, children: e })), s(Xn.Provider, { value: p, children: e });
};
function N4() {
...
const S4 = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: o = !0, mode: i = "sync", propagate: a = !1, anchorX: c = "left", root: l }) => {
  const [u, d] = Ua(a), h = X(() => $s(e), [e]), p = a && !u ? [] : h.map(Cn), f = q(!0), k = q(h), v = po(() => /* @__PURE__ */ new Map()), [M, g] = R(h), [w, C] = R(h);
  ta(() => {
  ...
  return s(ue, { children: w.map((L) => {
    const y = Cn(L), b = a && !u ? !1 : h === w || p.includes(y), j = () => {
      if (v.has(y))
        v.set(y, !0);
      else
        return;
    ...
    return s(b4, { isPresent: b, initial: !f.current || n ? void 0 : !1, custom: t, presenceAffectsLayout: o, mode: i, root: l, onExitComplete: b ? void 0 : j, anchorX: c, children: L }, y);
  }) });
}, za = Ht({ strict: !1 }), As = {
  animation: [
    "animate",
...
function Fn(e) {
  return e.startsWith("while") || e.startsWith("drag") && e !== "draggable" || e.startsWith("layout") || e.startsWith("onTap") || e.startsWith("onPan") || e.startsWith("onLayout") || j4.has(e);
}
let Xa = (e) => !Fn(e);
function T4(e) {
...
function qn(e) {
  return Kn(e.animate) || Bo.some((t) => en(e[t]));
}
function Ga(e) {
...
function P4(e) {
  const { initial: t, animate: n } = I4(e, ye(Gn));
  return X(() => ({ initial: t, animate: n }), [Is(t), Is(n)]);
}
function Is(e) {
  return Array.isArray(e) ? e.join(" ") : e;
}
const H4 = Symbol.for("motionComponentSymbol");
function Ct(e) {
...
const Oo = (e) => e.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), D4 = "framerAppearId", Ka = "data-" + Oo(D4), qa = Ht({});
function E4(e, t, n, r, o) {
  var v, M;
  const { visualElement: i } = ye(Gn), a = ye(za), c = ye(Xn), l = ye(Do).reducedMotion, u = q(null);
  ...
  d && !d.projection && o && (d.type === "html" || d.type === "svg") && B4(u.current, n, o, h);
  const p = q(!1);
  Ji(() => {
    d && p.current && d.update(n, c);
  });
  const f = n[Ka], k = q(!!f && !((v = window.MotionHandoffIsComplete) != null && v.call(window, f)) && ((M = window.MotionHasOptimisedAnimation) == null ? void 0 : M.call(window, f)));
  return ta(() => {
    d && (p.current = !0, window.MotionIsMounted = !0, d.updateFeatures(), Ho.render(d.render), k.current && d.animationState && d.animationState.animateChanges());
  }), Y(() => {
...
function O4({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: o }) {
  ...
  function i(c, l) {
    ...
    const d = {
      ...
      ...c,
      layoutId: F4(c)
    }, { isStatic: h } = d, p = P4(c), f = r(c, h);
    if (!h && fo) {
      Z4(d, e);
      const k = Y4(d);
      u = k.MeasureLayout, p.visualElement = E4(o, f, d, t, k.ProjectionNode);
    }
    return m(Gn.Provider, { value: p, children: [u && p.visualElement ? s(u, { visualElement: p.visualElement, ...d }) : null, n(o, c, R4(f, p.visualElement, l), f, h, p.visualElement)] });
  }
...
function K4(e, t) {
  const n = e.style || {}, r = {};
  return Wa(r, n, e), Object.assign(r, G4(e, t)), r;
}
function q4(e, t) {
  const n = {}, r = K4(e, t);
...
function ec(e, {
  ...
  h.transform && (p.transform = h.transform, delete h.transform), (p.transform || h.transformOrigin) && (p.transformOrigin = h.transformOrigin ?? "50% 50%", delete h.transformOrigin), p.transform && (p.transformBox = (d == null ? void 0 : d.transformBox) ?? "fill-box", delete h.transformBox), t !== void 0 && (h.x = t), n !== void 0 && (h.y = n), r !== void 0 && (h.scale = r), o !== void 0 && W4(h, o, i, a, !1);
}
const tc = () => ({
  ...Zo(),
  attrs: {}
...
function np(e = !1) {
  return (n, r, o, { latestValues: i }, a) => {
    const l = (Yo(n) ? ep : q4)(r, i, a, n), u = $4(r, typeof n == "string", e), d = n !== sn ? { ...u, ...l, ref: o } : {}, { children: h } = r, p = X(() => Me(h) ? h.get() : h, [h]);
    return Wi(n, {
      ...d,
      children: p
    });
...
function rp({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, o) {
  return {
    latestValues: op(n, r, o, e),
    renderState: t()
  };
}
const rc = (e) => (t, n) => {
  const r = ye(Gn), o = ye(Xn), i = () => rp(e, t, r, o);
  return n ? i() : po(i);
};
function op(e, t, n, r) {
  const o = {}, i = r(e, {});
...
function pp(e, { repeat: t, repeatType: n = "loop" }, r) {
  const o = e.filter(hp), i = t && n !== "loop" && t % 2 === 1 ? 0 : o.length - 1;
  return o[i];
}
const fp = {
  type: "spring",
  ...
  duration: 0.3
}, kp = (e, { keyframes: t }) => t.length > 2 ? gp : Bt.has(e) ? e.startsWith("scale") ? mp(t[1]) : fp : vp;
function Lp({ when: e, delay: t, delayChildren: n, staggerChildren: r, staggerDirection: o, repeat: i, repeatType: a, repeatDelay: c, from: l, elapsed: u, ...d }) {
...
const zo = (e, t, n, r = {}, o, i) => (a) => {
  ...
  Lp(c) || Object.assign(d, kp(e, d)), d.duration && (d.duration = /* @__PURE__ */ He(d.duration)), d.repeatDelay && (d.repeatDelay = /* @__PURE__ */ He(d.repeatDelay)), d.from !== void 0 && (d.keyframes[0] = d.from);
  let h = !1;
  ...
  return c.isSync ? new To(d) : new J2(d);
};
...
function ic(e, t, { delay: n = 0, transitionOverride: r, type: o } = {}) {
  ...
  for (const d in c) {
    ...
    zr(e, d), h.start(zo(d, h, p, e.shouldReduceMotion && Ha.has(d) ? { type: !1 } : f, e, v));
    const M = h.animation;
    M && l.push(M);
  }
...
const bp = [...Eo].reverse(), Np = Eo.length;
function Sp(e) {
...
function Vp(e) {
  ...
  function a(l) {
    ...
    let f = {}, k = 1 / 0;
    for (let M = 0; M < Np; M++) {
      const g = bp[M], w = n[g], C = u[g] !== void 0 ? u[g] : d[g], x = en(C), N = g === l ? w.isActive : null;
      N === !1 && (k = M);
      let L = C === d[g] && C !== u[g] && x;
      ...
      Kn(C) || typeof C == "boolean")
        continue;
      const y = jp(w.prevProp, C);
      ...
      for (const E in A) {
        ...
        if (f.hasOwnProperty(E))
          continue;
        let D = !1;
        Ur(z) && Ur($) ? D = !ac(z, $) : D = z !== $, D ? z != null ? T(E) : p.add(E) : z !== void 0 && p.has(E) ? T(E) : w.protectedKeys[E] = !0;
      }
      w.prevProp = C, w.prevResolvedValues = I, w.isActive && (f = { ...f, ...I }), r && e.blockInitialAnimation && (b = !1), b && (!(L && y) || j) && h.push(...V.map((E) => ({
        animation: E,
        options: { type: g }
      })));
    }
...
const dc = 1e-4, Dp = 1 - dc, Ep = 1 + dc, uc = 0.01, Bp = 0 - uc, Op = 0 + uc;
function xe(e) {
  return e.max - e.min;
}
function Fp(e, t, n) {
...
function Rs(e, t, n, r = 0.5) {
  e.origin = r, e.originPoint = le(t.min, t.max, e.origin), e.scale = xe(n) / xe(t), e.translate = le(n.min, n.max, e.origin) - e.originPoint, (e.scale >= Dp && e.scale <= Ep || isNaN(e.scale)) && (e.scale = 1), (e.translate >= Bp && e.translate <= Op || isNaN(e.translate)) && (e.translate = 0);
}
function Gt(e, t, n, r) {
...
function ot(e) {
  return Gr(e) || hc(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function hc(e) {
...
function fc(e, t) {
  return lc(Rp(e.getBoundingClientRect(), t));
}
function _p(e, t, n) {
  ...
  constructor(t, n, { transformPagePoint: r, contextWindow: o = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3 } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
      if (!(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const p = Mr(this.lastMoveEventInfo, this.history), f = this.startEvent !== null, k = Up(p.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
      if (!f && !k)
        return;
...
class tf {
  ...
  start(t, { snapToCursor: n = !1, distanceThreshold: r } = {}) {
    ...
    const i = (h) => {
      ...
      if (f && !k && (this.openDragLock && this.openDragLock(), this.openDragLock = f4(f), !this.openDragLock))
        return;
      ...
      }), v && ae.postRender(() => v(h, p)), zr(this.visualElement, "transform");
      ...
      if (k && this.currentDirection === null) {
        this.currentDirection = nf(g), this.currentDirection !== null && v && v(this.currentDirection);
        return;
      }
  ...
  updateAxis(t, n, r) {
    ...
    this.constraints && this.constraints[t] && (a = Gp(a, this.constraints[t], this.elastic[t])), i.set(a);
  }
  resolveConstraints() {
    var i;
    ...
    t && Ct(t) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : t && r ? this.constraints = Kp(r.layoutBox, t) : this.constraints = !1, this.elastic = Wp(n), o !== this.constraints && r && this.constraints && !this.hasMutatedConstraints && je((a) => {
  ...
  resolveRefConstraints() {
    ...
    if (!o || !o.layout)
      return !1;
    const i = _p(r, o.root, this.visualElement.getTransformPagePoint());
    let a = qp(o.layout.layoutBox, i);
    if (n) {
      const c = n(Hp(a));
  ...
  scalePositionWithinConstraints() {
    ...
    je((a) => {
      ...
      if (c && this.constraints !== !1) {
        const l = c.get();
        o[a] = Jp({ min: l, max: l }, this.constraints[a]);
      }
    });
...
class rf extends tt {
  constructor(t) {
    super(t), this.removeGroupControls = Te, this.removeListeners = Te, this.controls = new tf(t);
  }
  mount() {
...
class af extends Sl {
  ...
  componentDidMount() {
    ...
    _4(cf), i && (n.group && n.group.add(i), r && r.register && o && r.register(i), ei && i.root.didUpdate(), i.addEventListener("animationComplete", () => {
      this.safeToRemove();
    }), i.setOptions({
      ...i.options,
...
function kc(e) {
  ...
  return s(af, { ...e, layoutGroup: r, switchLayoutGroup: ye(qa), isPresent: t, safeToRemove: n });
}
const cf = {
  borderRadius: {
    ...Yt,
...
class uf {
  ...
  forEach(t) {
    this.isDirty && this.children.sort(df), this.isDirty = !1, this.children.forEach(t);
  }
}
function hf(e, t) {
...
const Lc = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"], pf = Lc.length, ti = (e) => typeof e == "string" ? parseFloat(e) : e, ni = (e) => typeof e == "number" || J.test(e);
function ff(e, t, n, r, o, i) {
  o ? (e.opacity = le(0, n.opacity ?? 1, mf(r)), e.opacityExit = le(t.opacity ?? 1, 0, gf(r))) : i && (e.opacity = le(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let a = 0; a < pf; a++) {
...
const mf = /* @__PURE__ */ wc(0, 0.5, ha), gf = /* @__PURE__ */ wc(0.5, 0.95, Te);
function wc(e, t, n) {
...
function vf(e, t = 0, n = 1, r = 0.5, o, i = e, a = e) {
...
function ai(e, t, [n, r, o], i, a) {
  vf(e, t[n], t[r], t[o], t.scale, i, a);
}
const kf = ["x", "scaleX", "originX"], Lf = ["y", "scaleY", "originY"];
function ci(e, t, n, r) {
  ai(e.x, t, kf, n ? n.x : void 0, r ? r.x : void 0), ai(e.y, t, Lf, n ? n.y : void 0, r ? r.y : void 0);
}
function li(e) {
...
function xc({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: o }) {
  return class {
    constructor(a = {}, c = t == null ? void 0 : t()) {
      this.id = xf++, this.animationId = 0, this.animationCommitId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = { x: 1, y: 1 }, this.eventHandlers = /* @__PURE__ */ new Map(), this.hasTreeAnimated = !1, this.updateScheduled = !1, this.scheduleUpdate = () => this.update(), this.projectionUpdateScheduled = !1, this.checkUpdateFailed = () => {
        this.isUpdating && (this.isUpdating = !1, this.clearAllSnapshots());
      }, this.updateProjection = () => {
        this.projectionUpdateScheduled = !1, this.nodes.forEach(Sf), this.nodes.forEach($f), this.nodes.forEach(Af), this.nodes.forEach(Vf);
    ...
    mount(a) {
      if (this.instance)
        return;
      this.isSVG = _a(a) && !w4(a), this.instance = a;
      ...
      if (u && !u.current && u.mount(a), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (l || c) && (this.isLayoutDirty = !0), e) {
        ...
        ae.read(() => {
          ...
          f !== h && (h = f, this.root.updateBlockedByResize = !0, d && d(), d = hf(p, 250), $n.hasAnimatedSinceResize && ($n.hasAnimatedSinceResize = !1, this.nodes.forEach(gi)));
        });
      }
      c && this.root.registerSharedNode(c, this), this.options.animate !== !1 && u && (c || l) && this.addEventListener("didUpdate", ({ delta: d, hasLayoutChanged: h, hasRelativeLayoutChanged: p, layout: f }) => {
        ...
        const k = this.options.transition || u.getDefaultTransition() || Df, { onLayoutAnimationStart: v, onLayoutAnimationComplete: M } = u.getProps(), g = !this.targetLayout || !Cc(this.targetLayout, f), w = !h && p;
    ...
    update() {
      ...
      this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(Tf), this.nodes.forEach(bf), this.nodes.forEach(Nf)) : this.nodes.forEach(mi), this.clearAllSnapshots();
      const c = Ne.now();
    ...
    clearAllSnapshots() {
      this.nodes.forEach(jf), this.sharedNodes.forEach(Pf);
    }
    ...
    measurePageBox() {
      ...
      if (!(((u = this.scroll) == null ? void 0 : u.wasRoot) || this.path.some(Bf))) {
    ...
    resolveTargetDelta(a = !1) {
      ...
      if (!(!this.layout || !(d || h))) {
        if (this.resolvedRelativeTargetAt = Le.timestamp, !this.targetDelta && !this.relativeTarget) {
          ...
          f && f.layout && this.animationProgress !== 1 ? (this.relativeParent = f, this.forceRelativeParentToResolveTarget(), this.relativeTarget = he(), this.relativeTargetOrigin = he(), Kt(this.relativeTargetOrigin, this.layout.layoutBox, f.layout.layoutBox), Ve(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
        }
        if (!(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = he(), this.targetWithTransforms = he()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Zp(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : Ve(this.target, this.layout.layoutBox), pc(this.target, this.targetDelta)) : Ve(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
          this.attemptToResolveRelativeTarget = !1;
          const f = this.getClosestProjectingParent();
          f && !!f.resumingFrom == !!this.resumingFrom && !f.options.layoutScroll && f.target && this.animationProgress !== 1 ? (this.relativeParent = f, this.forceRelativeParentToResolveTarget(), this.relativeTarget = he(), this.relativeTargetOrigin = he(), Kt(this.relativeTargetOrigin, this.target, f.target), Ve(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
        }
      }
    }
    getClosestProjectingParent() {
      if (!(!this.parent || Gr(this.parent.latestValues) || hc(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      Yp(this.layoutCorrected, this.treeScale, this.path, c), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox, a.targetWithTransforms = he());
      const { target: f } = a;
      if (!f) {
        this.prevProjectionDelta && (this.createProjectionDeltas(), this.scheduleRender());
        return;
      }
      !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (si(this.prevProjectionDelta.x, this.projectionDelta.x), si(this.prevProjectionDelta.y, this.projectionDelta.y)), Gt(this.projectionDelta, this.layoutCorrected, f, this.latestValues), (this.treeScale.x !== h || this.treeScale.y !== p || !pi(this.projectionDelta.x, this.prevProjectionDelta.x) || !pi(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", f));
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    setAnimationOrigin(a, c = !1) {
      ...
      const p = he(), f = l ? l.source : void 0, k = this.layout ? this.layout.source : void 0, v = f !== k, M = this.getStack(), g = !M || M.members.length <= 1, w = !!(v && !g && this.options.crossfade === !0 && !this.path.some(Rf));
      this.animationProgress = 0;
      let C;
      this.mixTargetDelta = (x) => {
        const N = x / 1e3;
        vi(h.x, a.x, N), vi(h.y, a.y, N), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Kt(p, this.layout.layoutBox, this.relativeParent.layout.layoutBox), Hf(this.relativeTarget, this.relativeTargetOrigin, p, N), C && wf(this.relativeTarget, C) && (this.isProjectionDirty = !1), C || (C = he()), Ve(C, this.relativeTarget)), v && (this.animationValues = d, ff(d, u, this.latestValues, N, w, g)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = N;
    ...
    startAnimation(a) {
      ...
      this.notifyListeners("animationStart"), (c = this.currentAnimation) == null || c.stop(), (u = (l = this.resumingFrom) == null ? void 0 : l.currentAnimation) == null || u.stop(), this.pendingAnimation && (We(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = ae.update(() => {
        $n.hasAnimatedSinceResize = !0, this.motionValue || (this.motionValue = Nt(0)), this.currentAnimation = lf(this.motionValue, [0, 1e3], {
          ...a,
          velocity: 0,
          isSync: !0,
          onUpdate: (d) => {
    ...
    applyTransformsToTarget() {
      ...
      if (!(!c || !l || !u)) {
        ...
        Ve(c, l), bt(c, d), Gt(this.projectionDeltaWithTransform, this.layoutCorrected, c, d);
      }
    }
    registerSharedNode(a, c) {
      this.sharedNodes.has(a) || this.sharedNodes.set(a, new yf()), this.sharedNodes.get(a).add(c);
    ...
    applyProjectionStyles(a, c) {
      ...
      let h = Cf(this.projectionDeltaWithTransform, this.treeScale, d);
      ...
      for (const k in tn) {
        if (d[k] === void 0)
          continue;
        const { correct: v, applyTo: M, isCSSVariable: g } = tn[k], w = h === "none" ? d[k] : v(d[k], u);
        if (M) {
          const C = M.length;
          for (let x = 0; x < C; x++)
            a[M[x]] = w;
...
function Nf(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners("didUpdate")) {
    ...
    Gt(c, r, t.layoutBox);
    const l = Mt();
    a ? Gt(l, e.applyTransform(o, !0), t.measuredBox) : Gt(l, r, t.layoutBox);
    const u = !yc(c);
    let d = !1;
    if (!e.resumeFrom) {
      ...
      if (h && !h.resumeFrom) {
        ...
        if (p && f) {
          const k = he();
          Kt(k, t.layoutBox, p.layoutBox);
          const v = he();
          Kt(v, r, f.layoutBox), Cc(k, v) || (d = !0), h.options.layoutRoot && (e.relativeTarget = v, e.relativeTargetOrigin = k, e.relativeParent = h);
        }
      }
    }
...
function bc(e, t, n) {
  return e === "position" || e === "preserve-aspect" && !Fp(hi(t), hi(n), 0.2);
}
function Bf(e) {
  var t;
...
class Zf extends tt {
  mount() {
    ...
    t && (this.unmount = m4(t, (n, r) => (Ci(this.node, r, "Start"), (o) => Ci(this.node, o, "End"))));
  }
  unmount() {
  }
}
...
class _f extends tt {
  mount() {
    const { current: t } = this.node;
    t && (this.unmount = L4(t, (n, r) => (Mi(this.node, r, "Start"), (o, { success: i }) => Mi(this.node, o, i ? "End" : "Cancel")), { useGlobalTarget: this.node.props.globalTapTarget }));
  }
  unmount() {
  }
}
const Jr = /* @__PURE__ */ new WeakMap(), Sr = /* @__PURE__ */ new WeakMap(), Uf = (e) => {
  const t = Jr.get(e.target);
  t && t(e);
}, zf = (e) => {
  e.forEach(Uf);
};
function Xf({ root: e, ...t }) {
  const n = e || document;
  Sr.has(n) || Sr.set(n, {});
  const r = Sr.get(n), o = JSON.stringify(t);
  return r[o] || (r[o] = new IntersectionObserver(zf, { root: e, ...t })), r[o];
}
function Gf(e, t, n) {
  const r = Xf(t);
...
class qf extends tt {
  ...
  startObserver() {
    ...
    return Gf(this.node.current, a, c);
  }
  mount() {
    this.startObserver();
  }
  update() {
    ...
    ["amount", "margin", "root"].some(Jf(t, n)) && this.startObserver();
  }
  unmount() {
  }
}
function Jf({ viewport: e = {} }, { viewport: t = {} } = {}) {
  return (n) => e[n] !== t[n];
}
const Qf = {
  inView: {
...
class r0 {
  ...
  constructor({ parent: t, props: n, presenceContext: r, reducedMotionConfig: o, blockInitialAnimation: i, visualState: a }, c = {}) {
    ...
    this.latestValues = l, this.baseTarget = { ...l }, this.initialValues = n.initial ? { ...l } : {}, this.renderState = u, this.parent = t, this.props = n, this.presenceContext = r, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = o, this.options = c, this.blockInitialAnimation = !!i, this.isControllingVariants = qn(n), this.isVariantNode = Ga(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(t && t.current);
  ...
  mount(t) {
    this.current = t, t0.set(t, this), this.projection && !this.projection.instance && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, r) => this.bindToMotionValue(r, n)), Sc.current || e0(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Qr.current, process.env.NODE_ENV !== "production" && Lo(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected."), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext);
  }
  unmount() {
  ...
  update(t, n) {
    ...
    this.prevMotionValues = n0(this, this.scrapeMotionValuesFromProps(t, this.prevProps, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue();
  }
  getProps() {
    return this.props;
  }
  ...
  readValue(t, n) {
    ...
    return r != null && (typeof r == "string" && (na(r) || oa(r)) ? r = parseFloat(r) : !C4(r) && et.test(n) && (r = Ba(t, n)), this.setBaseTarget(t, Me(r) ? r.get() : r)), Me(r) ? r.get() : r;
  }
  /**
...
class Vc extends r0 {
  constructor() {
    super(...arguments), this.KeyframeResolver = d4;
  }
...
class s0 extends Vc {
  ...
  readValueFromInstance(t, n) {
    var r;
    if (Bt.has(n))
      return (r = this.projection) != null && r.isProjecting ? Br(n) : V2(t, n);
    {
      const o = o0(t), i = (Co(n) ? o.getPropertyValue(n) : o[n]) || 0;
...
const c0 = (e, t) => Yo(e) ? new a0(t) : new s0(t, {
  ...
  const y = 8, b = O(() => {
    ...
    let B = H(D);
    z = B.top, $ = B.left, D = B.placement, (() => {
      if ($ < y && ($ = y), $ + g.width > F - y && ($ = F - g.width - y), z < y) {
        if (D === "top") {
          const K = H("bottom");
          K.top + g.height <= E - y ? (z = K.top, $ = K.left, D = "bottom") : z = y;
        }
      } else if (z + g.height > E - y && D === "bottom") {
        const K = H("top");
        K.top >= y ? (z = K.top, $ = K.left, D = "top") : z = E - g.height - y;
      }
      if (($ < y || $ + g.width > F - y) && (D === "top" || D === "bottom")) {
        const K = H("left");
        if (K.left >= y)
          z = K.top, $ = K.left, D = "left";
        else {
          const _ = H("right");
          _.left + g.width <= F - y && (z = _.top, $ = _.left, D = "right");
        }
      }
    })(), M({ top: z, left: $ }), x(D);
  }, [r, i, g]);
  Y(() => {
    ...
    if (L.current && f && i) {
      const P = new ResizeObserver((F) => {
        for (const E of F) {
          const { width: z, height: $ } = E.target.getBoundingClientRect();
          w({ width: z, height: $ });
        }
      });
  ...
  const S = () => {
    ...
    if (!N.current || !i || g.width === 0 || g.height === 0) return {};
    const P = N.current.getBoundingClientRect(), F = 12, E = P.left + P.width / 2, z = P.top + P.height / 2, $ = v.left, D = v.top, H = E - $, B = z - D, U = (K, _, Q) => _ >= 0 && _ <= Q ? Math.max(F, Math.min(Q - F, _)) : _ < 0 ? F : Q - F;
    switch (C) {
      case "top":
        return {
...
const $c = ({
  ...
  const u = q(null), [d, h] = R(""), [p, f] = R(0), k = O(() => l(), [l]), v = O((b) => b === window ? window.pageYOffset || document.documentElement.scrollTop : b.scrollTop, []), M = O((b, j) => {
    ...
    if (V)
      if (n === 0)
        ...
        const S = I === window ? { top: 0 } : I.getBoundingClientRect(), T = V.getBoundingClientRect().top - S.top, F = v(I) + T - n;
        M(I, F);
      }
    t == null || t(b);
  }, [n, t, k, v, M]);
...
function u0(e, t, n, r, o = 2, i = 2, a = "#999", c = "#FF0000", l, u) {
...
function p0({
  ...
  const h = q(null), p = q(null), f = q(), [k, v] = R([]), [M, g] = R(!1), [w, C] = R(null), [x, N] = R(t), L = O(async () => {
    if (e) {
      g(!0), C(null);
      try {
        const S = new (window.AudioContext || window.webkitAudioContext)(), T = await (await fetch(e)).arrayBuffer(), P = await S.decodeAudioData(T), F = h0(P, r);
        v(F || []), S.close();
      } catch (S) {
  ...
  }, [k, r, o, i, a, c, l, u, d, e]), b = O((S, A, T, P, F) => {
    try {
      ...
      const z = A.width, $ = A.height;
      if (z === 0 || $ === 0) {
        console.warn("Canvas has no size for line waveform");
        return;
      }
      const D = T.currentTime || 0, H = T.duration || 1, B = Math.floor(D / H * S.length);
      if (E.clearRect(0, 0, z, $), S.length === 0) {
        console.warn("No data for line waveform");
        return;
      }
      const U = Math.max(...S), K = U > 0 ? $ * 0.6 / U : 1, _ = z / (S.length - 1);
      if (E.beginPath(), E.strokeStyle = P, E.lineWidth = 1, E.setLineDash([2, 2]), E.moveTo(0, $ / 2), E.lineTo(z, $ / 2), E.stroke(), E.setLineDash([]), E.beginPath(), E.strokeStyle = P, E.lineWidth = 2, S.forEach((Q, oe) => {
        const te = oe * _, ie = $ / 2 - Q * K;
        oe === 0 ? E.moveTo(te, ie) : E.lineTo(te, ie);
      }), E.stroke(), B > 0) {
        E.beginPath(), E.strokeStyle = F, E.lineWidth = 3;
        for (let Q = 0; Q < Math.min(B, S.length); Q++) {
          const oe = Q * _, te = $ / 2 - S[Q] * K;
  ...
  return Y(() => {
    ...
    return S.addEventListener("play", A), S.addEventListener("pause", T), S.addEventListener("ended", P), () => {
      S.removeEventListener("play", A), S.removeEventListener("pause", T), S.removeEventListener("ended", P), I();
    };
  }, [V, I, n]), Y(() => () => {
    I();
  }, [I]), {
...
const Rc = (e, t) => {
  ...
  const [x, N] = R({
    ...
    if (!M.current) return;
    const F = M.current.getBoundingClientRect(), E = window.innerWidth, z = window.innerHeight, $ = window.pageXOffset || document.documentElement.scrollLeft, D = window.pageYOffset || document.documentElement.scrollTop, H = 200, B = 150, U = 0;
    ...
    if (i === "bottom" && te < B && ie > B ? Q = "top" : i === "top" && ie < B && te > B && (Q = "bottom"), t) {
      ...
      Q === "bottom" ? K = F.bottom + U + D : K = F.top - be - U + D;
      ...
      _ < $ ? (_ = $ + U, oe = "left") : _ + ge > $ + E && (_ = $ + E - ge - U, oe = "right"), K < D ? K = D + U : K + be > D + z && (K = D + z - be - U);
    } else
      oe = a;
  ...
  const L = X(() => e ? e.filter((T) => x.includes(T.key)).map((T) => T.label) : [], [e, x]), y = X(() => e ? e.filter((T) => x.includes(T.key)) : [], [e, x]), b = O(() => {
    var T;
    return e ? o ? L.length === 0 ? t : a !== void 0 && L.length > a ? `${L.slice(0, a).join(i)}等${L.length}个选项` : L.join(i) : w === void 0 || w === "" ? t : (T = e == null ? void 0 : e.filter((P) => P.key === w)[0]) == null ? void 0 : T.label : t;
  }, [
    o,
    L,
    a,
    ...
    {
      const T = e == null ? void 0 : e.filter((E) => E.key === w)[0], P = T ? [T] : [], F = T ? [T.key] : [];
      return l({
        values: F,
        items: P,
        isMultiple: !1,
    ...
    () => /* @__PURE__ */ s("div", { className: "land-select-list", children: e && e.length > 0 ? e == null ? void 0 : e.map((T) => /* @__PURE__ */ m(
      "div",
      {
        className: `land-select-drop-item ${T.tip ? "hover-pop" : ""} ${I(T.key) ? "selected" : ""} ${T.disabled ? "disabled" : ""}`,
        onClick: (P) => {
  ...
  return /* @__PURE__ */ s("div", { className: `land-select ${v}`, style: M, children: /* @__PURE__ */ s(un, { trigger: "click", disabled: p, dropContent: S, ...g, children: /* @__PURE__ */ m(
    "div",
    {
...
const Oc = ({
  language: e = "zh",
  className: t = ""
}) => /* @__PURE__ */ s("div", { className: `land-calendar-weekdays ${t}`, children: y0.map((n, r) => /* @__PURE__ */ s("div", { className: "land-calendar-item weekday", children: e === "zh" ? n.zh : n.en }, r)) }), M0 = ({
  day: e,
  onDayClick: t,
  onDayMouseOver: n,
  onDayMouseOut: r,
  ...
  const [l, u] = R(/* @__PURE__ */ new Date()), [d, h] = R(() => {
    const L = /* @__PURE__ */ new Date(), y = vt(L.getFullYear(), L.getMonth());
    let b = 0;
    ...
    u(L);
    const y = vt(L.getFullYear(), L.getMonth());
    let b = 0;
    for (let V = 0; V < y.length; V++)
      if (y[V].isCurrentWeek) {
        b = V;
  ...
  const [h, p] = R(d()), [f, k] = R(u), { yearRange: v, shouldShowYearSelector: M } = X(() => {
    ...
    const S = [], [A, T] = v, P = Math.floor(A / 10) * 10, F = Math.floor(T / 10) * 10;
    ...
    return S;
  }, [v]), b = (S) => S === u, j = (S) => S === f, V = (S) => v0(S, t, n), I = L.includes(u);
...
] }), vm = ({ children: e, style: t, className: n }) => {
  ...
  { key: "hsv", label: "HSV" },
  { key: "hsl", label: "HSL" }
], T0 = "hex", ji = { h: 0, s: 100, v: 100 }, Ti = "var(--color-gray-3)", ne = {
  // RGB转HSV
  rgbToHsv: (e, t, n) => {
  ...
  const [i, a] = R(T0), [c, l] = R(ji.h), [u, d] = R(1), [h, p] = R(""), [f, k] = R({ r: 0, g: 0, b: 0 }), [v, M] = R(ji), [g, w] = R({ h: 0, s: 0, l: 0 }), [C, x] = R({ x: 0, y: 0 }), N = q(!1), L = q(""), y = X(() => {
    switch (i) {
      case "hex":
        return h || "#000000";
      case "rgb":
    ...
    switch (i) {
      ...
      case "hsl":
        ...
        return ne.rgbToHex(D.r, D.g, D.b);
      default:
        return "#000000";
    }
  }, [i, h, f, v, g]), j = X(() => {
    const $ = ne.hexToRgb(b);
    return $ ? `rgba(${$.r}, ${$.g}, ${$.b}, ${u})` : `rgba(0, 0, 0, ${u})`;
  }, [b, u]), V = X(
    () => ({
      background: j,
      ...n
  ...
  Y(() => {
    if (e && e !== Ti && !N.current) {
      const $ = ne.hexToRgb(e);
      if ($) {
        const D = ne.rgbToHsv($.r, $.g, $.b), H = ne.rgbToHsl($.r, $.g, $.b);
        p(e), k($), M(D), w(H), l(D.h), N.current = !0;
      }
    } else N.current || (l(0), M({ h: 0, s: 0, v: 50 }), w({ h: 0, s: 0, l: 50 }), k({ r: 128, g: 128, b: 128 }), p("#808080"), N.current = !0);
  }, [e]);
  const I = O(() => {
    const $ = `${y}-${b}-${j}`;
    $ !== L.current && (L.current = $, t == null || t(y, b, j));
  }, [t, y, b, j]);
  Y(() => {
    N.current && I();
  }, [y, b, j, I]);
  const S = O(
    ...
    const D = { ...v, h: $ };
    M(D);
    const H = ne.hsvToRgb($, D.s, D.v), B = ne.rgbToHsl(H.r, H.g, H.b), U = ne.rgbToHex(H.r, H.g, H.b);
    k(H), w(B), p(U);
  }, T = ($) => {
    d($);
  }, P = ($) => {
    let D = $.replace("#", "").toUpperCase();
    D.length > 6 && (D = D.slice(0, 6)), D = D.replace(/[^0-9A-F]/g, "");
    const H = D.length > 0 ? `#${D}` : "#";
    if (p(H), D.length === 6) {
    ...
    const H = Math.max(0, Math.min(255, Math.round(D))), B = { ...f, [$]: H };
    k(B);
    const U = ne.rgbToHsv(B.r, B.g, B.b), K = ne.rgbToHsl(B.r, B.g, B.b), _ = ne.rgbToHex(B.r, B.g, B.b);
    M(U), w(K), p(_), l(U.h);
  }, E = ($, D) => {
    let H = D;
    $ === "h" ? H = (D % 360 + 360) % 360 : H = Math.max(0, Math.min(100, Math.round(D)));
    const B = { ...v, [$]: H };
    M(B);
        ...
        un,
        {
          ...
          dropContent: /* @__PURE__ */ m(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ s($0, { hue: c, onPanelChange: S }),
  ...
  const L = O((D, H) => {
    if (!D) return "";
    const B = D.getFullYear(), U = D.getMonth() + 1, K = D.getDate();
    switch (H) {
      case "year":
        return `${B}年`;
      case "month":
      ...
      case "quarter":
        ...
        return `${B}年第${_}季度`;
      case "week":
        const Q = new Date(B, 0, 1), oe = Math.floor((D.getTime() - Q.getTime()) / (24 * 60 * 60 * 1e3)), te = Math.ceil((oe + Q.getDay() + 1) / 7);
        return `${B}年第${te}周`;
      case "date":
      default:
  ...
  const b = O((...D) => {
    ...
    if (!e && h && c === "date") {
      if (N(!1), w.trim()) {
        const D = y(w);
        D ? (v(D), g(L(D, c)), t == null || t(D)) : g(L(k, c));
      } else
        v(null), g(""), t == null || t(null);
      C("");
    }
  }, [h, c, w, y, k, L, t, e]), F = O((D) => {
    if (!e && h && c === "date" && D.trim()) {
      const H = y(D);
  ...
  const l = q(null), [u, d] = R(!1), [h, p] = R(0), f = t || n || "", k = O(() => {
    const g = l.current;
    if (g)
      if (e === 1) {
...
), Mm = ({ children: e, style: t, className: n }) => /* @__PURE__ */ s("div", { className: `land-footer ${n}`, style: t, children: e });
...
const Fc = ({
          ...
          children: [
            /* @__PURE__ */ m(
              "div",
              {
                ...
                onClick: (w) => {
                  M.titleDeputy || i || M.clickType === An.DISABLED || M.disabled || (w.stopPropagation(), a == null || a(M));
                },
                children: [
  ...
  const L = n || (d === "success" || w === "success" ? k : "1"), y = () => c && typeof c != "string" && d === "error" && (w === "error" || !l) ? c : d === "error" && (w === "error" || !l) && (!c || typeof c == "string") ? /* @__PURE__ */ s(Ac, { type: "error", title: "加载失败", direction: "column", className: "land-image-alert", noBg: !0 }) : null, b = d === "loading" || M && w === "loading", j = p && (d === "success" || w === "success" || b);
  return /* @__PURE__ */ m(
    "div",
    {
...
}, bm = ({ children: e, style: t, className: n }) => /* @__PURE__ */ s("div", { className: `land-layout ${n}`, style: t, children: e });
var Se = function() {
...
function W0(e) {
  return G0(Hn("", null, null, null, [""], e = X0(e), 0, [0], e));
}
    ...
    switch (k = w, w = De()) {
      case 40:
        if (k != 108 && ke(y, h - 1) == 58) {
          In(y += W(jr(w), "&", "&\f"), "&\f", _c(u ? c[u - 1] : 0)) != -1 && (g = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (w) {
          ...
          case 125:
            M = 0;
          case 59 + d:
            g == -1 && (y = W(y, /\f/g, "")), f > 0 && Oe(y) - h && Ut(f > 32 ? Pi(y + ";", r, n, h - 1, l) : Pi(W(y, " ", "") + ";", r, n, h - 2, l), l);
            break;
          case 59:
            y += ";";
          default:
            if (Ut(L = Ii(y, t, n, u, d, o, c, C, x = [], N = [], h, i), i), w === 123)
              if (d === 0)
                Hn(y, t, L, L, x, i, h, c, N);
              else
      ...
      default:
        ...
        switch (y += qo(w), w * v) {
          ...
          case 44:
            ...
            break;
          case 64:
            ut() === 45 && (y += jr(De())), p = ut(), d = h = Oe(C = y += Q0(Pn())), w++;
            break;
          case 45:
            k === 45 && Oe(y) == 2 && (v = 0);
        }
...
function Ii(e, t, n, r, o, i, a, c, l, u, d, h) {
  for (var p = o - 1, f = o === 0 ? i : [""], k = zc(f), v = 0, M = 0, g = 0; v < r; ++v)
    for (var w = 0, C = Tt(e, p + 1, p = _c(M = a[v])), x = e; w < k; ++w)
      (x = Uc(M > 0 ? f[w] + " " + C : W(C, /&\f/g, f[w]))) && (l[g++] = x);
  return er(e, t, n, o === 0 ? Qn : c, l, u, d, h);
}
function e3(e, t, n, r) {
  return er(e, t, n, Zc, qo(U0()), Tt(e, 2, -2), 0, r);
}
function Pi(e, t, n, r, o) {
  return er(e, t, n, Ko, Tt(e, 0, r), Tt(e, r + 1, -1), r, o);
}
function Gc(e, t, n) {
  switch (Y0(e, t)) {
    case 5103:
    ...
    case 4765:
      if (Oe(e) - 1 - t > 6)
        switch (ke(e, t + 1)) {
          ...
          case 115:
            return ~In(e, "stretch", 0) ? Gc(W(e, "stretch", "fill-available"), t, n) + e : e;
        }
      break;
    case 5152:
    case 5920:
...
function o3(e, t, n, r) {
  if (e.length > -1 && !e.return)
    switch (e.type) {
      ...
      case Qn:
        if (e.length)
          return _0(n = e.props, function(o) {
...
var s3 = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, pt = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", Kc = "active", qc = "data-styled-version", nr = "6.1.18", Jo = `/*!sc*/
`, Un = typeof window < "u" && typeof document < "u", i3 = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Hi = /invalid hook call/i, xn = /* @__PURE__ */ new Set(), a3 = function(e, t) {
...
var el = typeof Symbol == "function" && Symbol.for, tl = el ? Symbol.for("react.memo") : 60115, p3 = el ? Symbol.for("react.forward_ref") : 60112, f3 = { childContextTypes: !0, contextType: !0, contextTypes: !0, defaultProps: !0, displayName: !0, getDefaultProps: !0, getDerivedStateFromError: !0, getDerivedStateFromProps: !0, mixins: !0, propTypes: !0, type: !0 }, m3 = { name: !0, length: !0, prototype: !0, caller: !0, callee: !0, arguments: !0, arity: !0 }, nl = { $$typeof: !0, compare: !0, defaultProps: !0, displayName: !0, propTypes: !0, type: !0 }, g3 = ((Tr = {})[p3] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }, Tr[tl] = nl, Tr);
function Ei(e) {
  return ("type" in (t = e) && t.type.$$typeof) === tl ? nl : "$$typeof" in e ? g3[e.$$typeof] : f3;
  var t;
}
var v3 = Object.defineProperty, k3 = Object.getOwnPropertyNames, Bi = Object.getOwnPropertySymbols, L3 = Object.getOwnPropertyDescriptor, w3 = Object.getPrototypeOf, Oi = Object.prototype;
function rl(e, t, n) {
  if (typeof t != "string") {
    if (Oi) {
      var r = w3(t);
    ...
    for (var i = Ei(e), a = Ei(t), c = 0; c < o.length; ++c) {
      var l = o[c];
      if (!(l in m3 || n && n[l] || a && l in a || i && l in i)) {
        var u = L3(t, l);
        try {
          v3(e, l, u);
        } catch {
...
var y3 = process.env.NODE_ENV !== "production" ? { 1: `Cannot create styled-component for component: %s.
...
function Zt(e) {
  ...
  return process.env.NODE_ENV === "production" ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(C3.apply(void 0, jt([y3[e]], t, !1)).trim());
}
var M3 = function() {
  function e(t) {
...
}(), x3 = 1 << 30, Rn = /* @__PURE__ */ new Map(), zn = /* @__PURE__ */ new Map(), Dn = 1, Nn = function(e) {
  if (Rn.has(e)) return Rn.get(e);
  for (; zn.has(Dn); ) Dn++;
  var t = Dn++;
  if (process.env.NODE_ENV !== "production" && ((0 | t) < 0 || t > x3)) throw Zt(16, "".concat(t));
  return Rn.set(e, t), zn.set(t, e), t;
}, b3 = function(e, t) {
  Dn = t + 1, Rn.set(e, t), zn.set(t, e);
}, N3 = "style[".concat(pt, "][").concat(qc, '="').concat(nr, '"]'), S3 = new RegExp("^".concat(pt, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), V3 = function(e, t, n) {
  ...
  for (var n, r = ((n = t.textContent) !== null && n !== void 0 ? n : "").split(Jo), o = [], i = 0, a = r.length; i < a; i++) {
    ...
    if (c) {
      ...
      if (l) {
        ...
        u !== 0 && (b3(d, u), V3(e, d, l[3]), e.getTag().insertRules(u, o)), o.length = 0;
      } else o.push(c);
    }
  }
}, Zi = function(e) {
  for (var t = document.querySelectorAll(N3), n = 0, r = t.length; n < r; n++) {
    var o = t[n];
    o && o.getAttribute(pt) !== Kc && (j3(e, o), o.parentNode && o.parentNode.removeChild(o));
  }
};
function T3() {
...
var ol = function(e) {
  ...
  r.setAttribute(pt, Kc), r.setAttribute(qc, nr);
  var a = T3();
...
}(), Yi = Un, P3 = { isServer: !Un, useCSSOMInjection: !i3 }, sl = function() {
  function e(t, n, r) {
    t === void 0 && (t = At), n === void 0 && (n = {});
    var o = this;
    this.options = Se(Se({}, P3), t), this.gs = n, this.names = new Map(r), this.server = !!t.isServer, !this.server && Un && Yi && (Yi = !1, Zi(this)), Wo(this, function() {
      return function(i) {
        for (var a = i.getTag(), c = a.length, l = "", u = function(h) {
          ...
          var v = "".concat(pt, ".g").concat(h, '[id="').concat(p, '"]'), M = "";
          f !== void 0 && f.forEach(function(g) {
            g.length > 0 && (M += "".concat(g, ","));
          }), l += "".concat(k).concat(v, '{content:"').concat(M, '"}').concat(Jo);
        }, d = 0; d < c; d++) u(d);
        return l;
      }(o);
    });
  ...
  return e.registerId = function(t) {
    ...
    return this.tag || (this.tag = (t = function(n) {
      ...
      return n.isServer ? new I3(o) : r ? new $3(o) : new A3(o);
    }(this.options), new M3(t)));
    var t;
...
function D3(e) {
  var t, n, r, o = At, i = o.options, a = i === void 0 ? At : i, c = o.plugins, l = c === void 0 ? rr : c, u = function(p, f, k) {
    return k.startsWith(n) && k.endsWith(n) && k.replaceAll(n, "").length > 0 ? ".".concat(t) : p;
  }, d = l.slice();
  d.push(function(p) {
    p.type === Qn && p.value.includes("&") && (p.props[0] = p.props[0].replace(H3, n).replace(r, u));
  }), a.prefix && d.push(o3), d.push(t3);
  var h = function(p, f, k, v) {
    f === void 0 && (f = ""), k === void 0 && (k = ""), v === void 0 && (v = "&"), t = v, n = f, r = new RegExp("\\".concat(n, "\\b"), "g");
    var M = p.replace(R3, ""), g = W0(k || f ? "".concat(k, " ").concat(f, " { ").concat(M, " }") : M);
    a.namespace && (g = il(g, a.namespace));
    var w = [];
    return _n(g, n3(d.concat(r3(function(C) {
      return w.push(C);
    })))), w;
  };
...
var E3 = new sl(), so = D3(), al = $e.createContext({ shouldForwardProp: void 0, styleSheet: E3, stylis: so });
al.Consumer;
...
var cl = function(e) {
  ...
  for (var o in e) {
    var i = e[o];
    e.hasOwnProperty(o) && !cl(i) && (Array.isArray(i) && i.isCss || It(i) ? r.push("".concat(zi(o), ":"), i, ";") : Pt(i) ? r.push.apply(r, jt(jt(["".concat(o, " {")], ll(i), !1), ["}"], !1)) : r.push("".concat(zi(o), ": ").concat((t = o, (n = i) == null || typeof n == "boolean" || n === "" ? "" : typeof n != "number" || n === 0 || t in s3 || t.startsWith("--") ? String(n).trim() : "".concat(n, "px")), ";")));
  }
  return r;
};
function ht(e, t, n, r) {
...
var F3 = Qc(nr), Z3 = function() {
  function e(t, n, r) {
    this.rules = t, this.staticRulesId = "", this.isStatic = process.env.NODE_ENV === "production" && (r === void 0 || r.isStatic) && O3(t), this.componentId = n, this.baseHash = st(F3, n), this.baseStyle = r, sl.registerId(n);
  }
...
function Y3(e, t, n) {
  var r = Qo(e), o = e, i = !$r(e), a = t.attrs, c = a === void 0 ? rr : a, l = t.componentId, u = l === void 0 ? function(x, N) {
    ...
    Ar[L] = (Ar[L] || 0) + 1;
    var y = "".concat(L, "-").concat(h3(nr + L + Ar[L]));
  ...
  }(e) : d, p = t.displayName && t.componentId ? "".concat(Ri(t.displayName), "-").concat(t.componentId) : t.componentId || u, f = r && o.attrs ? o.attrs.concat(c).filter(Boolean) : c, k = t.shouldForwardProp;
  ...
  var g = new Z3(n, p, r ? o.componentStyle : void 0);
  function w(x, N) {
    return function(L, y, b) {
      var j = L.attrs, V = L.componentStyle, I = L.defaultProps, S = L.foldedComponentIds, A = L.styledComponentId, T = L.target, P = $e.useContext(dl), F = _i(), E = L.shouldForwardProp || F.shouldForwardProp;
      process.env.NODE_ENV !== "production" && cs(A);
      var z = c3(y, P, I) || At, $ = function(_, Q, oe) {
      ...
      for (var B in $) $[B] === void 0 || B[0] === "$" || B === "as" || B === "theme" && $.theme === z || (B === "forwardedAs" ? H.as = $.forwardedAs : E && !E(B, D) || (H[B] = $[B], E || process.env.NODE_ENV !== "development" || O0(B) || Xi.has(B) || !no.has(D) || (Xi.add(B), console.warn('styled-components: it looks like an unknown prop "'.concat(B, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var U = function(_, Q) {
      ...
      var K = ct(S, A);
      return U && (K += " " + U), $.className && (K += " " + $.className), H[$r(D) && !no.has(D) ? "class" : "className"] = K, b && (H.ref = b), Wi(D, H);
    }(C, x, N);
  }
  w.displayName = h;
  var C = $e.forwardRef(w);
  return C.attrs = f, C.componentStyle = g, C.displayName = h, C.shouldForwardProp = k, C.foldedComponentIds = r ? ct(o.foldedComponentIds, o.styledComponentId) : "", C.styledComponentId = p, C.target = r ? o.target : e, Object.defineProperty(C, "defaultProps", { get: function() {
  ...
  } }), process.env.NODE_ENV !== "production" && (a3(h, p), C.warnTooManyClasses = /* @__PURE__ */ function(x, N) {
    var L = {}, y = !1;
    return function(b) {
...
function _3(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  if (It(e) || Pt(e)) return Ki(ht(Gi(rr, jt([e], t, !0))));
  var r = e;
  return t.length === 0 && r.length === 1 && typeof r[0] == "string" ? ht(r) : Ki(ht(Gi(r, t)));
}
function io(e, t, n) {
  if (n === void 0 && (n = At), !t) throw Zt(1, t);
  var r = function(o) {
    for (var i = [], a = 1; a < arguments.length; a++) i[a - 1] = arguments[a];
    return e(t, n, _3.apply(void 0, jt([o], i, !1)));
  };
...
const Ke = ao.getInstance(), Sm = {
  ...
  const [f, k] = R([]), v = O(() => {
    ...
    let I = h || [];
    for (let S = 0; S < V; S++) {
      const A = f[S], T = I.find((P) => P.key === A);
    ...
    return I;
  }, [h, f]), w = O((V) => n ? c.some((I) => I.key === V.key) : (a == null ? void 0 : a.key) === V.key, [n, c, a]), C = O((V) => {
    if (!n || !V.children) return !1;
    const I = Lt(V), S = I.filter(
      (A) => c.some((T) => T.key === A)
    ).length;
    ...
    return S(h || []).forEach((T) => {
      const P = Lt(T), F = P.filter(
        (z) => I.some(($) => $.key === z)
      ).length, E = I.some((z) => z.key === T.key);
      F === P.length && !E ? I.push(T) : F === 0 && E && (I = I.filter((z) => z.key !== T.key));
    }), I;
  }, [h, Lt]), N = O((V, I) => {
...
const X3 = ({
  ...
  onStart: C,
  onEnd: x
}) => /* @__PURE__ */ s("div", { className: "land-slider", children: /* @__PURE__ */ s("div", { className: "land-slider-track" }) }), Pm = ({
  type: e = "empty",
  title: t,
  subTitle: n,
  titleLink: r,
  ...
  const [d, h] = R(""), [p, f] = R(!1), [k, v] = R(!1), M = q(null), g = q(null), w = q(e), x = { ...{
    ...
    const z = G3[x.easing], $ = () => {
      E++;
      const D = E / F, H = z(D), B = S + (A - S) * H;
      h(N(B)), E < F ? M.current = requestAnimationFrame($) : (h(N(A)), M.current = null);
    };
  ...
  return /* @__PURE__ */ m("div", { className: `land-statistic ${u || ""}`, style: l, children: [
    ...
    /* @__PURE__ */ m("div", { className: "land-statistic-value", children: [
      /* @__PURE__ */ s(S4, { mode: "wait", children: i === "random" ? /* @__PURE__ */ s("div", { className: "flex items-center", children: j.map((S, A) => /* @__PURE__ */ s(
        "div",
        {
...
}, Rm = ({}) => /* @__PURE__ */ s("div", { children: "Swiper" }), pl = $e.memo(({ item: e, index: t, isActive: n, isFinished: r, onClick: o, direction: i }) => {
  const a = O(() => {
    o == null || o(e);
  }, [o, e]), c = O((u) => {
...
const Dm = ({
  ...
  const k = X(() => h !== void 0 && p.some((w) => w.key === h), [h, p]) ? h : p[0].key, v = O((w) => w.finished !== void 0 ? w.finished : n.includes(w.key), [n]), M = X(() => ["land-steps", a === "vertical" ? "vertical" : "", l].filter(Boolean).join(" "), [a, l]), g = O(() => p.map((w, C) => {
...
const q3 = ({
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "land-tag-input-container", children: [
          C == null ? void 0 : C.map((L, y) => /* @__PURE__ */ s(q3, { className: `land-tag-input-tag ${k}`, canDelete: !0, onDelete: () => {
...
}, Fm = ({ data: e, direction: t = "column", icon: n }) => /* @__PURE__ */ s("div", { className: `land-timeline ${t === "row" ? "row" : ""}`, children: e == null ? void 0 : e.map((r, o) => /* @__PURE__ */ m("div", { className: `land-timeline-item ${t === "row" ? "row" : ""}`, children: [
  ...
  const v = q(null), M = q(null), [g, w] = R({ width: 0, height: 0 }), C = O(() => {
    const { width: b, height: j } = g;
    if (b === 0 || j === 0) return [];
    const [V, I] = i, [S, A] = a, T = Math.max(V, r), P = Math.max(I, o), F = b - r, E = j - o, z = Math.max(0, Math.min(S, F)), $ = Math.max(0, Math.min(A, E)), D = Math.ceil((F - z) / T) + 1, H = Math.ceil((E - $) / P) + 1, B = [];
    for (let U = 0; U < H; U++)
      for (let K = 0; K < D; K++) {
        const _ = z + K * T, Q = $ + U * P;
        _ + r <= b && Q + o <= j && B.push({
  ...
  }, [k, l]), /* @__PURE__ */ m(Q3, { ref: u, className: `land-video-progress-bar ${p ? "hover" : ""}`, children: [
    /* @__PURE__ */ m(
      "div",
      {
...
`, W3 = ({
  ...
  loop: r = !1,
  onLoopChange: o
}) => /* @__PURE__ */ m(em, { children: [
  /* @__PURE__ */ m($i, { gap: 8, column: !0, children: [
    /* @__PURE__ */ s("span", { children: "倍数" }),
    /* @__PURE__ */ s(H0, { gap: 4, type: Be.ColumnRepeat, repeatNum: 3, children: e == null ? void 0 : e.map((i, a) => /* @__PURE__ */ m(
      tm,
      {
  ...
  /* @__PURE__ */ m($i, { justify: "space-between", width: "100%", children: [
    "自动循环",
    /* @__PURE__ */ s(K3, { checked: r, dark: !0, onChange: o })
  ] })
] }), em = fn.div`
  display: flex;
...
`, qi = (e) => {
  ...
  const g = q(null), w = q(null), C = q(null), [x, N] = R(1), [L, y] = R(0), [b, j] = R(0), [V, I] = R(0), [S, A] = R(!0), [T, P] = R(!1), [F, E] = R(!1), [z, $] = R(!1), [D, H] = R(!1), [B, U] = R(!1);
  q(null);
  const K = O(() => {
    if (g.current && !z) {
      const G = g.current;
  ...
  }, []), [Q, oe] = R(0), [te, ie] = R(!1), ve = X(() => (x || Number(t) || 1.7777777777777777) < 1 ? 100 : 200, [x, t]), ge = O((G, ee, Ce) => {
    if (!o) return;
    const Ee = w.current;
  ...
  }, [L, S, _]), [Ye, mn] = R(100), [gn, fl] = R(100), [Ge, vn] = R(!0), es = q(null), [ts, ns] = R(!1), ml = O((G) => {
    g.current && (mn(G), g.current.volume = G / 100, G > 0 && Ge && vn(!1));
  }, [Ge]);
  Y(() => {
    Ye !== 0 && (fl(Ye), vn(!1), ns(Ye < 100)), Ye === 0 && vn(!0);
  }, [Ye]);
  const ir = O(() => {
    g.current && (Ge ? gn > 0 ? (g.current.volume = gn / 100, mn(gn)) : (g.current.volume = 1, mn(100)) : (g.current.volume = 0, mn(0)), vn(!Ge));
  }, [Ge, gn]);
  Y(() => {
    g.current && (g.current.pause(), H(!1), j(0), I(0), y(0), A(!0), P(!1), E(!1), cr(!1), dr(!1), hr(!1), ie(!1)), w.current && (w.current.currentTime = 0);
  }, [e]), Rc(es, () => {
    ts && ns(!1);
  });
  const [rs, gl] = R(1), kn = O((G, ee) => {
    gl(ee.value), g.current && (console.log(G, g.current.playbackRate), g.current.playbackRate = G);
  }, []), [ft, os] = R(!1), ss = async () => {
    if (!g.current) return;
    const G = g.current;
    try {
  ...
  }, [mt, is] = R(!1), [nt, as] = R(!1), Ln = O(() => {
    if (!g.current) return;
    const G = g.current;
    G.requestFullscreen && G.requestFullscreen();
  }, []), [ar, cr] = R(!1), [lr, dr] = R(!1), [ur, hr] = R(!1);
  Y(() => {
    if (ar) {
      const G = setTimeout(() => {
        cr(!1);
  ...
  const vl = O((G) => {
    ...
    N(Ce), y(ee.duration), j(0), I(0), A(!0), P(!1), E(!1);
  }, []), fr = O(() => {
    if (!C.current) return;
    const ee = C.current.offsetWidth, Ce = 120, Ee = 60, Ll = f || k ? 80 : 0, wl = Ce + Ee + Ll, yl = ee < wl + 240 + 30;
    U(yl);
  }, [f, k]);
  Y(() => {
    fr();
  ...
  const kl = X(() => t || (x && x > 0 ? x.toString() : "auto"), [t, x]);
  return /* @__PURE__ */ m(
    "div",
    {
      className: `land-video ${T ? "error" : ""} ${nt ? "fullView" : ""} ${l}`,
      style: { aspectRatio: kl, ...u },
      children: [
        ...
        !T && /* @__PURE__ */ s(
          jl,
          {
                      ...
                      /* @__PURE__ */ m("div", { className: "land-video-controls-left", children: [
                        ...
                        /* @__PURE__ */ s(
                          "button",
                          {
                            ...
                            title: "播放 (space)",
                            onClick: _,
                            children: D ? /* @__PURE__ */ s(Z, { name: "video-play", size: 20 }) : /* @__PURE__ */ s(Z, { name: "video-pause", size: 32 })
                          }
                        ),
                        k && /* @__PURE__ */ s(
                          "a",
            ...
            centerOption: {
              content: F && !S ? /* @__PURE__ */ s($c, { size: 32, color: "white", strokeSize: 4 }) : /* @__PURE__ */ s("div", { className: "land-video-tags-container", children: D ? /* @__PURE__ */ s(Z, { name: "video-play", size: 20 }) : /* @__PURE__ */ s(Z, { name: "video-pause", size: 32 }) }),
              style: {
                opacity: ur || F || !D ? 1 : 0,
                pointerEvents: "none"
              }
    ...
    const b = () => {
      ...
      for (let P = 0; P < d.length; P++)
        I += d[P], V[A] = {
          type: S,
          msg: I
        }, e.some((E) => I.includes(E) ? (S = E, !0) : !1) && (V[A].msg = I.split(S)[0], V.push({
          type: S,
          msg: S
        }), A += 2, I = "", S = "default");
      const T = V.map(
...
`) && T.push({ type: "default", msg: /* @__PURE__ */ s("br", {}) }), T;
  ...
  const k = X(() => om(e, u), [e, u]), v = q(null), M = q(null), g = O(() => {
...
export {
  Be as GridType,
  Z as Icon,
  jl as LandAffixContainer,
  Ac as LandAlert,
  dm as LandAnchor,
  Xo as LandAudio,
  um as LandAutoContainer,
  zm as LandAutoWidthHeightTextarea,
  hm as LandBadge,
  pm as LandBreadCrumb,
  de as LandButton,
  V0 as LandCalendar,
  Go as LandCheck,
  fm as LandCheckbox,
  mm as LandCheckedContainer,
  gm as LandCollapse,
  ...
  Mm as LandFooter,
  H0 as LandGrid,
  Gm as LandGridTemplate,
  xm as LandHeader,
  Km as LandHighlightInput,
  rm as LandHighlightTextarea,
  D0 as LandImage,
  Jn as LandInput,
  bm as LandLayout,
  on as LandLink,
  ...
  Vm as LandPagination,
  jm as LandPopConfirm,
  me as LandPopOver,
  qm as LandPrefixValueInput,
  Tm as LandProgress,
  z3 as LandRadio,
  $m as LandRadioGroup,
  Am as LandRate,
  Dc as LandSelect,
  Im as LandSelectTree,
  R0 as LandSkeleton,
  X3 as LandSlider,
  Pm as LandState,
  Hm as LandStatistic,
