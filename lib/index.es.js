...
const Qn = "land-affix-container", ba = {
  ...
  const n = t.offset !== void 0 ? t.offset : Qc, r = ba[e], o = r.includes("start"), i = r.includes("end"), a = r.startsWith("top"), l = r.startsWith("bottom"), c = e === "topCenter" || e === "bottomCenter" || e === "center", u = e === "startCenter" || e === "endCenter" || e === "center", d = e === "custom", f = d ? t.left : o ? n : c ? "50%" : "auto", h = i ? n : "auto", p = d ? t.top : a ? n : u ? "50%" : "auto", m = l ? n : "auto";
  let v = "";
  return c && u ? v = "translate(-50%, -50%)" : c ? v = "translateX(-50%)" : u && (v = "translateY(-50%)"), { left: f, right: h, top: p, bottom: m, transform: v };
  ...
  const d = (h) => {
    const p = h.display ?? "always";
    return p === "hoverShow" ? c ? 1 : 0 : p === "hoverHide" && c ? 0 : 1;
  }, f = j(() => [
    Qn,
    t && `${Qn}--disabled`,
    o
...
function o4(e, t) {
  ...
  const d = {
    ...
    schedule: (f, h = !1, p = !1) => {
      const v = p && o ? n : r;
      return h && a.add(f), v.has(f) || v.add(f), f;
    },
    /**
    ...
    process: (f) => {
      ...
      o = !0, [n, r] = [r, n], n.forEach(u), t && Qo.value && Qo.value.frameloop[t].push(c), c = 0, n.clear(), o = !1, i && (i = !1, d.process(f));
    }
  };
  return d;
}
...
function Za(e, t) {
  ...
  const o = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, i = () => n = !0, a = jr.reduce((C, w) => (C[w] = o4(i, t ? w : void 0), C), {}), { setup: l, read: c, resolveKeyframes: u, preUpdate: d, update: f, preRender: h, render: p, postRender: m } = a, v = () => {
    const C = nn.useManualTiming ? o.timestamp : performance.now();
    n = !1, nn.useManualTiming || (o.delta = r ? 1e3 / 60 : Math.max(Math.min(C - o.timestamp, i4), 1)), o.timestamp = C, o.isProcessing = !0, l.process(o), c.process(o), u.process(o), d.process(o), f.process(o), h.process(o), p.process(o), m.process(o), o.isProcessing = !1, n && t && (r = !1, e(v));
  }, L = () => {
...
const { schedule: Ke, cancel: mn, state: lt, steps: as } = /* @__PURE__ */ Za(typeof requestAnimationFrame < "u" ? requestAnimationFrame : jt, !0);
let Pr;
function a4() {
  Pr = void 0;
}
const yt = {
  now: () => (Pr === void 0 && yt.set(lt.isProcessing || nn.useManualTiming ? lt.timestamp : performance.now()), Pr),
  set: (e) => {
...
const T4 = (e) => {
  ...
  return {
     ...
     */
    now: () => lt.isProcessing ? lt.timestamp : yt.now()
  };
}, Ja = (e, t, n = 10) => {
  let r = "";
...
function D4({ duration: e = Xe.duration, bounce: t = Xe.bounce, velocity: n = Xe.velocity, mass: r = Xe.mass }) {
  ...
  a = en(Xe.minDamping, Xe.maxDamping, a), e = en(Xe.minDuration, Xe.maxDuration, /* @__PURE__ */ zt(e)), a < 1 ? (o = (u) => {
    const d = u * a, f = d * e, h = d - n, p = Vs(u, a), m = Math.exp(-f);
    return us - h / p * m;
  }, i = (u) => {
    const f = u * a * e, h = f * n + n, p = Math.pow(a, 2) * Math.pow(u, 2) * e, m = Math.exp(-f), v = Vs(Math.pow(u, 2), a);
    return (-o(u) + us > 0 ? -1 : 1) * ((h - p) * m) / v;
  }) : (o = (u) => {
...
function Zr(e = Xe.visualDuration, t = Xe.bounce) {
  ...
  const i = n.keyframes[0], a = n.keyframes[n.keyframes.length - 1], l = { done: !1, value: i }, { stiffness: c, damping: u, mass: d, duration: f, velocity: h, isResolvedFromDuration: p } = R4({
    ...n,
...
function Ts({ keyframes: e, velocity: t = 0, power: n = 0.8, timeConstant: r = 325, bounceDamping: o = 10, bounceStiffness: i = 500, modifyTarget: a, min: l, max: c, restDelta: u = 0.5, restSpeed: d }) {
  const f = e[0], h = {
    ...
    value: f
  }, p = (T) => l !== void 0 && T < l || c !== void 0 && T > c, m = (T) => l === void 0 ? c : c === void 0 || Math.abs(l - T) < Math.abs(c - T) ? l : c;
  let v = n * t;
  const L = f + v, k = a === void 0 ? L : a(L);
  k !== L && (v = k - f);
  ...
  const l = E4(t, r, o), c = l.length, u = (d) => {
    ...
    if (c > 1)
      for (; f < e.length - 2 && !(d < e[f + 1]); f++)
        ;
    const h = /* @__PURE__ */ cr(e[f], e[f + 1], d);
    return l[f](h);
  };
...
class ko extends vo {
  ...
  tick(t, n = !1) {
    ...
    if (this.startTime === null)
      return r.next(0);
    const { delay: u = 0, keyframes: d, repeat: f, repeatType: h, repeatDelay: p, type: m, onUpdate: v, finalKeyframe: L } = this.options;
    ...
    if (f) {
      ...
      !V && T >= 1 && (V = 1), V === 1 && _--, _ = Math.min(_, f + 1), !!(_ % 2) && (h === "reverse" ? (V = 1 - V, p && (V -= p / l)) : h === "mirror" && (w = a)), C = en(0, 1, V) * l;
    }
...
const y2 = 40;
class w2 extends vo {
  constructor({ autoplay: t = !0, delay: n = 0, type: r = "keyframes", repeat: o = 0, repeatDelay: i = 0, repeatType: a = "loop", keyframes: l, name: c, motionValue: u, element: d, ...f }) {
    var m;
    super(), this.stop = () => {
      var v, L;
    ...
    const h = {
      ...
      element: d,
      ...f
    }, p = (d == null ? void 0 : d.KeyframeResolver) || Lo;
    this.keyframeResolver = new p(l, (v, L, k) => this.onKeyframesResolved(v, L, h, !k), c, u, d), (m = this.keyframeResolver) == null || m.scheduleResolve();
  }
  onKeyframesResolved(t, n, r, o) {
    ...
    p.finished.then(() => this.notifyFinished()).catch(jt), this.pendingTimeline && (this.stopTimeline = p.attachTimeline(this.pendingTimeline), this.pendingTimeline = void 0), this._animation = p;
  }
  get finished() {
...
function R2(e, t, n = {}) {
  const [r, o, i] = ml(e, n), a = (l) => {
    ...
    if (typeof u != "function" || !c)
      return;
    const d = (f) => {
      fi(f) && (u(f), c.removeEventListener("pointerleave", d));
    };
...
function Z2(e, t, n = {}) {
  const [r, o, i] = ml(e, n), a = (l) => {
    ...
    Ar.add(c);
    const u = t(c, l), d = (p, m) => {
      window.removeEventListener("pointerup", f), window.removeEventListener("pointercancel", h), Ar.has(c) && Ar.delete(c), mi(p) && typeof u == "function" && u(p, { success: m });
    }, f = (p) => {
      d(p, c === window || c === document || n.useGlobalTarget || gl(c, p.target));
    }, h = (p) => {
      d(p, !1);
    };
...
function X2({ children: e, isPresent: t, anchorX: n, root: r }) {
  ...
  return Ca(() => {
    const { width: c, height: u, top: d, left: f, right: h } = a.current;
    if (t || !i.current || !c || !u)
      return;
...
const Q2 = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: o = !0, mode: i = "sync", propagate: a = !1, anchorX: l = "left", root: c }) => {
  const [u, d] = kl(a), f = j(() => gi(e), [e]), h = a && !u ? [] : f.map(Tr), p = ae(!0), m = ae(f), v = eo(() => /* @__PURE__ */ new Map()), [L, k] = F(f), [y, C] = F(f);
  Na(() => {
  ...
  if (f !== L) {
    ...
    return i === "wait" && w.length && (x = w), C(gi(x)), k(f), null;
  }
  ...
  return s(tt, { children: y.map((x) => {
    const N = Tr(x), T = a && !u ? !1 : f === y || h.includes(N), _ = () => {
      if (v.has(N))
        v.set(N, !0);
      else
        return;
    ...
    return s(q2, { isPresent: T, initial: !p.current || n ? void 0 : !1, custom: t, presenceAffectsLayout: o, mode: i, root: c, onExitComplete: T ? void 0 : _, anchorX: l, children: x }, N);
  }) });
}, Ll = Yn({ strict: !1 }), vi = {
  animation: [
    "animate",
...
function cf(e, t, n, r, o) {
  ...
  const d = u.current, f = ft(Ml);
  d && !d.projection && o && (d.type === "html" || d.type === "svg") && df(u.current, n, o, f);
  const h = ae(!1);
  Ca(() => {
    d && h.current && d.update(n, l);
  });
  const p = n[Cl], m = ae(!!p && !((v = window.MotionHandoffIsComplete) != null && v.call(window, p)) && ((L = window.MotionHasOptimisedAnimation) == null ? void 0 : L.call(window, p)));
  return Na(() => {
    ...
    d && (!m.current && d.animationState && d.animationState.animateChanges(), m.current && (queueMicrotask(() => {
      var k;
      (k = window.MotionHandoffMarkAsComplete) == null || k.call(window, p);
    }), m.current = !1));
  }), d;
}
function df(e, t, n, r) {
...
function uf({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: o }) {
  ...
  function i(l, c) {
    ...
    const d = {
      ...
      ...l,
      layoutId: hf(l)
    }, { isStatic: f } = d, h = sf(l), p = r(l, f);
    if (!f && to) {
      ff(d, e);
      const m = pf(d);
      u = m.MeasureLayout, h.visualElement = cf(o, p, d, t, m.ProjectionNode);
    }
    return g(Gr.Provider, { value: h, children: [u && h.visualElement ? s(u, { visualElement: h.visualElement, ...d }) : null, n(o, l, af(p, h.visualElement, c), p, f, h.visualElement)] });
  }
...
function $l(e, {
  ...
  f.transform && (h.transform = f.transform, delete f.transform), (h.transform || f.transformOrigin) && (h.transformOrigin = f.transformOrigin ?? "50% 50%", delete f.transformOrigin), h.transform && (h.transformBox = (d == null ? void 0 : d.transformBox) ?? "fill-box", delete f.transformBox), t !== void 0 && (f.x = t), n !== void 0 && (f.y = n), r !== void 0 && (f.scale = r), o !== void 0 && bf(f, o, i, a, !1);
}
const Nl = () => ({
  ...Vo(),
  attrs: {}
...
function $f(e = !1) {
  return (n, r, o, { latestValues: i }, a) => {
    const c = (To(n) ? xf : wf)(r, i, a, n), u = tf(r, typeof n == "string", e), d = n !== vr ? { ...u, ...c, ref: o } : {}, { children: f } = r, h = j(() => pt(f) ? f.get() : f, [f]);
    return zc(n, {
      ...d,
      children: h
    });
...
const Do = (e, t, n, r = {}, o, i) => (a) => {
  ...
  let f = !1;
  if ((d.type === !1 || d.duration === 0 && !d.repeatDelay) && (d.duration = 0, d.delay === 0 && (f = !0)), (nn.instantAnimations || nn.skipAnimations) && (f = !0, d.duration = 0, d.delay = 0), d.allowFlatten = !l.type && !l.ease, f && !i && t.get() !== void 0) {
...
function Hl(e, t, { delay: n = 0, transitionOverride: r, type: o } = {}) {
  ...
  for (const d in l) {
    const f = e.getValue(d, e.latestValues[d] ?? null), h = l[d];
    ...
    if (m !== void 0 && !f.isAnimating && !Array.isArray(h) && h === m && !p.velocity)
      continue;
    let v = !1;
    ...
    Os(e, d), f.start(Do(d, f, h, e.shouldReduceMotion && ll.has(d) ? { type: !1 } : p, e, v));
    const L = f.animation;
    L && c.push(L);
  }
...
function Kf(e, t, n = 0, r = 0, o = 0, i = 1, a) {
  const l = [], c = e.variantChildren.size, u = (c - 1) * o, d = typeof r == "function", f = d ? (h) => r(h, c) : (
    // Support deprecated staggerChildren
    i === 1 ? (h = 0) => h * o : (h = 0) => u - h * o
  );
  return Array.from(e.variantChildren).sort(zf).forEach((h, p) => {
...
function Wf(e) {
  ...
  const o = (c) => (u, d) => {
    var h;
    const f = pr(e, d, c === "exit" ? (h = e.presenceContext) == null ? void 0 : h.custom : void 0);
    if (f) {
      const { transition: p, transitionEnd: m, ...v } = f;
      u = { ...u, ...v, ...m };
    }
    return u;
  };
  ...
  function a(c) {
    const { props: u } = e, d = Il(e.parent) || {}, f = [], h = /* @__PURE__ */ new Set();
    let p = {}, m = 1 / 0;
    for (let L = 0; L < Qf; L++) {
      const k = Gf[L], y = n[k], C = u[k] !== void 0 ? u[k] : d[k], w = hr(C), b = k === c ? y.isActive : null;
      b === !1 && (m = L);
      let x = C === d[k] && C !== u[k] && w;
      if (x && r && e.manuallyAnimateOnMount && (x = !1), y.protectedKeys = { ...p }, // If it isn't active and hasn't *just* been set as inactive
      ...
      y.prevProp = C, y.prevResolvedValues = H, y.isActive && (p = { ...p, ...H }), r && e.blockInitialAnimation && (T = !1), T && (!(x && N) || _) && f.push(...V.map((R) => ({
        animation: R,
        options: { type: k }
      })));
    }
  ...
  constructor(t, n, { transformPagePoint: r, contextWindow: o = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3 } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
      if (!(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const h = ms(this.lastMoveEventInfo, this.history), p = this.startEvent !== null, m = gp(h.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
      if (!p && !m)
        return;
      const { point: v } = h, { timestamp: L } = lt;
      this.history.push({ ...v, timestamp: L });
      const { onStart: k, onMove: y } = this.handlers;
      p || (k && k(this.lastMoveEvent, h), this.startEvent = this.lastMoveEvent), y && y(this.lastMoveEvent, h);
    }, this.handlePointerMove = (h, p) => {
      this.lastMoveEvent = h, this.lastMoveEventInfo = ps(p, this.transformPagePoint), Ke.update(this.updatePoint, !0);
      ...
      if (this.dragSnapToOrigin && L && L(), !(this.lastMoveEvent && this.lastMoveEventInfo))
        return;
      const k = ms(h.type === "pointercancel" ? this.lastMoveEventInfo : ps(p, this.transformPagePoint), this.history);
    ...
    const l = wr(t), c = ps(l, this.transformPagePoint), { point: u } = c, { timestamp: d } = lt;
    this.history = [{ ...u, timestamp: d }];
    const { onSessionStart: f } = n;
    f && f(t, ms(c, this.history)), this.removeListeners = kr(ir(this.contextWindow, "pointermove", this.handlePointerMove), ir(this.contextWindow, "pointerup", this.handlePointerUp), ir(this.contextWindow, "pointercancel", this.handlePointerUp));
  }
  updateHandlers(t) {
    this.handlers = t;
  }
...
class _p {
  ...
  start(t, { snapToCursor: n = !1, distanceThreshold: r } = {}) {
    ...
    const i = (f) => {
      ...
      h ? this.pauseAnimation() : this.stopAnimation(), n && this.snapToCursor(wr(f).point);
    }, a = (f, h) => {
      const { drag: p, dragPropagation: m, onDragStart: v } = this.getProps();
      if (p && !m && (this.openDragLock && this.openDragLock(), this.openDragLock = B2(p), !this.openDragLock))
        return;
      this.latestPointerEvent = f, this.latestPanInfo = h, this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), Nt((k) => {
      ...
      }), v && Ke.postRender(() => v(f, h)), Os(this.visualElement, "transform");
      const { animationState: L } = this.visualElement;
      L && L.setActive("whileDrag", !0);
    }, l = (f, h) => {
      this.latestPointerEvent = f, this.latestPanInfo = h;
      const { dragPropagation: p, dragDirectionLock: m, onDirectionLock: v, onDrag: L } = this.getProps();
      ...
      this.updateAxis("x", h.point, k), this.updateAxis("y", h.point, k), this.visualElement.render(), L && L(f, h);
    }, c = (f, h) => {
...
function Ql({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: o }) {
  return class {
    ...
    mount(a) {
      ...
      if (u && !u.current && u.mount(a), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (c || l) && (this.isLayoutDirty = !0), e) {
        ...
        Ke.read(() => {
          ...
          p !== f && (f = p, this.root.updateBlockedByResize = !0, d && d(), d = Pp(h, 250), Rr.hasAnimatedSinceResize && (Rr.hasAnimatedSinceResize = !1, this.nodes.forEach(ta)));
        });
      }
      l && this.root.registerSharedNode(l, this), this.options.animate !== !1 && u && (l || c) && this.addEventListener("didUpdate", ({ delta: d, hasLayoutChanged: f, hasRelativeLayoutChanged: h, layout: p }) => {
        ...
        const m = this.options.transition || u.getDefaultTransition() || a0, { onLayoutAnimationStart: v, onLayoutAnimationComplete: L } = u.getProps(), k = !this.targetLayout || !ql(this.targetLayout, p), y = !f && h;
        if (this.options.layoutRoot || this.resumeFrom || y || f && (k || !this.currentAnimation)) {
          ...
          f || ta(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
        this.targetLayout = p;
      });
    }
    unmount() {
    ...
    update() {
      ...
      const l = yt.now();
      lt.delta = en(0, 1e3 / 60, l - lt.timestamp), lt.timestamp = l, lt.isProcessing = !0, as.update.process(lt), as.preRender.process(lt), as.render.process(lt), lt.isProcessing = !1;
    }
    didUpdate() {
    ...
    removeElementScroll(a) {
      ...
      for (let u = 0; u < this.path.length; u++) {
        ...
        d !== this.root && f && h.layoutScroll && (f.wasRoot && xt(l, a), En(l.x, f.offset.x), En(l.y, f.offset.y));
      }
      return l;
    }
    ...
    removeTransform(a) {
      ...
      for (let c = 0; c < this.path.length; c++) {
        ...
        xt(d, f), zi(l, u.latestValues, u.snapshot ? u.snapshot.layoutBox : void 0, d);
      }
    ...
    resolveTargetDelta(a = !1) {
      ...
      if (!(!this.layout || !(d || f))) {
        if (this.resolvedRelativeTargetAt = lt.timestamp, !this.targetDelta && !this.relativeTarget) {
          ...
          p && p.layout && this.animationProgress !== 1 ? (this.relativeParent = p, this.forceRelativeParentToResolveTarget(), this.relativeTarget = We(), this.relativeTargetOrigin = We(), lr(this.relativeTargetOrigin, this.layout.layoutBox, p.layout.layoutBox), xt(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
        }
        if (!(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = We(), this.targetWithTransforms = We()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), fp(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : xt(this.target, this.layout.layoutBox), El(this.target, this.targetDelta)) : xt(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget)) {
          ...
          const p = this.getClosestProjectingParent();
          p && !!p.resumingFrom == !!this.resumingFrom && !p.options.layoutScroll && p.target && this.animationProgress !== 1 ? (this.relativeParent = p, this.forceRelativeParentToResolveTarget(), this.relativeTarget = We(), this.relativeTargetOrigin = We(), lr(this.relativeTargetOrigin, this.target, p.target), xt(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
        }
      }
    }
    ...
    calcProjection() {
      ...
      let c = !0;
      if ((this.isProjectionDirty || (m = this.parent) != null && m.isProjectionDirty) && (c = !1), l && (this.isSharedProjectionDirty || this.isTransformDirty) && (c = !1), this.resolvedRelativeTargetAt === lt.timestamp && (c = !1), c)
        return;
      ...
      !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (Ui(this.prevProjectionDelta.x, this.projectionDelta.x), Ui(this.prevProjectionDelta.y, this.projectionDelta.y)), ar(this.projectionDelta, this.layoutCorrected, p, this.latestValues), (this.treeScale.x !== f || this.treeScale.y !== h || !Ji(this.projectionDelta.x, this.prevProjectionDelta.x) || !Ji(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", p));
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    applyTransformsToTarget() {
      ...
      if (!(!l || !c || !u)) {
        if (this !== a && this.layout && u && Jl(this.options.animationType, this.layout.layoutBox, u.layoutBox)) {
          c = this.target || We();
          const f = gt(this.layout.layoutBox.x);
    ...
    applyProjectionStyles(a, l) {
      ...
      let f = Kp(this.projectionDeltaWithTransform, this.treeScale, d);
      c && (f = c(d, f)), a.transform = f;
      const { x: h, y: p } = this.projectionDelta;
      a.transformOrigin = `${h.origin * 100}% ${p.origin * 100}% 0`, u.animationValues ? a.opacity = u === this ? d.opacity ?? this.latestValues.opacity ?? 1 : this.preserveOpacity ? this.latestValues.opacity : d.opacityExit : a.opacity = u === this ? d.opacity !== void 0 ? d.opacity : "" : d.opacityExit !== void 0 ? d.opacityExit : 0;
      for (const m in fr) {
        if (d[m] === void 0)
          continue;
        const { correct: v, applyTo: L, isCSSVariable: k } = fr[m], y = f === "none" ? d[m] : v(d[m], u);
        if (L) {
          const C = L.length;
          for (let w = 0; w < C; w++)
            a[L[w]] = y;
...
function Gp(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners("didUpdate")) {
    ...
    i === "size" ? Nt((f) => {
      const h = a ? t.measuredBox[f] : t.layoutBox[f], p = gt(h);
      h.min = r[f].min, h.max = h.min + p;
    }) : Jl(i, t.layoutBox, r) && Nt((f) => {
      const h = a ? t.measuredBox[f] : t.layoutBox[f], p = gt(r[f]);
    ...
    if (!e.resumeFrom) {
      ...
      if (f && !f.resumeFrom) {
        ...
        if (h && p) {
          ...
          const v = We();
          lr(v, r, p.layoutBox), ql(m, v) || (d = !0), f.options.layoutRoot && (e.relativeTarget = v, e.relativeTargetOrigin = m, e.relativeParent = f);
        }
      }
    }
...
const S0 = (e, t) => To(e) ? new T0(t) : new j0(t, {
  ...
  ...u0,
  ...M0
}, S0), ct = /* @__PURE__ */ nf(H0), Dn = "land-popover", dt = ({
  show: e,
  content: t,
  trigger: n = "hover",
  onVisibleChange: r,
  ...
  const [p, m] = F(e ?? !1), [v, L] = F(null), [k, y] = F({ width: 0, height: 0 }), [C, w] = F(i), [b, x] = F(!1), N = ae(null), T = ae(null), _ = ae(r), V = ae(!0), H = ae(i);
  de(() => {
  ...
  de(() => {
    var D;
    re.current !== p && (re.current = p, (D = _.current) == null || D.call(_, p));
  }, [p]);
  const R = ae(k);
  R.current = k;
  const q = ae();
  q.current = () => {
    ...
    var D;
    p && U && k.width > 0 && k.height > 0 && ((D = q.current) == null || D.call(q));
  }, [p, U, k]), de(() => {
    if (n !== "click" || !p) return;
    const D = (he) => {
  ...
  const J = M(() => {
    ...
    `${Dn}__bubble`,
    `${Dn}__bubble--${o}`,
    p && `${Dn}__bubble--visible`,
    a && `${Dn}__bubble--no-arrow`,
    d
  ].filter(Boolean).join(" "), [o, p, a, d]), pe = j(() => {
    const D = {
      zIndex: U ? 1e3 : 100,
  ...
  return /* @__PURE__ */ s(dt, { content: l, ...c, children: b });
};
Kr.LinkWave = D0;
const P0 = "land-loading", Gn = ({
  ...
  const [x, N] = F(!0), [T, _] = F(!1), V = j(() => A0[e] || "info", [e]), H = j(() => B0[n] || "horizontal", [n]), S = j(() => m ? "text" : t, [m, t]), A = j(() => ({
    ...
    o && /* @__PURE__ */ g("div", { className: `${ut}__title`, children: [
      o,
      f && /* @__PURE__ */ g(tt, { children: [
        "，",
        /* @__PURE__ */ s(Kr, { onClick: h, children: f })
      ] })
    ] }),
  ...
  ] }), q = () => !p && !l ? null : /* @__PURE__ */ g("div", { className: `${ut}__actions`, children: [
    p,
  ...
  const c = ae(null), [u, d] = F(""), [f, h] = F(0), [p, m] = F(-1), [v, L] = F(!1), k = M(() => l(), [l]), y = M((_) => _ === window ? window.pageYOffset || document.documentElement.scrollTop : _.scrollTop, []), C = M((_, V) => {
  ...
  const d = j(() => e > c, [e, c]), f = j(() => [da, i].filter(Boolean).join(" "), [i]), h = j(() => [`${da}__content`, n].filter(Boolean).join(" "), [n]), p = j(() => ({
    width: d ? "100%" : "auto",
    height: d ? "auto" : "100%",
    aspectRatio: `${e}`,
    ...r
  ...
  }, [n, i]), c = j(() => Math.max(1, Math.round(t / 6)), [t]), u = j(() => Array.from({ length: r }, (d, f) => {
    const h = -(o * (r - 1 - f) * 0.15);
    return /* @__PURE__ */ s(
      "div",
      {
  ...
  const u = j(() => typeof t == "number" ? t : ua[t] || ua.medium, [t]), d = j(() => Math.round(u * 0.625), [u]), f = j(() => {
    ...
    r || i || a == null || a(m);
  }, p = () => i ? /* @__PURE__ */ s(Gn, { size: d, color: n, strokeSize: 2 }) : e ? o ? /* @__PURE__ */ s(sc, { size: d, color: n, playing: !0 }) : /* @__PURE__ */ s(Le, { name: "video-play", size: d, color: n }) : /* @__PURE__ */ s(Le, { name: "video-pause", size: d + 4, color: n });
  return /* @__PURE__ */ s(
    "button",
    {
      type: "button",
...
function U0({
  ...
  if (f === 0 || h === 0) return;
  u.clearRect(0, 0, f, h);
  const p = r + o, m = Math.floor(f / p), v = Math.min(d.length, m), L = Math.max(...d), k = 2, y = L > 0 ? Math.max(h * 0.85 / L, k / L) : 1, C = Math.floor(n * v);
  for (let w = 0; w < v; w++) {
    const b = d[w] || 0, x = w * p, N = Math.max(b * y, k), T = (h - N) / 2;
...
function Y0({
  ...
  if (a === 0 || l === 0) return;
  i.clearRect(0, 0, a, l);
  const c = Math.max(...e), u = c > 0 ? l * 0.7 / c : 1, d = a / (e.length - 1), f = Math.floor(n * e.length);
  if (i.beginPath(), i.strokeStyle = r, i.lineWidth = 1, i.setLineDash([2, 2]), i.moveTo(0, l / 2), i.lineTo(a, l / 2), i.stroke(), i.setLineDash([]), i.beginPath(), i.strokeStyle = r, i.lineWidth = 2, i.lineJoin = "round", i.lineCap = "round", e.forEach((h, p) => {
    const m = p * d, v = l / 2 - h * u;
    p === 0 ? i.moveTo(m, v) : i.lineTo(m, v);
  }), i.stroke(), f > 0) {
    i.beginPath(), i.strokeStyle = o, i.lineWidth = 3;
    for (let h = 0; h < Math.min(f, e.length); h++) {
      const p = h * d, m = l / 2 - e[h] * u;
      h === 0 ? i.moveTo(p, m) : i.lineTo(p, m);
    }
    i.stroke();
  }
}
const dc = ({
  ...
  return V ? /* @__PURE__ */ s("div", { className: X, style: { height: p, ...k }, children: /* @__PURE__ */ s("div", { className: "land-audio-wave__error", children: V }) }) : T ? /* @__PURE__ */ s("div", { className: X, style: { height: p, ...k }, children: /* @__PURE__ */ s(Gn, { size: 20, color: "var(--color-text-3)", strokeSize: 2 }) }) : /* @__PURE__ */ g(
    "div",
    {
      ref: b,
      className: X,
  ...
  const Ie = j(() => {
    const Ve = ["land-audio"];
    return Q === "error" && Ve.push("land-audio--error"), p && Ve.push("land-audio--with-wave"), re && Ve.push(re), Ve.join(" ");
  }, [Q, p, re]);
  return /* @__PURE__ */ g("div", { className: Ie, style: R, children: [
    ...
    /* @__PURE__ */ g("div", { className: "land-audio__content", children: [
      ...
      /* @__PURE__ */ g("div", { className: "land-audio__controls", children: [
        ...
        /* @__PURE__ */ s("div", { className: "land-audio__progress-area", children: p ? /* @__PURE__ */ s(
          dc,
          {
            src: e,
            audioRef: z,
        ...
        f && /* @__PURE__ */ g("div", { className: "land-audio__time", children: [
...
const om = ({
  ...
  const {
    ...
    const _ = [Ft];
    return u ? _.push(`${Ft}--has-children`) : _.push(`${Ft}--standalone`), p && _.push(p), _.join(" ");
  }, [u, p]), b = j(() => {
    const _ = [`${Ft}__sup`];
  ...
  return /* @__PURE__ */ s(dt, { attach: "body", content: e.tip || (o && a ? e.label : ""), children: /* @__PURE__ */ g(
    "div",
    {
  ...
  const l = ae(null), [c, u] = F(!1), [d, f] = F(!0);
  de(() => {
    if (!n || !l.current) return;
    const p = l.current, m = () => {
      u(p.scrollLeft <= p.clientWidth - p.scrollWidth), f(p.scrollLeft >= 0);
    };
  ...
  return /* @__PURE__ */ g("div", { className: h, style: i, children: [
    ...
    /* @__PURE__ */ s("div", { ref: l, className: `${on}__container`, children: [...e].reverse().map((p, m) => /* @__PURE__ */ s(
      z0,
      {
        index: m,
        item: p,
  ...
  return /* @__PURE__ */ g(
    et,
    {
      ...
      children: [
        /* @__PURE__ */ s(ct.div, { animate: { opacity: r ? 1 : 0, scaleY: r ? 1 : -1 }, transition: { duration: 0.6, type: "spring" }, className: "land-button-change-hover", children: t }),
        /* @__PURE__ */ s(ct.div, { animate: { opacity: r ? 0 : 1 }, transition: { duration: 0.6, type: "spring" }, className: "land-button-change-default", children: e })
      ]
    }
  );
}, st = "land-button", et = ({
  ...
  const w = j(() => !!(v && !p && !m), [v, p, m]), b = j(() => [
    ...
    !w && (p || m) && /* @__PURE__ */ g("div", { className: `${st}__content-wrapper`, children: [
      /* @__PURE__ */ s("span", { className: `${st}__text`, children: p }),
      m && /* @__PURE__ */ s("span", { className: `${st}__sub-text`, children: m }),
      (a || e === "transparent") && /* @__PURE__ */ g("div", { className: `${st}__mask-content`, children: [
        /* @__PURE__ */ s("span", { className: `${st}__mask-text`, children: p }),
        m && /* @__PURE__ */ s("span", { className: `${st}__sub-text`, children: m })
      ] })
    ] }),
    h
  ...
  return /* @__PURE__ */ s(dt, { theme: "dark", content: k, ...y, children: /* @__PURE__ */ s(
    "button",
    {
      ...N,
      children: x()
...
const Cr = ({
  ...
  const X = M((ie) => {
    ...
    f,
    L
  ].filter(Boolean).join(" "), [w, l, f, L]), Z = j(() => [
    `${Tt}__panel`,
    w && `${Tt}__panel--open`,
    S && `${Tt}__panel--portal`,
    `${Tt}__panel--${R}`,
    `${Tt}__panel--${U}`
  ].filter(Boolean).join(" "), [w, S, R, U]), te = j(() => [`${Tt}__content`, p].filter(Boolean).join(" "), [p]), pe = M(() => {
    l || e === "click" && b((ie) => !ie);
  }, [l, e]), ue = M(() => {
    l || e !== "hover" || b(!0);
  }, [l, e]), le = M(() => {
  ...
  const C = l ?? a, w = j(() => [
    ...
    o && `${ot}--indeterminate`,
    f
  ].filter(Boolean).join(" "), [c, i, k, o, f]), b = j(() => [
    `${ot}__wrapper`,
  ...
  const $ = j(() => a ? H.filter((I) => R.includes(I.key)) : H.filter((I) => I.key === U), [a, H, R, U]), Z = j(() => $.map((I) => I.label), [$]), te = M(
        ...
        "div",
        {
          ...
          children: [
            ...
            I.iconTip && /* @__PURE__ */ g("div", { className: `${nt}__option-icon`, children: [
              ...
              /* @__PURE__ */ s(dt, { content: I.iconTip, placement: "right", theme: "dark" })
            ] }),
            I.tip && /* @__PURE__ */ s(dt, { content: I.tip, placement: "right", theme: "dark" })
          ]
        },
        I.key
      );
    ...
    `${nt}__trigger--${S}`,
    `${nt}__trigger--${d}`,
    f && `${nt}__trigger--disabled`,
    J && `${nt}__trigger--open`
  ].filter(Boolean).join(" "), [S, d, f, J]);
  return /* @__PURE__ */ s("div", { className: he, style: ne, children: /* @__PURE__ */ s(
    Cr,
    {
      ...
      children: /* @__PURE__ */ g("div", { className: ge, children: [
        ...
        L && /* @__PURE__ */ s(dt, { attach: "body", content: L, theme: "dark", ...k })
      ] })
    }
  ) });
};
...
const J0 = (e) => {
  ...
  return /* @__PURE__ */ g("div", { className: `land-calendar__header ${v}`, style: L, children: [
    ...
    f && /* @__PURE__ */ s("div", { className: "land-calendar__header-extra", children: f }),
    /* @__PURE__ */ g("div", { className: "land-calendar__header-nav", children: [
      b && /* @__PURE__ */ s(
        et,
        {
...
const e3 = (e) => {
  if (W0(e)) {
    const {
      ...
      S.stopPropagation(), !p.isDisabled && (p.isCurrentMonth ? m == null || m(p) : v == null || v(p));
    }, N = (S) => {
      !p.isDisabled && L && L(p, S);
    }, T = (S) => {
      !p.isDisabled && k && k(p, S);
    }, _ = (S) => {
      !p.isDisabled && y && y(p, S);
    }, V = (S) => {
      !p.isDisabled && C && C(p, S);
    }, H = [
      "land-calendar__cell",
      p.isToday && "land-calendar__cell--today",
      p.isSelected && "land-calendar__cell--selected",
      p.isDisabled && "land-calendar__cell--disabled",
      !p.isCurrentMonth && "land-calendar__cell--other",
      b
    ].filter(Boolean).join(" ");
    return /* @__PURE__ */ g(
      "div",
      {
        ...
        onMouseLeave: V,
        children: [
          /* @__PURE__ */ s("span", { className: "land-calendar__cell-text", children: p.dayNumber }),
          w
        ]
      }
    );
  ...
  const u = (p) => {
    p.stopPropagation(), !t.isDisabled && (t.isCurrentMonth ? r == null || r(t) : o && o(t));
  }, d = (p) => {
    t.isDisabled || i == null || i(t, p);
  }, f = (p) => {
    t.isDisabled || a == null || a(t, p);
  }, h = [
    "land-calendar__cell",
...
function s3(e, t, n, r, o) {
  ...
  for (let h = 0; h < l; h++) {
    const p = new Date(e, t, 0), m = new Date(p.getTime() - (l - h - 1) * 24 * 60 * 60 * 1e3), v = m.getDate(), L = m.getMonth(), k = m.getFullYear();
    d.push({
      date: m,
      isCurrentMonth: !1,
  ...
  for (let h = 1; h <= c; h++) {
    const p = new Date(e, t, h);
    d.push({
      date: p,
      isCurrentMonth: !0,
      isToday: p.toDateString() === u.toDateString(),
      isSelected: n === h,
  ...
  const f = d.length;
  for (let h = 1; h <= 42 - f; h++) {
    const p = new Date(e, t + 1, h), m = p.getDate(), v = p.getMonth(), L = p.getFullYear();
    d.push({
      date: p,
      isCurrentMonth: !1,
      isToday: p.toDateString() === u.toDateString(),
...
function o3(e, t, n, r, o) {
  ...
  let f = [];
  for (let h = 0; h < l; h++) {
    const p = new Date(e, t, 0), m = new Date(p.getTime() - (l - h - 1) * 24 * 60 * 60 * 1e3);
    f.push(m);
  }
  for (let h = 1; h <= c; h++)
    if (f.push(new Date(e, t, h)), f.length === 7) {
      const p = f[0], m = f[6], v = d.length;
      d.push({
        dates: [...f],
        isCurrentWeek: ma(f, u),
        isSelected: n === v + 1,
        isDisabled: !pa(p, m, r, o),
        weekStart: p,
        weekEnd: m
      }), f = [];
    }
  if (f.length > 0) {
    for (let v = f.length; v < 7; v++) {
      const L = new Date(e, t + 1, v - f.length + 1);
      f.push(L);
    }
    const h = f[0], p = f[6], m = d.length;
    d.push({
      dates: f,
      isCurrentWeek: ma(f, u),
      isSelected: n === m + 1,
      isDisabled: !pa(h, p, r, o),
      weekStart: h,
      weekEnd: p
    });
  }
...
const i3 = (e) => {
  const {
    ...
    showWeekNumber: f = Qt.showWeekNumber,
    showTodayButton: h = Qt.showTodayButton,
    showOtherMonthDays: p = Qt.showOtherMonthDays,
    ...
    const Ce = he.find((at) => at.value === Y);
    ...
    if (r === "year") {
      Y = `${ne}-${ne + 9}`;
      const [xe, De] = Z, at = Math.floor(xe / 10) * 10, wt = Math.floor(De / 10) * 10;
      Ce = [];
      for (let ce = at; ce <= wt; ce += 10)
    ...
    /* @__PURE__ */ s("div", { className: "land-calendar__grid land-calendar__grid--week", children: ie.map((Y, Ce) => {
      ...
      return /* @__PURE__ */ s(
        "div",
        {
          ...
          onClick: () => se(Y, Ce),
          children: Y.dates.map((De, at) => /* @__PURE__ */ s(
            "div",
            {
  ...
  const X = M(() => {
    ...
    transitionDuration: p ? `${m}ms` : "0ms"
  }), [N, U, p, m]), be = () => f ? null : l !== void 0 ? typeof l == "function" ? /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: l(S) }) : /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: l }) : /* @__PURE__ */ s("span", { className: `${kt}__arrow`, children: /* @__PURE__ */ s(
    Le,
    {
      name: "arrow",
      strokeWidth: 4,
  ...
  return /* @__PURE__ */ s("div", { className: S, style: y, children: /* @__PURE__ */ g("div", { className: `${Qe}__content`, children: [
    ...
    f && /* @__PURE__ */ s("div", { className: `${Qe}__after`, children: f }),
    X()
  ] }) });
}, Fe = "land-input", gr = ({
  variant: e = "outline",
  ...
  const S = j(() => [
    ...
    onCompositionEnd: q,
    ...x
  }, z = () => p ? /* @__PURE__ */ g(tt, { children: [
    /* @__PURE__ */ g("div", { className: `${Fe}__prefix-ghost`, children: [
      /* @__PURE__ */ s("span", { className: `${Fe}__affix-label`, children: p }),
      /* @__PURE__ */ s("span", { className: `${Fe}__affix-value`, children: _ || a })
    ] }),
    /* @__PURE__ */ s("span", { className: `${Fe}__affix-spacer`, children: p })
  ] }) : null, Q = () => !m || !_ ? null : /* @__PURE__ */ g("div", { className: `${Fe}__suffix-ghost`, children: [
    p && /* @__PURE__ */ s("span", { className: `${Fe}__affix-spacer`, children: p }),
  ...
  return /* @__PURE__ */ s("div", { className: S, style: b, children: /* @__PURE__ */ g("div", { className: `${Fe}__content`, children: [
    f && /* @__PURE__ */ s("div", { className: `${Fe}__before`, children: f }),
...
const ln = "land-divider", qt = ({
  ...
  const d = e === "vertical", f = r != null, h = j(
    () => [
      ln,
      `${ln}--${e}`,
      `${ln}--${t}`,
  ...
  return /* @__PURE__ */ g("div", { className: h, style: p, children: [
  ...
  const q = U ? e : re, J = M(
    (ne) => f !== void 0 ? Number(ne.toFixed(f)) : ne,
    [f]
  ), z = M(
    (ne) => {
      let ge = ne;
  ...
  const {
    ...
    name: u,
    presets: d,
    showInput: f = Zt.showInput,
    showFormatSwitch: h = Zt.showFormatSwitch,
    panelWidth: p = Zt.panelWidth,
  ...
  ), [l, N, w, se, $e]), He = M(() => f ? /* @__PURE__ */ g("div", { className: "land-color-picker__inputs", children: [
    h && /* @__PURE__ */ s(
      hc,
      {
        variant: "transparent",
  ...
  return /* @__PURE__ */ s("div", { className: at, style: v, "data-name": u, children: /* @__PURE__ */ s(
    Cr,
    {
      trigger: "click",
      disabled: i,
...
function ga(e) {
  ...
  for (const { pattern: i, extract: a } of o) {
    ...
    if (l)
      try {
        const { year: c, month: u, day: d } = a(l), f = new Date(c, u - 1, d);
        if (f.getFullYear() === c && f.getMonth() === u - 1 && f.getDate() === d)
          return f;
      } catch {
        continue;
      }
...
const fm = (e) => {
  const {
  ...
  }), [W, fe] = F(null), [K, P] = F(""), [oe, se] = F(!1), ve = ae(null), [_e, Se] = F(void 0), we = t !== void 0 || be.value !== void 0, Ie = T !== void 0, Ue = we ? t ?? be.value ? new Date(t ?? be.value) : null : I, Ve = Ie ? T : ne, Oe = M((Me) => Me ? typeof f == "function" ? f(Me, ie, o) : h3(Me, ie, o) : "", [f, ie, o]), Re = j(() => Oe(Ue), [Ue, Oe]), Ge = j(() => d || u3(ie, o), [d, ie, o]), ze = j(() => ({
    date: "date",
    week: "week",
    month: "month",
    quarter: "quarter",
    ...
    x || N || (p && ie === "date" ? (se(!0), P(Re)) : Ce(), O == null || O(Me));
  }, [x, N, p, ie, Re, Ce, O]), He = M((Me) => {
    if (!(x || N)) {
      if (p && ie === "date") {
        if (se(!1), K.trim()) {
          const Ze = ga(K);
  ...
  }, [x, N, p, ie, K, we, H, ce, U]), Ee = M((Me) => {
    if (!(x || N || !p || ie !== "date") && Me.trim()) {
      const Ze = ga(Me);
      ...
      children: [
        /* @__PURE__ */ s(
          gr,
          {
            ...
            onFocus: Be,
            onBlur: He,
            onChange: p && ie === "date" ? $e : void 0,
            onClear: he ? ce : void 0,
            onEnter: Ee,
            className: "land-date-picker__input",
            htmlProps: { readOnly: N || !p || ie !== "date" },
            ...J
          }
        ),
  ...
  const O = j(() => {
    ...
    if (J.key === "Escape" && w && e && k && k(), J.key === "Enter" && b && e && y && !p) {
      const z = J.target;
  ...
  const c = ae(null), [u, d] = F(!1), [f, h] = F(0), p = j(() => t || n || "", [t, n]), m = j(() => {
  ...
  const y = j(() => l ? l(f) : f, [l, f]), C = j(() => /* @__PURE__ */ s(
    "div",
    {
      className: m,
      style: o,
...
const Je = "land-menu", gc = ({
  ...
  de(() => {
    p && e && v.current && v.current.scrollIntoView({ behavior: "smooth", block: "nearest" });
  }, [e, p, n]);
  const L = j(() => [
    Je,
    n === "column" && `${Je}--column`,
    ...
    p && `${Je}--scroll`,
    h
  ].filter(Boolean).join(" "), [n, o, p, h]);
  return /* @__PURE__ */ s("div", { ref: m, className: L, style: f, children: t.map((k, y) => {
  ...
  return de(() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        f && /* @__PURE__ */ s("div", { className: "land-header-right", children: f }),
  ...
  ) : null, pe = () => p ? /* @__PURE__ */ s("div", { className: `${Ht}__fallback`, children: p }) : L ? /* @__PURE__ */ g("div", { className: `${Ht}__error`, children: [
  ...
  const d = j(() => v3[e] || "info", [e]), f = t ?? n, h = j(() => [
    Jt,
    `${Jt}--${d}`,
    `${Jt}--${r}`,
    o && `${Jt}--simple`,
  ...
  return /* @__PURE__ */ g("div", { className: h, style: c, children: [
    ...
    /* @__PURE__ */ s("span", { className: `${Jt}__content`, children: f }),
    ...
    return this.validateOptions(t) ? this.safeDOMOperation(() => {
      ...
      if (r.style.cssText = o, t.style)
        try {
          ...
          console.warn("MessagePlugin: 应用自定义样式失败", f);
        }
      ...
      if (a.style.cssText = l + d, t.simple || r.appendChild(a), r.appendChild(i), t.closable) {
        ...
        `, f.onmouseenter = () => f.style.opacity = "1", f.onmouseleave = () => f.style.opacity = "0.6", f.onclick = () => this.close(n), r.appendChild(f);
      }
...
const cn = qs.getInstance(), Mm = {
  ...
  const { pageData: d, curStart: f, isStartPreOut: h, isStartNextOut: p } = j(() => {
    const w = t;
    let b = 2;
    ...
    (w) => {
      w === "prev" && !h ? m(Math.max(1, f - t)) : w === "next" && !p && m(Math.min(n, f + t));
    },
    [f, t, h, p, n, m]
  ), L = M(
    (w) => {
  ...
  return /* @__PURE__ */ g("div", { className: p, style: m, children: [
  ...
  const l = j(() => Math.max(0, Math.min(1, e)), [e]), c = j(() => [
    ...
    const { size: m, radius: v, circumference: L, strokeDashoffset: k } = f;
  ...
  return /* @__PURE__ */ s("div", { className: c, style: i, children: /* @__PURE__ */ s("div", { className: `${$t}__content`, children: n === "circle" ? /* @__PURE__ */ g("div", { className: `${$t}__circle-container`, children: [
    h(),
    !r && t === "default" && /* @__PURE__ */ s("div", { className: `${$t}__circle-label`, children: p }),
  ...
  const L = j(() => [
    ...
    `${Dt}__text`,
    f
  ].filter(Boolean).join(" "), [f]), C = M((w) => {
    i || (p == null || p(w), m || (v(!0), h == null || h(!0, w)));
  }, [i, m, p, h]);
  return /* @__PURE__ */ g(
    "div",
    {
...
const y3 = ({ className: e }) => /* @__PURE__ */ s("svg", { className: e, viewBox: "0 0 48 48", fill: "currentColor", children: /* @__PURE__ */ s("path", { d: "M22.683 5.415c.568-1.043 2.065-1.043 2.634 0l5.507 10.098a1.5 1.5 0 0 0 1.04.756l11.306 2.117c1.168.219 1.63 1.642.814 2.505l-7.902 8.359a1.5 1.5 0 0 0-.397 1.223l1.48 11.407c.153 1.177-1.058 2.057-2.131 1.548l-10.391-4.933a1.5 1.5 0 0 0-1.287 0l-10.39 4.933c-1.073.51-2.284-.37-2.131-1.548l1.48-11.407a1.5 1.5 0 0 0-.398-1.223L4.015 20.89c-.816-.863-.353-2.286.814-2.505l11.306-2.117a1.5 1.5 0 0 0 1.04-.756l5.508-10.098Z" }) }), Nm = (e) => {
  ...
  const S = j(() => e ?? i ?? [], [e, i]), A = j(() => d || (f ? w3[f] ?? "outline" : "outline"), [d, f]), [O, U] = F(() => t !== void 0 ? t : a != null && a.key !== void 0 ? a.key : r), [re, R] = F(() => n !== void 0 ? n : l != null && Array.isArray(l) ? l.filter((E) => E != null).map((E) => E.key) : o ?? []);
  de(() => {
  ...
  const [q, J] = F([]), z = j(() => {
    ...
    `${ht}__trigger`,
    `${ht}__trigger--${A}`,
    p && `${ht}__trigger--disabled`
  ].filter(Boolean).join(" "), [A, p]), ge = j(() => [
    `${ht}__dropdown`,
    T
  ...
  return /* @__PURE__ */ s("div", { className: he, style: I, children: /* @__PURE__ */ s(
    Cr,
    {
      ...
      children: /* @__PURE__ */ g("div", { className: ne, children: [
        ...
        k && /* @__PURE__ */ s(dt, { attach: "body", content: k, theme: "dark", ...y })
      ] })
    }
  ) });
}, Gs = pn.memo(({
...
const La = {
  ...
  const {
    ...
    const _ = [Yt];
    return _.push(`${Yt}--${n}`), f && _.push(`${Yt}--clickable`), h && _.push(h), _.join(" ");
  }, [n, f, h]), x = j(() => {
    const _ = [`${Yt}__icon`];
  ...
  const [d, f] = F(""), [h, p] = F(!1), m = ae(null), v = ae(null), L = ae(null), k = ae(null), y = ae(e), C = ae(!0), b = { ...{
    duration: 1e3,
    easing: "easeOut",
    delay: 0,
    loop: !1,
    ...
    const $ = V3[J], Z = () => {
      ...
      f(x(ue)), X < Q ? m.current = requestAnimationFrame(Z) : (f(x(R)), m.current = null);
    };
  ...
  de(() => {
    ...
    const re = () => {
      L.current = setTimeout(() => {
        C.current && (p(!1), k.current = setTimeout(() => {
          C.current && p(!0);
        }, 100), re());
      }, b.loopInterval);
    };
    ...
    C.current = !1, N(), T(), _(), V();
  }), []), de(() => (y.current !== e && i !== "none" && (p(!1), k.current = setTimeout(() => {
    C.current && p(!0);
  }, 50)), y.current = e, () => {
    V();
  }), [e, i]);
  ...
  return /* @__PURE__ */ s("div", { className: f, style: l, role: "list", "aria-label": "步骤导航", children: e.map((h, p) => {
    ...
    return /* @__PURE__ */ g(vr, { children: [
      ...
      /* @__PURE__ */ g(
        "div",
        {
          ...
          tabIndex: 0,
          role: "button",
          "aria-label": `步骤 ${p + 1}: ${h.title}`,
          "aria-current": m ? "step" : void 0,
          children: [
            /* @__PURE__ */ s("div", { className: `${dn}__num`, children: v ? /* @__PURE__ */ s(Le, { name: "check", size: 10 }) : p + 1 }),
  ...
  }, ue = () => !l && !c ? null : /* @__PURE__ */ s("span", { className: "land-switch__track-content", children: R ? c : l }), le = () => k ? /* @__PURE__ */ s(Gn, { className: "land-switch__loading-icon", strokeSize: 2, size: v === "small" ? 10 : v === "large" ? 14 : 12 }) : (R ? d : u) || null, be = () => h ? /* @__PURE__ */ s("div", { className: "land-switch__icon-tip", children: /* @__PURE__ */ s(dt, { content: h, theme: "dark", ...m, children: /* @__PURE__ */ s(Le, { name: "info-stroke", size: v === "small" ? 14 : 16 }) }) }) : null, ie = /* @__PURE__ */ g(
    "div",
    {
      className: Q,
      style: b,
  ...
  return f ? /* @__PURE__ */ s(dt, { content: f, theme: "dark", ...p, children: ie }) : ie;
}, un = "land-tabs", Dm = ({
  width: e = "100%",
  checked: t,
  data: n = [],
  ...
  const u = j(() => [
    ...
    l && `${un}--disabled`,
    a
  ].filter(Boolean).join(" "), [l, a]), d = M((m, v) => {
    v.stopPropagation(), !(m.disabled || l) && (o == null || o(m.key, m));
  }, [l, o]), f = M((m, v) => {
    var k;
    const L = (k = n[m - 1]) == null ? void 0 : k.key;
    return t === v || t === L;
  }, [t, n]), h = M((m) => {
    const v = t === m.key, L = m.disabled || l;
    return [
      `${un}__item`,
      v && `${un}__item--selected`,
      v && i,
      !v && L && `${un}__item--disabled`
    ].filter(Boolean).join(" ");
  }, [t, l, i]), p = M((m) => {
    const v = t === m.key;
    return typeof m.label == "function" ? m.label(m, v) : m.label;
  }, [t]);
  return /* @__PURE__ */ s("div", { className: u, style: { width: e, ...c }, children: n.map((m, v) => /* @__PURE__ */ g(vr, { children: [
    r && v !== 0 && /* @__PURE__ */ s(
      qt,
      {
        direction: "vertical",
        spacing: 0,
        length: "14px",
        className: `${un}__divider ${f(v, m.key) ? `${un}__divider--hidden` : ""}`
      }
    ),
    /* @__PURE__ */ s(
      "div",
      {
        className: h(m),
        onClick: (L) => d(m, L),
        children: /* @__PURE__ */ s("span", { className: `${un}__item-label`, children: p(m) })
      }
    )
  ] }, m.key)) });
  ...
  const t = S3(e), {
    ...
    const $ = { ...L };
    return u && !Ms(u) && ($["--tag-custom-color"] = u), h && ($["--tag-bg-color"] = h), p && ($["--tag-text-color"] = p), m && ($["--tag-border-color"] = m), v && ($.border = v), $;
  }, [L, u, h, p, m, v]), X = j(() => [
    "land-tag",
    `land-tag--${l}`,
    `land-tag--${c}`,
    ...
    y && "land-tag--closable",
    k
  ].filter(Boolean).join(" "), [l, c, d, u, f, C, w, q, N, y, k]);
  return R ? /* @__PURE__ */ g(
    "span",
    {
      className: X,
  ...
  const c = pn.Children.toArray(e), u = o ? c.slice(0, o) : c, d = o ? Math.max(0, c.length - o) : 0, f = {
    display: "flex",
  ...
  return /* @__PURE__ */ g("div", { className: `land-tag-group ${l}`, style: f, children: [
    u,
...
const bt = "land-tag-input", bs = (e) => typeof e == "string" ? e : e.label, I3 = (e, t) => typeof e == "string" ? `${e}-${t}` : e.key ?? `${e.label}-${t}`, P3 = (e) => typeof e == "string" ? !0 : e.closable !== !1, Im = ({
  ...
  const [O, U] = F(""), [re, R] = F(
    e ?? t ?? n ?? []
  ), [q, J] = F(!1), z = ae(null), Q = ae(null), X = e !== void 0, $ = X ? e : re, Z = o ?? i, te = $.length >= Z, pe = h && $.length > 0 && !d && !f;
  de(() => {
    X && R(e);
  }, [X, e]);
  const ue = M(
    ...
    var K;
    d || f || (ue([], "clear"), T == null || T(), (K = Q.current) == null || K.focus());
  }, [d, f, ue, T]), D = M(
    (K) => {
      if (K.key === "Enter") {
    ...
    f && `${bt}--readonly`,
    p
  ].filter(Boolean).join(" "), [c, u, q, d, f, p]), W = j(() => ({
    width: typeof v == "number" ? `${v}px` : v,
    ...m
  }), [v, m]), fe = M(
    (K, P) => {
      const oe = bs(K), se = I3(K, P), ve = P3(K) && !d && !f, _e = typeof K == "object" ? { ...k, ...K.style } : k, Se = typeof K == "object" ? `${bt}__tag ${L} ${K.className ?? ""}` : `${bt}__tag ${L}`;
...
function Pm(e) {
  ...
  const ie = (P, oe) => {
    ...
    f && "land-table-wrapper--bordered",
    p && "land-table-wrapper--cross-highlight",
...
const Dr = "land-title", Am = ({
  ...
  const c = j(() => [Dr, a].filter(Boolean).join(" "), [a]), u = M(() => {
    l == null || l();
  }, [l]), d = j(() => /* @__PURE__ */ s(t, { children: e }), [t, e]), f = j(() => r ? typeof r == "string" ? /* @__PURE__ */ s("div", { className: `${Dr}__sub`, children: r }) : /* @__PURE__ */ s(tt, { children: r }) : null, [r]);
  return /* @__PURE__ */ g(
    "div",
    {
      className: c,
      ...
      children: [
        ...
        o && /* @__PURE__ */ g("div", { className: `${Dr}__tip hover-pop`, children: [
          ...
          /* @__PURE__ */ s(dt, { content: o, theme: "dark", style: { maxWidth: "200px" } })
        ] }),
        f
      ]
    }
  ...
  const U = ae(null), [re, R] = F(o ?? ""), [q, J] = F(!1), z = ae(!1), Q = r !== void 0, X = Q ? r : re, $ = M(() => {
    ...
    let we = 0, Ie = 1 / 0;
    if (typeof m == "object") {
      const Oe = m.minRows ?? h, Re = m.maxRows ?? p;
      Oe && (we = Oe * oe + se + ve + _e + Se), Re && (Ie = Re * oe + se + ve + _e + Se);
    } else
      h && (we = h * oe + se + ve + _e + Se), p && (Ie = p * oe + se + ve + _e + Se);
...
const Rm = (e) => {
  const {
    ...
    async (ce, $e) => {
      ...
      He.open(h, f, !0), p && Object.entries(p).forEach(([Ee, Pe]) => {
  ...
  return /* @__PURE__ */ g("div", { ref: v, className: C, style: p, children: [
    e,
  ...
  onDragStart: u,
  onDragEnd: d,
  isExternalDragging: f = !1
}) => {
  const h = ae(null), [p, m] = F(0), [v, L] = F(!1), [k, y] = F(!1), [C, w] = F(0);
  de(() => {
    if (!h.current) return;
  ...
  const b = M((S) => {
    ...
    L(!1), w(0), !f && k && (y(!1), d == null || d()), c == null || c();
  }, [k, f, d, c]), V = M(() => {
    k && (y(!1), d == null || d());
  }, [k, d]);
  de(() => {
  ...
  const H = [
    ...
    (k || f) && "land-video-progress--dragging",
  ...
  const we = ae(null), Ie = ae(null), Ue = ae(null), Ve = ae(null), Oe = ae(null), [Re, Ge] = F("idle"), [ze, Y] = F(0), [Ce, xe] = F(0), [De, at] = F(0), [wt, ce] = F(16 / 9), [$e, Be] = F(!1), [He, Ee] = F(h), [Pe, B] = F(h), [G, me] = F(f), [ee, ke] = F(d), [je, Me] = F(p), [Ze, Vt] = F(!1), [Tn, br] = F(!1), [rn, wc] = F(!1), [Cc, Mc] = F(!1), [Gt, xr] = F(!1), es = ae(null), [bc, Ao] = F(!1), [xc, _c] = F(0), [ts, Bo] = F(!1), [ns, Ro] = F(!1), [rs, Eo] = F(!1), _r = j(() => typeof l == "number" ? `${l}px` : l, [l]), Oo = j(() => a || wt, [a, wt]), $c = j(() => S / (wt || 1.7777777777777777), [S, wt]), Et = M(() => ({
    currentTime: Ce,
    duration: ze,
    ...
    const ye = we.current;
    xe(ye.currentTime), ye.buffered.length > 0 && at(ye.buffered.end(ye.buffered.length - 1)), $ == null || $(Et());
  }, [Tn, Et, $]), jc = M(() => {
    if (!we.current) return;
    const ye = we.current;
  ...
  de(() => {
    ...
    we.current && (we.current.pause(), Be(!1), xe(0), at(0), Y(0), Ge("idle"));
  }, [t]), G3(Oe, () => {
    Ze && Vt(!1);
  }), de(() => {
    const ye = () => {
  ...
  return de(() => {
    ...
    /* @__PURE__ */ s(
      "textarea",
      {
        ...
        placeholder: e,
        value: t,
        onChange: (f) => n == null ? void 0 : n(f.target.value, f)
      }
    )
  ] });
  ...
  const [c, u] = F(!1), [d, f] = F(t), h = ae(null);
  de(() => {
    f(t);
  }, [t]);
  const p = () => {
    ...
    y.key === "Enter" && !y.shiftKey && (y.preventDefault(), m()), y.key === "Escape" && (f(t), u(!1));
  }, L = (y) => {
    f(y.target.value);
  }, k = () => {
    const y = {};
  ...
  return /* @__PURE__ */ g("div", { className: `land-grid-template ${u} type-${e} ${o}`, style: { gap: n, aspectRatio: t, ...r }, children: [
    l,
    !l && /* @__PURE__ */ s(tt, { children: Array.from({ length: c }).map((d, f) => /* @__PURE__ */ s("div", { className: `land-grid-template-item ${a}`, style: i }, f)) })
  ] });
}, yc = (e, t) => {
  const n = [];
  let r = "", o = "default", i = 0;
...
`) && w.push({ type: "default", msg: /* @__PURE__ */ s("br", {}) }), w;
      ...
      !h.current || !p.current || (h.current.scrollTop = p.current.scrollTop);
    }, []), L = M(
      (C) => {
        a == null || a(C), v();
      },
    ...
    return qc(f, () => ({
      ...
      !p.current || !l || (l.current = p.current);
  ...
  const d = j(() => yc(e, i), [e, i]), f = ae(null), h = ae(null), p = M(() => {
    !f.current || !h.current || (f.current.scrollLeft = h.current.scrollLeft);
  }, []), m = M(() => {
    f.current && (f.current.scrollLeft = 0), r == null || r();
  }, []);
  ...
  const u = ae(null), d = ae(null), f = ae(null), [h, p] = F(0);
  de(() => {
    var y;
    p(((y = f.current) == null ? void 0 : y.offsetWidth) ?? 0);
  }, [t]);
  const m = M(() => {
  ...
  return /* @__PURE__ */ g("div", { className: `${xn} ${a}`, style: l, children: [
    /* @__PURE__ */ g("div", { ref: d, className: `${xn}__mirror`, children: [
      t && /* @__PURE__ */ g("span", { ref: f, className: `${xn}__prefix`, children: [
        "[",
  ...
  }, [e, l]), f = j(() => e == null ? void 0 : e.map((v) => v.id), [e]), h = j(() => d == null ? void 0 : d.indexOf(i), [d, i]), p = j(() => f == null ? void 0 : f.indexOf(l), [f, l]), m = (v) => e.slice(0, v).reduce((L, k) => L + k.mediaData.length, 0);
  return de(() => {
    if (n === void 0 || p === -1 || h === -1) return;
    let v = m(p);
    d.length <= 6 ? u.current && u.current.scrollTo({ top: (v - 1) * 96 + p * 8 + (v - p) * 1, behavior: "smooth" }) : h <= 5 ? u.current && u.current.scrollTo({ top: (v - 1) * 96 + p * 8 + (v - p) * 1, behavior: "smooth" }) : p === 0 ? u.current && u.current.scrollTo({ top: (v + Math.floor(h / 7) * 7) * 96 + p * 8 + (v - p + Math.floor(h / 7) * 7) * 1, behavior: "smooth" }) : u.current && u.current.scrollTo({ top: (v + 6 + Math.floor((h - 6) / 7) * 7) * 96 + p * 8 + (v - p + 6 + Math.floor((h - 6) / 7) * 7) * 1, behavior: "smooth" });
  }, [h, p]), de(() => {
    if (!o) return;
    const v = (L) => {
      ...
      if (!(L.repeat || p === -1 || h === -1))
        if (["TEXTAREA", "INPUT"].indexOf(L.target.tagName) === -1 && L.preventDefault(), L.code === "ArrowUp" || L.key === "ArrowUp") {
          if (h > 0)
            a(d[h - 1]), r == null || r((k = e[p]) == null ? void 0 : k.mediaData[h - 1], e[p]);
          else if (p > 0) {
            c(f[p - 1] ?? "");
            const V = (C = (y = e == null ? void 0 : e.filter((H) => H.id === f[p - 1])[0]) == null ? void 0 : y.mediaData) == null ? void 0 : C.length;
            a((b = (w = e[p - 1]) == null ? void 0 : w.mediaData[V - 1]) == null ? void 0 : b.id), r == null || r((x = e[p - 1]) == null ? void 0 : x.mediaData[V - 1], e[p - 1]);
          }
        } else (L.code === "ArrowDown" || L.key === "ArrowDown") && (h < (d == null ? void 0 : d.length) - 1 ? (a(d[h + 1]), r == null || r((N = e[p]) == null ? void 0 : N.mediaData[h + 1], e[p])) : p < f.length - 1 && (c(f[p + 1] ?? ""), a((T = e[p + 1]) == null ? void 0 : T.mediaData[0].id), r == null || r((_ = e[p + 1]) == null ? void 0 : _.mediaData[0], e[p + 1])));
    };
