import { default as React, CSSProperties, ChangeEvent } from 'react';
 ...
 * 合并了所有属性接口
 */
export type NumberInputProps = NumberInputBaseProps & NumberInputDisplayProps & NumberInputFeatureProps & NumberInputContentProps & NumberInputSizeProps & NumberInputStyleProps & NumberInputEventProps & Omit<InputProps, 'value' | 'onChange'>;
/**
 * 属性优先级说明：
 * 1. value控制数字输入框的当前值
 * 2. type控制数字输入框的视觉样式
