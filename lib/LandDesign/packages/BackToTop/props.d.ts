 ...
 * 合并了所有属性接口
 */
export type BackToTopProps = BackToTopBaseProps & BackToTopStyleProps & BackToTopInteractionProps & BackToTopAnimationProps & BackToTopIconProps & BackToTopScrollProps;
/**
 * 属性优先级说明：
