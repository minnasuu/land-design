...
export interface NumberInputEventProps {
     ...
     * @param info 变化信息
     */
    onChange?: (value: number | undefined, info: NumberInputChangeInfo) => void;
    /**
     * 步进回调
 ...
 * NumberInput 组件完整属性
 */
export type NumberInputProps = NumberInputBaseProps & NumberInputAppearanceProps & NumberInputValueProps & NumberInputContentProps & NumberInputInteractionProps & NumberInputStyleProps & NumberInputEventProps;
/**
 * NumberInput 默认属性值
 */
export declare const numberInputDefaultProps: Partial<NumberInputProps>;
