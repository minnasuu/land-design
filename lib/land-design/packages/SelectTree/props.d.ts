...
export interface SelectTreeProps extends CommonProps, Omit<DropdownProps, 'content' | 'children' | 'onChange'> {
     ...
     * @returns 自定义渲染内容
     */
    renderOption?: (option: SelectTreeOption, state: {
        selected: boolean;
        expanded: boolean;
     ...
     */
    onChange?: (value: string | string[], option: SelectTreeOption, selectedOptions?: SelectTreeOption[]) => void;
    /**
     * 展开/收起回调
 ...
 * SelectTree 组件默认属性
 */
export declare const selectTreeDefaultProps: Partial<SelectTreeProps>;
/**
 * 旧 type 到新 variant 的映射
 * @internal
 */
export declare const typeToVariantMap: Record<SelectTreeType, SelectTreeVariant>;
/**
 * SelectTree 属性使用说明
 *
 * 1. 数据源：
