 ...
 */
export type RadioProps = RadioBaseProps & RadioAnimationProps & RadioTipProps & RadioStyleProps & RadioEventProps;
/**
 * Radio 组件默认属性
 * @description 组件的默认配置值
 */
export declare const radioDefaultProps: Partial<RadioProps>;
/**
 * 属性使用优先级说明：
 *
 * 1. 受控 vs 非受控模式：
