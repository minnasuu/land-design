 ...
 */
export type ColorPickerProps = ColorPickerBaseProps & ColorPickerPanelProps & ColorPickerStyleProps & ColorPickerEventProps & ColorPickerChildrenProps;
export declare const defaultColorPickerProps: {
    defaultValue: string;
    format: ColorFormat;
    showAlpha: boolean;
    disabled: boolean;
