...
export const NAV_COMPONENTS_DATA = [
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "a-scroller", title: "滚动容器" },
      { key: "anchor-offset", title: "偏移设置" },
      { key: "b-scroller", title: "滚动容器2" },
      { key: "anchor-indicator", title: "指示器" },
      { key: "c-scroller", title: "滚动容器3" },
    ],
...
export const INPUT_COMPONENTS_DATA = [
  ...
  },
  {
    ...
    anchors: [
      { key: "color-picker-normal", title: "基础用法" },
      { key: "color-picker-disabled", title: "禁用状态" },
      { key: "color-picker-custom", title: "自定义样式" },
      { key: "color-picker-border", title: "带边框" },
      { key: "color-picker-colors", title: "不同颜色" },
      { key: "color-picker-values", title: "颜色值展示" },
    ],
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "date-picker-styles", title: "不同样式" },
    ],
...
export const FEEDBACK_COMPONENTS_DATA = [
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "progress-custom", title: "自定义样式" },
    ],
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "skeleton-custom-style", title: "自定义样式" },
    ],
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "loading-combined", title: "组合使用" },
      { key: "loading-button", title: "按钮加载" },
      { key: "loading-custom", title: "自定义样式" },
      { key: "loading-scenarios", title: "使用场景" },
    ],
...
export const TEXT_COMPONENTS_DATA = [
  ...
  },
  {
    ...
    anchors: [
      ...
      { key: "ellipsis-custom-maxwidth", title: "自定义最大宽度" },
    ],
